...
.field public static final W:Ljava/lang/String; = "17"
...
.method public constructor <init>(Lx0/h1;)V
    ...
    iput-object p1, p0, Lx0/w0;->B:Ljava/util/HashMap;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Lx0/w0;->C:Ljava/util/HashMap;

    new-instance p1, Lx0/i1;

    invoke-direct {p1, p0}, Lx0/i1;-><init>(Lx0/w0;)V

    iput-object p1, p0, Lx0/w0;->A:Lx0/i1;
...
.method public B()Ljava/lang/String;
    ...
    iget-object p0, p0, Lx0/w0;->d:Ljava/lang/String;

    return-object p0
.end method

.method public C()Lcom/android/camera/fragment/beauty/l$a;
    .locals 0
    ...
    iget-object p0, p0, Lx0/w0;->g:Lcom/android/camera/fragment/beauty/l$a;
...
.method public E(I)I
    ...
    invoke-virtual {p0, p1}, Lx0/w0;->h(I)Z

    move-result p1

    iput-boolean p1, p0, Lx0/w0;->e:Z
...
.method public G()Lx0/i1;
    .locals 0

    iget-object p0, p0, Lx0/w0;->A:Lx0/i1;
...
.method public H()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lx0/w0;->x()Lcom/android/camera/data/data/c;
...
.method public J()Z
    ...
    invoke-direct {v1}, Lx0/v0;-><init>()V
    ...
    :cond_0
    iget-object v0, p0, Lx0/w0;->f:Lcom/android/camera2/f;
    ...
    :cond_1
    iget-boolean v0, p0, Lx0/w0;->w:Z

    if-eqz v0, :cond_3

    iget-object v0, p0, Lx0/w0;->d:Ljava/lang/String;
...
.method public K()Z
    ...
    iget-object p0, p0, Lx0/w0;->f:Lcom/android/camera2/f;
...
.method public P(IZ)Z
    ...
    iget-object p0, p0, Lx0/w0;->B:Ljava/util/HashMap;
...
.method public Q(IZ)Z
    ...
    iget-object p0, p0, Lx0/w0;->C:Ljava/util/HashMap;
...
.method public R(IZ)Z
    ...
    invoke-virtual {p0, p1, p2}, Lx0/w0;->P(IZ)Z

    move-result v0

    if-nez v0, :cond_1

    invoke-virtual {p0, p1, p2}, Lx0/w0;->Q(IZ)Z
...
.method public final S(Ljava/lang/String;)Lcom/android/camera/data/data/c;
    .locals 3
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "supportHalJsonBeautyItem"
    ...
    iget-object v0, p0, Lx0/w0;->g:Lcom/android/camera/fragment/beauty/l$a;
    ...
    invoke-virtual {p0}, Lx0/w0;->v()Lcom/android/camera/data/data/c;
...
.method public T(IILcom/android/camera2/f;Z)V
    .locals 8
    ...
    :goto_0
    iput-boolean p2, p0, Lx0/w0;->a:Z

    invoke-virtual {p0}, Lx0/w0;->U()V

    iput-object p3, p0, Lx0/w0;->f:Lcom/android/camera2/f;

    iput p1, p0, Lcom/android/camera/data/data/b;->mCurrentMode:I

    const/4 p2, -0x1

    iput p2, p0, Lx0/w0;->h:I

    const/4 v2, 0x0

    iput-object v2, p0, Lx0/w0;->c:Ljava/lang/String;

    iput-object v2, p0, Lx0/w0;->g:Lcom/android/camera/fragment/beauty/l$a;

    iput-boolean v0, p0, Lx0/w0;->l:Z

    iput-boolean v0, p0, Lx0/w0;->k:Z

    iput-boolean v0, p0, Lx0/w0;->m:Z

    iput-boolean v0, p0, Lx0/w0;->p:Z

    iput-boolean v0, p0, Lx0/w0;->q:Z

    iput-boolean v0, p0, Lx0/w0;->r:Z

    iput-boolean v0, p0, Lx0/w0;->s:Z

    iput-boolean v0, p0, Lx0/w0;->t:Z

    iput-boolean v0, p0, Lx0/w0;->w:Z

    iput-boolean v0, p0, Lx0/w0;->x:Z

    iput-boolean v0, p0, Lx0/w0;->n:Z

    iput-boolean v0, p0, Lx0/w0;->o:Z

    iput-boolean v0, p0, Lx0/w0;->j:Z

    iput-boolean v0, p0, Lx0/w0;->i:Z

    iput-boolean v0, p0, Lx0/w0;->y:Z

    iput-boolean v0, p0, Lx0/w0;->D:Z
    ...
    iput v4, p0, Lx0/w0;->h:I

    iget-boolean p1, p0, Lx0/w0;->a:Z
    ...
    iput-boolean v1, p0, Lx0/w0;->l:Z

    iget-object p1, p0, Lcom/android/camera/data/data/b;->mItems:Ljava/util/List;

    invoke-virtual {p0}, Lx0/w0;->j()Lcom/android/camera/data/data/c;
    ...
    invoke-virtual {p1}, Lsb/c;->J7()Z

    move-result p1

    if-eqz p1, :cond_5

    iput-boolean v1, p0, Lx0/w0;->q:Z

    iget-object p1, p0, Lcom/android/camera/data/data/b;->mItems:Ljava/util/List;

    invoke-virtual {p0, p3}, Lx0/w0;->k(Lcom/android/camera2/f;)Lcom/android/camera/data/data/c;
    ...
    invoke-virtual {p0}, Lx0/w0;->l()Lcom/android/camera/data/data/c;
    ...
    invoke-virtual {p0}, Lx0/w0;->o()Lcom/android/camera/data/data/c;
    ...
    invoke-virtual {p0, p2}, Lx0/w0;->S(Ljava/lang/String;)Lcom/android/camera/data/data/c;
    ...
    invoke-virtual {p2}, Lsb/c;->o3()Z

    move-result p2

    if-nez p2, :cond_1c

    iput-boolean v1, p0, Lx0/w0;->m:Z
    ...
    invoke-virtual {p2}, Lsb/c;->n5()Z

    move-result p2

    if-eqz p2, :cond_12

    iput-boolean v1, p0, Lx0/w0;->w:Z
    ...
    invoke-virtual {p0, v2}, Lx0/w0;->S(Ljava/lang/String;)Lcom/android/camera/data/data/c;
    ...
    invoke-virtual {p0}, Lx0/w0;->n()Lcom/android/camera/data/data/c;
    ...
    :cond_17
    invoke-virtual {p0}, Lx0/w0;->w()Lcom/android/camera/data/data/c;
    ...
    invoke-virtual {p0, p3}, Lx0/w0;->s(Lcom/android/camera2/f;)Lcom/android/camera/data/data/c;
    ...
    invoke-virtual {p0}, Lx0/w0;->q()Lcom/android/camera/data/data/c;

    move-result-object v2

    invoke-interface {p2, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iput-boolean v1, p0, Lx0/w0;->t:Z
    ...
    invoke-virtual {p2}, Lsb/c;->j5()Z

    move-result p2

    if-eqz p2, :cond_1b

    iput-boolean v1, p0, Lx0/w0;->x:Z
    ...
    invoke-virtual {p0}, Lx0/w0;->p()Lcom/android/camera/data/data/c;

    move-result-object v2

    invoke-interface {p2, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iput-boolean v1, p0, Lx0/w0;->u:Z
    ...
    invoke-virtual {p0}, Lx0/w0;->i()Lcom/android/camera/data/data/c;

    move-result-object p2

    invoke-interface {p1, p2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iput-boolean v1, p0, Lx0/w0;->v:Z
    ...
    invoke-virtual {p0, v5}, Lx0/w0;->m(Ljava/lang/String;)Lcom/android/camera/data/data/c;

    move-result-object p2

    invoke-interface {p1, p2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iput-object v5, p0, Lx0/w0;->c:Ljava/lang/String;
    ...
    :cond_33
    invoke-virtual {p0}, Lx0/w0;->r()Lcom/android/camera/data/data/c;
    ...
    invoke-virtual {p0}, Lx0/w0;->u()Lcom/android/camera/data/data/c;
    ...
    :cond_4b
    invoke-virtual {p0}, Lx0/w0;->t()Lcom/android/camera/data/data/c;
    ...
    :cond_56
    :goto_17
    iget-object p1, p0, Lx0/w0;->c:Ljava/lang/String;
    ...
    iput-object p1, p0, Lx0/w0;->c:Ljava/lang/String;

    :cond_57
    iget-object p1, p0, Lx0/w0;->c:Ljava/lang/String;

    iput-object p1, p0, Lx0/w0;->d:Ljava/lang/String;
...
.method public g()V
    ...
    iget-object v0, p0, Lx0/w0;->B:Ljava/util/HashMap;
...
.method public getDefaultValue(I)Ljava/lang/String;
    ...
    iget-object p0, p0, Lx0/w0;->c:Ljava/lang/String;
...
.method public h(I)Z
    ...
    iget-object v0, p0, Lx0/w0;->z:Lcom/android/camera/fragment/beauty/c0;
    ...
    iput-object v0, p0, Lx0/w0;->z:Lcom/android/camera/fragment/beauty/c0;
    ...
    invoke-virtual {p0, p1, v0}, Lx0/w0;->R(IZ)Z
    ...
    :cond_3
    iget-object v9, v9, Lcom/android/camera/data/data/c;->o:Ljava/lang/String;
    ...
    invoke-static {v9}, Lcom/android/camera/fragment/beauty/l;->f(Ljava/lang/String;)Z
    ...
    iget-object v3, p0, Lx0/w0;->z:Lcom/android/camera/fragment/beauty/c0;

    invoke-static {p1, v3}, Lcom/android/camera/t2;->X3(ILcom/android/camera/fragment/beauty/c0;)Z
    ...
    invoke-virtual {v9}, Lu0/h1;->F()Lx0/b;

    move-result-object v9

    invoke-virtual {v9}, Lx0/b;->isSwitchOn()Z
    ...
    invoke-virtual {v9}, Lu0/h1;->G()Lx0/c;
    ...
    invoke-static {p1}, Lcom/android/camera/t2;->P4(I)Z
    ...
    invoke-virtual {v6}, Lx0/h1;->T()Lx0/p0;

    move-result-object v6

    invoke-virtual {v6}, Lx0/p0;->isSwitchOn()Z
    ...
    :cond_14
    sget v11, Lcom/android/camera/effect/p;->V2:I
...
.method public t0(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lx0/w0;->g:Lcom/android/camera/fragment/beauty/l$a;
...
.method public final x()Lcom/android/camera/data/data/c;
    .locals 4
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
...
.method public z()Lcom/android/camera2/f;
    .locals 0
