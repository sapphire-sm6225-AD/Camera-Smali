...
.method public static synthetic a(Ltq/j0;Ljava/lang/String;[B)V
    .locals 0

    invoke-static {p0, p1, p2}, Lw5/c;->b(Ltq/j0;Ljava/lang/String;[B)V

    return-void
.end method

.method public static b(Ltq/j0;Ljava/lang/String;[B)V
    .locals 2

    const-class v0, Ltq/p1;
    ...
    check-cast v0, Ltq/p1;

    if-nez v0, :cond_0

    invoke-static {}, Ltq/p1;->E()Ltq/p1;
    ...
    :cond_0
    invoke-static {}, Ltq/p0;->n()Ljava/lang/String;
    ...
    invoke-static {p2}, Ltq/p0;->m([B)Ltq/p0;
    ...
    :cond_1
    invoke-static {}, Ltq/q0;->n()Ljava/lang/String;
    ...
    invoke-static {p2}, Ltq/q0;->m([B)Ltq/q0;
    ...
    invoke-static {v0, p0, p1}, Ltq/s0;->w(Ltq/s0;Ljava/lang/Class;Ljava/lang/String;)Ltq/c;
...
.method public static c(Landroid/media/MediaMetadataRetriever;Landroid/os/ParcelFileDescriptor;Ljava/lang/String;Lcom/android/camera/u2;[Landroid/graphics/Bitmap;)V
    .locals 2
    ...
    iget v1, p3, Lcom/android/camera/u2;->b:I
    ...
    invoke-direct {p3, v0, v1}, Lcom/android/camera/u2;-><init>(II)V
    ...
    iget p2, p3, Lcom/android/camera/u2;->a:I

    iget p3, p3, Lcom/android/camera/u2;->b:I

    invoke-static {p0, p1, p2, p3}, Lcom/android/camera/k5;->h(Landroid/media/MediaMetadataRetriever;Ljava/io/FileDescriptor;II)Landroid/graphics/Bitmap;
    ...
    :cond_2
    iget p1, p3, Lcom/android/camera/u2;->a:I

    iget p3, p3, Lcom/android/camera/u2;->b:I

    invoke-static {p0, p2, p1, p3}, Lcom/android/camera/k5;->i(Landroid/media/MediaMetadataRetriever;Ljava/lang/String;II)Landroid/graphics/Bitmap;
...
.method public static d(Ljava/io/File;)Ltq/p1;
    .locals 1
    ...
    :try_start_1
    invoke-static {p0}, Lw5/c;->e(Lqq/d;)Ltq/p1;
...
.method public static e(Lqq/d;)Ltq/p1;
    .locals 10
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public static f(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, v0}, Lcom/android/camera/c6;->r5(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v4}, Lw5/c;->d(Ljava/io/File;)Ltq/p1;
    ...
    invoke-static {v0, v4, v5}, Ltq/s0;->x(Ltq/s0;Ljava/lang/Class;[Ljava/lang/String;)Ltq/c;
...
.method public static g(Ljava/lang/String;Ljava/util/List;J)V
    ...
    invoke-direct {p0}, Lwq/e;-><init>()V

    new-instance p3, Lw5/c$a;

    invoke-direct {p3, p1}, Lw5/c$a;-><init>(Ljava/util/List;)V

    invoke-virtual {p0, p2, p3}, Lwq/e;->c(Ljava/io/File;Lwq/c;)V
    :try_end_0
