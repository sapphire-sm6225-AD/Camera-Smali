...
.method public static synthetic A(I)Lh5/p4;
    ...
    invoke-static {p0}, Ly3/h;->Q(I)Lh5/p4;
...
.method public static synthetic D(I)Lh5/p4;
    ...
    invoke-static {p0}, Ly3/h;->O(I)Lh5/p4;
...
.method public static synthetic O(I)Lh5/p4;
    ...
    invoke-virtual {v0}, Lx0/h1;->Y()Lx0/u0;

    move-result-object v0

    invoke-virtual {v0}, Lx0/u0;->isActivated()Z
...
.method public final H(II)Lf5/f$a;
    ...
    invoke-virtual {p1, p2}, Lx0/w0;->h(I)Z
...
.method public I(II)Lf5/f$a;
    ...
    invoke-virtual {p1}, Lx0/h1;->Y()Lx0/u0;

    move-result-object p1

    invoke-virtual {p1}, Lx0/u0;->isActivated()Z
...
.method public J(II)Lf5/f$a;
    ...
    invoke-virtual {p1}, Lx0/h1;->Z()Lcom/android/camera2/compat/theme/custom/mm/data/ComponentRunningPictureStyleMM;
...
.method public c()Ljava/util/List;
    ...
    invoke-virtual {v6}, Lh5/u2$b;->i()Lh5/u2;
    ...
    invoke-virtual {v6}, Lu0/h1;->w()Lu0/h;
    ...
    invoke-virtual {v5}, Lh5/u2$b;->i()Lh5/u2;
    ...
    invoke-virtual {v5, v6}, Lh5/u2$b;->q(Ljava/util/List;)Lh5/u2$b;
    ...
    invoke-static {}, Lh5/t2;->t1()Lh5/u2$b;

    move-result-object v4

    invoke-virtual {v4}, Lh5/u2$b;->i()Lh5/u2;
    ...
    invoke-virtual {v1}, Lu0/h1;->I0()Z

    move-result v1

    if-eqz v1, :cond_4

    invoke-static {}, Lh5/t2;->K1()Lh5/u2$b;
    ...
    invoke-virtual {v1}, Lsb/c;->Gb()Z

    move-result v1

    if-eqz v1, :cond_5

    invoke-static {}, Lh5/t2;->n1()Lh5/u2$b;
    ...
    invoke-static {}, Lh5/t2;->e1()Lh5/u2$b;
    ...
    :cond_8
    invoke-static {}, Lh5/t2;->c1()Lh5/u2$b;
    ...
    invoke-static {p0}, Lcom/android/camera/t2;->L(I)Z

    move-result p0

    if-eqz p0, :cond_9

    invoke-static {}, Lh5/t2;->p1()Lh5/u2$b;
...
.method public e(Ld5/i;)Ljava/util/List;
    ...
    invoke-static {}, Lcom/android/camera2/compat/theme/custom/mm/top/TopBarUtils;->getMacroModeItemBuilder()Lh5/u2$b;
    ...
    invoke-static {}, Lcom/android/camera2/compat/theme/custom/mm/top/TopBarUtils;->getRawItemBuilder()Lh5/u2$b;
    ...
    invoke-static {}, Lcom/android/camera2/compat/theme/custom/mm/top/TopBarUtils;->getUltraPixelItemBuilder()Lh5/u2$b;
...
.method public j()Ljava/util/List;
    ...
    invoke-static {v3}, Lcom/android/camera2/g;->g9(Lcom/android/camera2/f;)Z

    move-result v4

    if-nez v4, :cond_0

    invoke-static {}, Lh5/o4;->f0()Lh5/u2$b;
    ...
    invoke-virtual {v4}, Lsb/c;->U6()Z

    move-result v4

    if-eqz v4, :cond_1

    invoke-virtual {p0}, Ly3/h;->K()Lh5/u2$b;
    ...
    invoke-virtual {v4}, Lu0/h1;->w()Lu0/h;
    ...
    invoke-virtual {v3}, Lh5/u2$b;->i()Lh5/u2;
    ...
    invoke-virtual {v2, v3, v4}, Lsb/c;->u0(II)Z
    ...
    invoke-virtual {v2}, Lu0/h1;->I0()Z

    move-result v2

    if-eqz v2, :cond_3

    invoke-virtual {p0}, Ly3/h;->L()Lh5/u2$b;
    ...
    :cond_3
    invoke-virtual {v1}, Lx0/h1;->C1()Z

    move-result p0

    if-eqz p0, :cond_4

    invoke-static {}, Lh5/o4;->k0()Lh5/u2$b;
...
.method public l()Ljava/util/List;
    ...
    invoke-static {}, Lcom/android/camera2/compat/theme/custom/mm/top/TopBarUtils;->getParameterResetTip()Lh5/u2$b;
