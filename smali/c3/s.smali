...
# static fields
.field public static final Ha:Ljava/lang/String; = "DocModule"

.field public static final Ia:Z


# instance fields
.field public Fa:Landroid/net/Uri;
...
.method public static synthetic As(Lc3/s;)V
    .locals 0

    invoke-direct {p0}, Lc3/s;->Ss()V

    return-void
.end method

.method public static synthetic Bs(Landroid/net/Uri;)V
    .locals 0

    invoke-static {p0}, Lc3/s;->Ls(Landroid/net/Uri;)V
...
.method public static synthetic Cs(Lcom/android/camera/Camera;)V
    ...
    invoke-static {p0}, Lc3/s;->Qs(Lcom/android/camera/Camera;)V

    return-void
.end method

.method public static synthetic Ds(Lcom/android/camera/Camera;)V
    .locals 0

    invoke-static {p0}, Lc3/s;->Ws(Lcom/android/camera/Camera;)V

    return-void
.end method

.method public static synthetic Es(Lc3/s;Landroid/graphics/Bitmap;[FLda/x;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lc3/s;->Us(Landroid/graphics/Bitmap;[FLda/x;)V

    return-void
.end method

.method public static synthetic Fs(Lc3/s;Lcom/android/camera2/s5;)V
    .locals 0

    invoke-direct {p0, p1}, Lc3/s;->Ps(Lcom/android/camera2/s5;)V

    return-void
.end method

.method public static synthetic Gs()V
    .locals 0

    invoke-static {}, Lc3/s;->Os()V

    return-void
.end method

.method public static synthetic Ls(Landroid/net/Uri;)V
    .locals 2
...
.method private synthetic Ms(Lda/h;)V
    .locals 3

    invoke-virtual {p1}, Lda/h;->k()V

    invoke-virtual {p1}, Lda/h;->q()Landroid/util/Pair;
    ...
    invoke-direct {v1, v2, p1, v0}, Lda/h$a;-><init>(Lda/x;[FLjava/lang/String;)V

    iput-object v1, p0, Ld6/o2;->ka:Lda/h$a;
...
.method public static synthetic Ns(Landroid/net/Uri;)V
    .locals 2
...
.method public static synthetic Os()V
    .locals 1
...
.method private synthetic Ps(Lcom/android/camera2/s5;)V
    .locals 0
...
.method public static synthetic Qs(Lcom/android/camera/Camera;)V
    .locals 1
...
.method public static synthetic Rs(Lj7/d0;)V
    .locals 1
...
.method private synthetic Ss()V
    ...
    invoke-static {}, Lda/h;->r()Ljava/util/Optional;
...
.method private synthetic Ts(Landroid/graphics/Bitmap;[FLda/x;Lj7/d;)V
    .locals 2

    new-instance v0, Landroid/util/Size;

    invoke-virtual {p3}, Lda/x;->i()I

    move-result v1

    invoke-virtual {p3}, Lda/x;->e()I
    ...
    invoke-interface {p4, p1, p2, v0, p3}, Lj7/d;->P9(Landroid/graphics/Bitmap;[FLandroid/util/Size;Ljava/lang/Runnable;)V

    return-void
.end method

.method private synthetic Us(Landroid/graphics/Bitmap;[FLda/x;)V
    .locals 2
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Lc3/q;-><init>(Lc3/s;Landroid/graphics/Bitmap;[FLda/x;)V
...
.method private synthetic Vs(Ljava/lang/String;Landroid/graphics/Bitmap;)V
    .locals 4
    ...
    invoke-static {p2, v1, v2}, Lze/c;->o(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    ...
    invoke-static {p2, p1, v3, v1}, Lcom/android/camera/c6;->x4(Landroid/graphics/Bitmap;Ljava/lang/String;ILandroid/graphics/Bitmap$CompressFormat;)Z
...
.method public static synthetic us(Landroid/net/Uri;)V
    ...
    invoke-static {p0}, Lc3/s;->Ns(Landroid/net/Uri;)V

    return-void
.end method

.method public static synthetic vs(Lj7/d0;)V
    .locals 0

    invoke-static {p0}, Lc3/s;->Rs(Lj7/d0;)V

    return-void
.end method

.method public static synthetic ws(Lc3/s;Lda/h;)V
    .locals 0

    invoke-direct {p0, p1}, Lc3/s;->Ms(Lda/h;)V

    return-void
.end method

.method public static synthetic xs(Lc3/s;Ljava/lang/String;Landroid/graphics/Bitmap;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lc3/s;->Vs(Ljava/lang/String;Landroid/graphics/Bitmap;)V

    return-void
.end method

.method public static synthetic ys(Lj7/o1;)V
    .locals 0

    invoke-static {p0}, Lc3/s;->Xs(Lj7/o1;)V

    return-void
.end method

.method public static synthetic zs(Lc3/s;Landroid/graphics/Bitmap;[FLda/x;Lj7/d;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lc3/s;->Ts(Landroid/graphics/Bitmap;[FLda/x;Lj7/d;)V
...
.method public G0(Z)V
    ...
    invoke-direct {p1, v0}, Lc3/r;-><init>(Lcom/android/camera/Camera;)V
...
.method public final Hs()Z
    ...
    invoke-virtual {p0, v1}, Lda/w;->c(I)Lda/c;
    ...
    invoke-virtual {p0}, Lda/h;->q()Landroid/util/Pair;
...
.method public final Is(Ljava/lang/String;Ljava/lang/String;Lcom/android/camera/Camera;)V
    .locals 4
    ...
    iget-object p1, p0, Lc3/s;->Fa:Landroid/net/Uri;
    ...
    invoke-virtual {p3}, Lcom/android/camera/ActivityBase;->yk()Z
    ...
    invoke-static {p3, v0, p1}, Lcom/android/camera/c6;->a5(Landroid/app/Activity;Landroid/content/Intent;I)Z

    move-result p1

    iput-boolean p1, p0, Lc3/s;->Ga:Z

    iget-boolean p0, p0, Lc3/s;->Ga:Z

    if-eqz p0, :cond_3

    const/4 p0, 0x6

    invoke-virtual {p3, p0}, Lcom/android/camera/ActivityBase;->lk(I)V
...
.method public final Js()V
    ...
    iget-object v0, p0, Lc3/s;->Fa:Landroid/net/Uri;

    if-eqz v0, :cond_0

    const/4 v1, 0x0

    iput-object v1, p0, Lc3/s;->Fa:Landroid/net/Uri;
    ...
    invoke-direct {v1, v0}, Lc3/f;-><init>(Landroid/net/Uri;)V
...
.method public Lo(Landroid/net/Uri;Ljava/lang/String;)V
    ...
    invoke-static {p2}, La8/x;->K(Ljava/lang/String;)Z
    ...
    iput-object p1, p0, Lc3/s;->Fa:Landroid/net/Uri;

    const-string p1, ".jpg"

    invoke-static {p2, p1}, La8/x;->o(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p2}, Lx0/h1;->J()Lx0/o;

    move-result-object p2

    iget v1, p0, Ld6/j0;->a:I

    invoke-virtual {p2, v1}, Lcom/android/camera/data/data/b;->getComponentValue(I)Ljava/lang/String;

    move-result-object p2

    invoke-virtual {p0, p1, p2, v0}, Lc3/s;->Is(Ljava/lang/String;Ljava/lang/String;Lcom/android/camera/Camera;)V
    ...
    invoke-direct {p2, p1}, Lc3/o;-><init>(Landroid/net/Uri;)V

    invoke-static {p0, p2}, Lcom/xiaomi/camera/rx/CameraSchedulers;->scheduleDirect(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
...
.method public Qr()V
    ...
    invoke-virtual {p0, v0}, Ld6/o2;->tr(Z)V
...
.method public Re(Landroid/net/Uri;ZLjava/lang/String;Z)V
    ...
    :cond_0
    invoke-virtual {p0, p1, p3}, Lc3/s;->Lo(Landroid/net/Uri;Ljava/lang/String;)V
...
.method public Wn(I)I
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/c3;->b(Z)I
...
.method public final Ys(Lda/h$a;)V
    .locals 18
    ...
    invoke-virtual {v0, v1}, Ld6/o2;->l0(I)V

    invoke-virtual/range {p1 .. p1}, Lda/h$a;->c()Lda/x;

    move-result-object v2

    invoke-virtual/range {p1 .. p1}, Lda/h$a;->b()[F

    move-result-object v11

    invoke-virtual/range {p1 .. p1}, Lda/h$a;->a()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lda/x;->c()[B

    move-result-object v4

    invoke-virtual {v2}, Lda/x;->i()I

    move-result v5

    invoke-virtual {v2}, Lda/x;->e()I
    ...
    invoke-direct {v6, v0, v3, v4, v2}, Lc3/k;-><init>(Lc3/s;Landroid/graphics/Bitmap;[FLda/x;)V

    invoke-virtual {v5, v6}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    sget-boolean v2, Lc3/s;->Ia:Z
    ...
    invoke-direct {v4, v0, v14, v3}, Lc3/l;-><init>(Lc3/s;Ljava/lang/String;Landroid/graphics/Bitmap;)V
    ...
    :cond_1
    sget-object v2, Lcom/android/camera/c3;->d:Lcom/android/camera/c3;

    invoke-virtual {v2, v1}, Lcom/android/camera/c3;->b(Z)I

    move-result v2

    invoke-static {v3, v2}, Lze/c;->h(Landroid/graphics/Bitmap;I)[B
    ...
    invoke-direct/range {v12 .. v17}, Ldd/x;-><init>(IJILjava/lang/String;)V

    invoke-virtual {v6, v5}, Ldd/x;->b1(Z)V
    ...
    invoke-virtual {v6, v2, v1}, Ldd/x;->a([BI)V
    ...
    invoke-direct {v1, v2, v7, v8, v3}, Ldd/y$b;-><init>(Landroid/util/Size;Landroid/util/Size;Landroid/util/Size;I)V
    ...
    invoke-virtual {v1, v2}, Ldd/y$b;->C(I)Ldd/y$b;
    ...
    invoke-virtual {v6, v1}, Ldd/x;->b(Ldd/y;)V
    ...
    invoke-virtual {v6, v5}, Ldd/x;->n1(Z)V
    ...
    invoke-virtual {v0, v6, v1, v1, v1}, La8/h;->k(Ldd/x;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
    ...
    :cond_7
    :goto_2
    invoke-virtual/range {p0 .. p0}, Lc3/s;->Zs()V
...
.method public final at()V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/camera2/v5;->k(Ly9/cr;Ljava/lang/Object;)V
...
.method public io()V
    ...
    invoke-interface {v0, v1}, Lj7/d0;->n5(Z)V
    ...
    invoke-direct {v1, p0}, Lc3/m;-><init>(Lc3/s;)V
...
.method public jo()Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Ld6/o2;->Jn(Z)V
...
.method public xq(Lcom/android/camera2/s5;)V
    ...
    iget-object v0, p0, Ld6/o2;->ka:Lda/h$a;

    if-eqz v0, :cond_0

    invoke-virtual {p0, v0}, Lc3/s;->Ys(Lda/h$a;)V
    ...
    invoke-direct {v1, p0, p1}, Lc3/n;-><init>(Lc3/s;Lcom/android/camera2/s5;)V
