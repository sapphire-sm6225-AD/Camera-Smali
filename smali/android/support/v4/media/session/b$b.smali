...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_1
    invoke-interface {p0, p1, v3}, Landroid/support/v4/media/session/b;->d0(Landroid/support/v4/media/RatingCompat;Landroid/os/Bundle;)V
    ...
    invoke-interface {p0, v3, p1}, Landroid/support/v4/media/session/b;->K(Landroid/support/v4/media/MediaDescriptionCompat;I)V
    ...
    :cond_7
    invoke-interface {p0, v0}, Landroid/support/v4/media/session/b;->h0(Z)V
    ...
    :cond_11
    invoke-interface {p0, v3}, Landroid/support/v4/media/session/b;->Q(Landroid/support/v4/media/RatingCompat;)V
    ...
    :cond_1a
    invoke-interface {p0, p1, p4, v3}, Landroid/support/v4/media/session/b;->g0(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/session/MediaSessionCompat$ResultReceiverWrapper;)V
