...
.method public c()Z
    ...
    invoke-virtual {p0}, Landroid/support/v4/media/session/MediaSessionCompat$Token;->d()Landroid/support/v4/media/session/b;
...
.method public final i(Landroid/support/v4/media/session/MediaControllerCompat$a;)V
    ...
    invoke-interface {p0, v1}, Landroid/support/v4/media/session/b;->k0(Landroid/support/v4/media/session/a;)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public r()V
    ...
    invoke-interface {v3, v2}, Landroid/support/v4/media/session/b;->j0(Landroid/support/v4/media/session/a;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
