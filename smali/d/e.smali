...
.method public static a(Ljava/lang/String;)Lc/b;
    ...
    invoke-static {p0, v0}, Ld/e;->b(Ljava/lang/String;Lc/b;)Lc/b;
...
.method public static b(Ljava/lang/String;Lc/b;)Lc/b;
    .locals 13
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lc/e;
    ...
    invoke-direct {p0, p1, v6}, Lc/e;-><init>(Ljava/lang/String;I)V
    ...
    :cond_6
    invoke-interface {p1, v7}, Lc/b;->y(I)V
    ...
    :cond_9
    :goto_3
    invoke-interface {p1, v7}, Lc/b;->u(I)V
    ...
    :cond_c
    :goto_4
    invoke-interface {p1, v7}, Lc/b;->d0(I)V
    ...
    :cond_d
    invoke-interface {p1, v3}, Lc/b;->u(I)V

    invoke-interface {p1, v3}, Lc/b;->d0(I)V
    ...
    invoke-interface {p1, v1}, Lc/b;->m0(I)V
    ...
    :cond_11
    :goto_6
    invoke-interface {p1, v1}, Lc/b;->n0(I)V
    ...
    :cond_13
    :goto_7
    invoke-interface {p1, v1}, Lc/b;->x0(I)V
    ...
    :cond_17
    invoke-interface {p1, v8}, Lc/b;->j0(I)V
    ...
    invoke-interface {p1, v1}, Lc/b;->setTimeZone(Ljava/util/TimeZone;)V
...
.method public static c(Lc/b;)Ljava/lang/String;
    .locals 8
    ...
    invoke-interface {p0}, Lc/b;->getHour()I

    move-result v2

    if-nez v2, :cond_2

    invoke-interface {p0}, Lc/b;->getMinute()I

    move-result v2

    if-nez v2, :cond_2

    invoke-interface {p0}, Lc/b;->getSecond()I

    move-result v2

    if-nez v2, :cond_2

    invoke-interface {p0}, Lc/b;->l()I

    move-result v2

    if-nez v2, :cond_2

    invoke-interface {p0}, Lc/b;->getTimeZone()Ljava/util/TimeZone;
