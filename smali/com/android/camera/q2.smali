.class public Lcom/android/camera/q2;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/camera/q2$e;,
        Lcom/android/camera/q2$g;,
        Lcom/android/camera/q2$f;,
        Lcom/android/camera/q2$c;,
        Lcom/android/camera/q2$b;,
        Lcom/android/camera/q2$d;,
        Lcom/android/camera/q2$a;
    }
.end annotation
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/camera/q2;->e:Ljava/util/WeakHashMap;
...
.method public constructor <init>(Landroid/content/Intent;)V
    ...
    iput-object v0, p0, Lcom/android/camera/q2;->c:Ljava/lang/Boolean;

    iput-object p1, p0, Lcom/android/camera/q2;->a:Landroid/content/Intent;

    invoke-virtual {p0, p1}, Lcom/android/camera/q2;->T(Landroid/content/Intent;)Landroid/net/Uri;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/q2;->b:Landroid/net/Uri;
...
.method public static M(Landroid/content/Intent;)Z
    ...
    invoke-static {p0}, Lcom/android/camera/q2;->o(Landroid/content/Intent;)I
...
.method public static U()V
    ...
    sget-object v0, Lcom/android/camera/q2;->e:Ljava/util/WeakHashMap;
...
.method public static l(Landroid/content/Intent;)Lcom/android/camera/q2;
    .locals 2
    ...
    check-cast v0, Lcom/android/camera/q2;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/camera/q2;

    invoke-direct {v0, p0}, Lcom/android/camera/q2;-><init>(Landroid/content/Intent;)V

    sget-object v1, Lcom/android/camera/q2;->e:Ljava/util/WeakHashMap;

    invoke-virtual {v1, p0, v0}, Ljava/util/WeakHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "CameraIntentManager"

    invoke-static {v1, p0}, Lcom/android/camera/q2$e;->a(Ljava/lang/String;Landroid/content/Intent;)V
...
.method public A()Z
    ...
    iget-object p0, p0, Lcom/android/camera/q2;->a:Landroid/content/Intent;
...
.method public D(Landroid/app/Activity;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/q2;->I(Landroid/app/Activity;)Z
...
.method public G(Landroid/app/Activity;)Z
    ...
    iget-object v0, p0, Lcom/android/camera/q2;->a:Landroid/content/Intent;
    ...
    invoke-virtual {p0}, Lcom/android/camera/q2;->d()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/camera/q2;->a:Landroid/content/Intent;
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/q2;->x(Landroid/app/Activity;)Z
    ...
    :cond_2
    invoke-virtual {p0}, Lcom/android/camera/q2;->F()Z
    ...
    :cond_6
    iget-object p1, p0, Lcom/android/camera/q2;->a:Landroid/content/Intent;
...
.method public I(Landroid/app/Activity;)Z
    ...
    invoke-virtual {p0}, Lcom/android/camera/q2;->L()Z
...
.method public a()Z
    ...
    iget-object v0, p0, Lcom/android/camera/q2;->c:Ljava/lang/Boolean;
    ...
    :cond_9
    :goto_1
    iget-object p0, p0, Lcom/android/camera/q2;->c:Ljava/lang/Boolean;
...
.method public b(Landroid/app/Activity;)Z
    ...
    invoke-virtual {p0}, Lcom/android/camera/q2;->z()Z
...
.method public c()V
    ...
    iget-object v1, p0, Lcom/android/camera/q2;->a:Landroid/content/Intent;

    invoke-virtual {v0, v1}, Ljava/util/WeakHashMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/camera/q2;->b:Landroid/net/Uri;
...
.method public d()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/android/camera/q2;->b:Landroid/net/Uri;

    if-nez v0, :cond_0

    iget-object v0, p0, Lcom/android/camera/q2;->a:Landroid/content/Intent;

    invoke-virtual {p0, v0}, Lcom/android/camera/q2;->T(Landroid/content/Intent;)Landroid/net/Uri;
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/camera/q2;->b:Landroid/net/Uri;
...
.method public g()I
    ...
    invoke-virtual {p0}, Lcom/android/camera/q2;->f()Ljava/lang/String;
...
.method public w()Ljava/lang/Boolean;
    ...
    invoke-virtual {p0}, Lcom/android/camera/q2;->e()I
...
.method public final x(Landroid/app/Activity;)Z
    ...
    invoke-static {}, Lcom/android/camera/p3;->b()Lcom/android/camera/p3;

    move-result-object p1

    invoke-virtual {p1}, Lcom/android/camera/p3;->a()I
