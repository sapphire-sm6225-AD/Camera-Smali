...
.method public static synthetic Tj(Lj7/o;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/fragment/ocr/FragmentOCR;->ck(Lj7/o;)V
...
.method public static synthetic Uj(Lj7/o;)V
    ...
    invoke-static {p0}, Lcom/android/camera/fragment/ocr/FragmentOCR;->ak(Lj7/o;)V

    return-void
.end method

.method public static synthetic Vj(Lcom/android/camera/fragment/ocr/FragmentOCR;)V
    .locals 0

    invoke-virtual {p0}, Lcom/android/camera/fragment/ocr/FragmentOCR;->Zj()V
...
.method public static synthetic Wj(Lj7/c1;)V
    ...
    invoke-static {p0}, Lcom/android/camera/fragment/ocr/FragmentOCR;->dk(Lj7/c1;)V

    return-void
.end method

.method public static synthetic Xj(Lcom/android/camera/fragment/ocr/FragmentOCR;Ljava/lang/Boolean;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera/fragment/ocr/FragmentOCR;->bk(Ljava/lang/Boolean;)V
...
.method public static synthetic ak(Lj7/o;)V
    ...
    invoke-interface {p0, v0}, Lj7/o;->D7(Z)V

    return-void
.end method

.method private synthetic bk(Ljava/lang/Boolean;)V
    .locals 0
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/ocr/FragmentOCR;->xi()V
...
.method public final Yj()V
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/ocr/FragmentOCR;->c:Lno/d;
...
.method public final Zj()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/ocr/FragmentOCR;->Yj()V
...
.method public gc(Lcom/xiaomi/ocr/sdk_ocr/OCRData$Location;)V
    .locals 10
...
.method public kc(Landroid/view/View;I)V
    .locals 4
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/ocr/FragmentOCR;->c:Lno/d;
    ...
    invoke-direct {v0, v2}, Lno/d;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/camera/fragment/ocr/FragmentOCR;->c:Lno/d;

    const/16 v2, 0xbb8

    invoke-virtual {v0, v2}, Lno/d;->I(I)V

    iget-object v0, p0, Lcom/android/camera/fragment/ocr/FragmentOCR;->c:Lno/d;

    const v2, 0x7f12074f

    invoke-virtual {v0, v2}, Lno/d;->F(I)V
    ...
    invoke-virtual {v0, p1, p2, v1, v2}, Lno/d;->K(Landroid/view/View;IIZ)V

    goto :goto_0

    :cond_1
    iget-object p2, p0, Lcom/android/camera/fragment/ocr/FragmentOCR;->c:Lno/d;

    const/16 v0, 0x10

    invoke-virtual {p2, v0}, Lno/a;->m(I)V

    iget-object p2, p0, Lcom/android/camera/fragment/ocr/FragmentOCR;->c:Lno/d;

    invoke-virtual {p2, p1, v2}, Lno/d;->L(Landroid/view/View;Z)V
...
.method public notifyDataChanged(II)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/ocr/FragmentOCR;->ek()V
