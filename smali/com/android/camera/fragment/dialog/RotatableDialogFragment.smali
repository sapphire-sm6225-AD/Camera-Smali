...
.method public static synthetic Nj(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/android/camera/fragment/dialog/RotatableDialogFragment;->Rj(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
...
.method public static synthetic Oj(Lcom/android/camera/fragment/dialog/RotatableDialogFragment;Landroid/app/Dialog;ILandroid/content/DialogInterface;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/camera/fragment/dialog/RotatableDialogFragment;->Tj(Landroid/app/Dialog;ILandroid/content/DialogInterface;)V

    return-void
.end method

.method public static synthetic Pj(Lcom/android/camera/fragment/dialog/RotatableDialogFragment;Landroid/content/DialogInterface;I)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera/fragment/dialog/RotatableDialogFragment;->Sj(Landroid/content/DialogInterface;I)V

    return-void
.end method

.method public static synthetic Rj(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    .locals 0
...
.method private synthetic Sj(Landroid/content/DialogInterface;I)V
    .locals 1
...
.method private synthetic Tj(Landroid/app/Dialog;ILandroid/content/DialogInterface;)V
    .locals 2
    ...
    invoke-virtual {p0, p2}, Lcom/android/camera/fragment/dialog/RotatableDialogFragment;->Wj(I)V
...
# virtual methods
.method public final Qj(Landroid/os/Bundle;Lcom/android/camera2/q3;)Lmiuix/appcompat/app/AlertDialog$b;
    .locals 6
    ...
    new-instance p0, Lcom/android/camera/fragment/dialog/j;

    invoke-direct {p0}, Lcom/android/camera/fragment/dialog/j;-><init>()V
...
.method public Uj(Landroidx/fragment/app/FragmentManager;)V
    .locals 0
    ...
    invoke-static {p1, p0}, Lze/d;->d(Landroidx/fragment/app/FragmentManager;Ljava/lang/String;)Z

    return-void
.end method

.method public Vj(IIIII)V
    .locals 2
...
.method public Wj(I)V
    ...
    :cond_0
    invoke-static {v0}, Lzm/n;->k(Landroid/view/View;)Landroid/graphics/Point;
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    new-instance v1, Lcom/android/camera/fragment/dialog/k;

    invoke-direct {v1, p0}, Lcom/android/camera/fragment/dialog/k;-><init>(Lcom/android/camera/fragment/dialog/RotatableDialogFragment;)V

    const/4 v2, 0x0

    invoke-static {v1, v2}, Lcom/android/camera2/q3;->d(Landroid/content/DialogInterface$OnClickListener;Landroid/content/DialogInterface$OnCancelListener;)Lcom/android/camera2/q3;

    move-result-object v1

    invoke-virtual {p0, v0, v1}, Lcom/android/camera/fragment/dialog/RotatableDialogFragment;->Qj(Landroid/os/Bundle;Lcom/android/camera2/q3;)Lmiuix/appcompat/app/AlertDialog$b;
    ...
    invoke-virtual {v1, v0}, Lcom/android/camera2/q3;->c(Landroid/app/Dialog;)V

    new-instance v1, Lcom/android/camera/fragment/dialog/l;

    invoke-direct {v1, p0, v0, p1}, Lcom/android/camera/fragment/dialog/l;-><init>(Lcom/android/camera/fragment/dialog/RotatableDialogFragment;Landroid/app/Dialog;I)V
