...
.method public static synthetic Tj(Lcom/android/camera/fragment/FragmentWatermarkBase;Le0/e;Lc0/u;Landroid/graphics/Rect;Lx0/e;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lcom/android/camera/fragment/FragmentWatermarkBase;->dk(Le0/e;Lc0/u;Landroid/graphics/Rect;Lx0/e;Ljava/util/concurrent/atomic/AtomicBoolean;)V

    return-void
.end method

.method public static synthetic Uj(Lcom/android/camera/fragment/FragmentWatermarkBase;Landroid/view/View;Landroid/view/View;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera/fragment/FragmentWatermarkBase;->ck(Landroid/view/View;Landroid/view/View;)V

    return-void
.end method

.method public static synthetic Vj(Lcom/android/camera/fragment/FragmentWatermarkBase;Landroid/view/View;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera/fragment/FragmentWatermarkBase;->bk(Landroid/view/View;)V

    return-void
.end method

.method public static synthetic Wj(Lcom/android/camera/fragment/FragmentWatermarkBase;Le0/e;Lc0/u;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/camera/fragment/FragmentWatermarkBase;->ek(Le0/e;Lc0/u;Ljava/util/concurrent/atomic/AtomicBoolean;)V

    return-void
.end method

.method private synthetic bk(Landroid/view/View;)V
    .locals 0
...
.method private synthetic ck(Landroid/view/View;Landroid/view/View;)V
    .locals 2
    ...
    :cond_0
    new-instance p2, Lcom/android/camera/fragment/n4;

    invoke-direct {p2, p0, p1}, Lcom/android/camera/fragment/n4;-><init>(Lcom/android/camera/fragment/FragmentWatermarkBase;Landroid/view/View;)V
...
.method private synthetic dk(Le0/e;Lc0/u;Landroid/graphics/Rect;Lx0/e;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    .locals 3
    ...
    invoke-virtual {p0, v0, p3, p4, p2}, Lcom/android/camera/fragment/FragmentWatermarkBase;->lk([ILandroid/graphics/Rect;Lx0/e;Lc0/u;)V

    invoke-virtual {p0, p1, p2}, Lcom/android/camera/fragment/FragmentWatermarkBase;->ik(Le0/e;Lc0/u;)Z
...
.method private synthetic ek(Le0/e;Lc0/u;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    .locals 1
...
.method public Qg(Lc0/u;)V
    ...
    invoke-virtual {p0, v0, p1}, Lcom/android/camera/fragment/FragmentWatermarkBase;->kk(Lx0/e;Lc0/u;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/FragmentWatermarkBase;->nk()V
...
.method public Xj(Landroid/view/View;)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/android/camera/fragment/o4;-><init>(Lcom/android/camera/fragment/FragmentWatermarkBase;Landroid/view/View;)V
...
.method public Y2(I)V
    ...
    invoke-virtual {p0, v0, p1}, Lcom/android/camera/fragment/FragmentWatermarkBase;->gk(Landroid/view/View;I)V

    return-void
.end method

.method public final Yj()F
    .locals 1
...
.method public Zj()Landroid/graphics/Rect;
    .locals 2
...
.method public abstract ak(ILjava/lang/String;)Le0/e;
.end method

.method public abstract fk(Lc0/u;Le0/e;Landroid/widget/FrameLayout$LayoutParams;)V
.end method
...
.method public gk(Landroid/view/View;I)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/FragmentWatermarkBase;->hk(Landroid/view/View;)V
...
.method public ik(Le0/e;Lc0/u;)Z
    .locals 2
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/camera/fragment/FragmentWatermarkBase;->gk(Landroid/view/View;I)V

    invoke-interface {p1}, Le0/e;->h()Landroid/view/View;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/FragmentWatermarkBase;->jk(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/camera/fragment/FragmentWatermarkBase;->gk(Landroid/view/View;I)V
...
.method public abstract jk(Landroid/view/View;)V
.end method

.method public kk(Lx0/e;Lc0/u;)V
    .locals 0

    invoke-virtual {p1, p2}, Lx0/e;->E(Lc0/u;)V

    return-void
.end method

.method public abstract lk([ILandroid/graphics/Rect;Lx0/e;Lc0/u;)V
.end method

.method public mk(Landroid/graphics/Rect;Lx0/e;Lc0/u;Ljava/lang/String;)V
    .locals 16
    ...
    invoke-virtual {v7, v0, v1}, Lcom/android/camera/fragment/FragmentWatermarkBase;->ak(ILjava/lang/String;)Le0/e;
    ...
    invoke-virtual {v7, v8, v12, v0}, Lcom/android/camera/fragment/FragmentWatermarkBase;->fk(Lc0/u;Le0/e;Landroid/widget/FrameLayout$LayoutParams;)V
    ...
    new-instance v15, Lcom/android/camera/fragment/l4;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/camera/fragment/l4;-><init>(Lcom/android/camera/fragment/FragmentWatermarkBase;Le0/e;Lc0/u;Landroid/graphics/Rect;Lx0/e;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    ...
    invoke-direct {v1, v7, v12, v8, v13}, Lcom/android/camera/fragment/m4;-><init>(Lcom/android/camera/fragment/FragmentWatermarkBase;Le0/e;Lc0/u;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    ...
    invoke-virtual {v7, v0}, Lcom/android/camera/fragment/FragmentWatermarkBase;->Xj(Landroid/view/View;)V
...
.method public nk()V
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/camera/fragment/FragmentWatermarkBase;->Zj()Landroid/graphics/Rect;

    move-result-object v1

    invoke-virtual {v0}, Lx0/e;->m()Lc0/u;
    ...
    invoke-virtual {p0, v1, v0, v2, v3}, Lcom/android/camera/fragment/FragmentWatermarkBase;->mk(Landroid/graphics/Rect;Lx0/e;Lc0/u;Ljava/lang/String;)V
...
.method public updateView(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/FragmentWatermarkBase;->Yj()F
