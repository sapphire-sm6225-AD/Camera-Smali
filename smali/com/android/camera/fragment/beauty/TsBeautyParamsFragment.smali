...
.method public static synthetic Ck(Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;->Ok(Landroid/widget/AdapterView;Landroid/view/View;IJ)V

    return-void
.end method

.method public static synthetic Dk(Lcom/android/camera/data/data/j;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;->Pk(Lcom/android/camera/data/data/j;)V

    return-void
.end method

.method public static synthetic Ek(Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;ZLcom/android/camera/data/data/j;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;->Lk(ZLcom/android/camera/data/data/j;)V

    return-void
.end method

.method public static synthetic Fk(Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;ZLcom/android/camera/data/data/j;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;->Nk(ZLcom/android/camera/data/data/j;)V

    return-void
.end method

.method public static synthetic Gk(Landroid/text/SpannableStringBuilder;Ljava/util/concurrent/atomic/AtomicInteger;Landroid/text/Spanned;Ljava/util/concurrent/atomic/AtomicInteger;Landroid/text/style/URLSpan;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;->Mk(Landroid/text/SpannableStringBuilder;Ljava/util/concurrent/atomic/AtomicInteger;Landroid/text/Spanned;Ljava/util/concurrent/atomic/AtomicInteger;Landroid/text/style/URLSpan;)V

    return-void
.end method

.method public static synthetic Hk(Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;)Ll9/a;
    .locals 0
...
.method public static synthetic Ik(Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;)V
    .locals 0

    invoke-virtual {p0}, Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;->Qk()V

    return-void
.end method

.method private synthetic Lk(ZLcom/android/camera/data/data/j;)V
    .locals 1
...
.method public static synthetic Mk(Landroid/text/SpannableStringBuilder;Ljava/util/concurrent/atomic/AtomicInteger;Landroid/text/Spanned;Ljava/util/concurrent/atomic/AtomicInteger;Landroid/text/style/URLSpan;)V
    .locals 0
...
.method private synthetic Nk(ZLcom/android/camera/data/data/j;)V
    .locals 1
...
.method private synthetic Ok(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    .locals 0
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;->Jk(Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;->Zj()Ljava/lang/String;
...
.method public static synthetic Pk(Lcom/android/camera/data/data/j;)V
    .locals 4
...
.method public Jk(Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;->Kk()Z
...
.method public final Kk()Z
    ...
    invoke-static {p0}, Lcom/android/camera/q2;->K(Landroid/content/Intent;)Z
...
.method public final Qk()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/beauty/BaseBeautyMakeupFragment;->Xj()Ljava/util/List;
    ...
    new-instance v1, Lcom/android/camera/fragment/beauty/v0;

    invoke-direct {v1}, Lcom/android/camera/fragment/beauty/v0;-><init>()V
...
.method public Sj()V
    ...
    invoke-super {p0}, Lcom/android/camera/fragment/beauty/BaseBeautyMakeupFragment;->Sj()V

    iget v0, p0, Lcom/android/camera/fragment/BaseViewPagerFragment;->mCurrentMode:I

    const/4 v1, 0x0

    invoke-static {v0, v1}, Lcom/android/camera/t2;->n4(ILcom/android/camera/fragment/beauty/c0;)Z
    ...
    new-instance v2, Lcom/android/camera/fragment/beauty/x0;

    invoke-direct {v2, p0, v0}, Lcom/android/camera/fragment/beauty/x0;-><init>(Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;Z)V
...
.method public ik()Landroid/widget/AdapterView$OnItemClickListener;
    ...
    new-instance v0, Lcom/android/camera/fragment/beauty/u0;

    invoke-direct {v0, p0}, Lcom/android/camera/fragment/beauty/u0;-><init>(Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;)V
