...
.method public static synthetic H(Lcom/android/camera/litegallery/a;Landroid/content/Context;)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v0}, Lcom/android/camera/litegallery/GalleryContainerManager;->d0()La6/r1;

    move-result-object v0

    invoke-virtual {v0, p0}, La6/r1;->m(Lcom/android/camera/litegallery/a;)V
...
.method public static synthetic K(Ljava/lang/String;Lcom/android/camera/litegallery/b$b;)Lcom/android/camera/litegallery/b;
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera/litegallery/c;->P(Ljava/lang/String;Lcom/android/camera/litegallery/b$b;)Lcom/android/camera/litegallery/b;
...
.method public static synthetic N(Lcom/android/camera/litegallery/a;Landroid/widget/ImageView;Ljava/lang/Object;)V
    ...
    invoke-direct {p2, p0, p1}, La6/x1;-><init>(Lcom/android/camera/litegallery/a;Landroid/widget/ImageView;)V
...
.method public static O(Ljava/lang/String;Lcom/android/camera/litegallery/b$b;)Z
    .locals 12
...
.method public static P(Ljava/lang/String;Lcom/android/camera/litegallery/b$b;)Lcom/android/camera/litegallery/b;
    .locals 5
    ...
    invoke-static {p0, p1}, Lcom/android/camera/litegallery/c;->O(Ljava/lang/String;Lcom/android/camera/litegallery/b$b;)Z
...
.method public static Q(Ljava/lang/String;Lcom/android/camera/litegallery/b$b;)Ljava/util/concurrent/CompletableFuture;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1}, La6/y1;-><init>(Ljava/lang/String;Lcom/android/camera/litegallery/b$b;)V
    ...
    invoke-direct {p1}, La6/z1;-><init>()V
...
.method public static R(Landroid/content/Context;[BI)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p1, p2}, La6/b2;->a(Landroid/content/Context;[BI)Landroid/graphics/Bitmap;
...
.method public static T(Landroid/content/Context;Landroid/net/Uri;ILandroid/util/Size;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p1, p2, p3}, La6/b2;->b(Landroid/content/Context;Landroid/net/Uri;ILandroid/util/Size;)Landroid/graphics/Bitmap;
...
.method public static V(Landroid/content/Context;Lcom/android/camera/litegallery/a;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p1}, Lcom/android/camera/c6;->r5(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
...
.method public static Y(Lcom/android/camera/litegallery/a;Landroid/widget/ImageView;Z)V
    ...
    invoke-direct {v0, p0, p1}, La6/w1;-><init>(Lcom/android/camera/litegallery/a;Landroid/widget/ImageView;)V
...
.method public static Z(Lcom/android/camera/litegallery/a;Landroid/widget/ImageView;)V
    ...
    invoke-static {p0}, La6/d1;->b(I)Landroid/graphics/drawable/Drawable;
...
.method public static synthetic e(Ljava/lang/String;Lcom/android/camera/litegallery/b$b;)Lcom/android/camera/litegallery/b;
    ...
    invoke-static {p0, p1}, Lcom/android/camera/litegallery/c;->K(Ljava/lang/String;Lcom/android/camera/litegallery/b$b;)Lcom/android/camera/litegallery/b;
...
.method public static k(Landroid/content/Context;J)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-direct {v0, p0, p1, p2}, La6/u1;-><init>(Landroid/content/Context;J)V

    invoke-static {v0, v2}, Ljava/util/concurrent/CompletableFuture;->supplyAsync(Ljava/util/function/Supplier;Ljava/util/concurrent/Executor;)Ljava/util/concurrent/CompletableFuture;

    move-result-object p0

    new-instance p1, La6/v1;

    invoke-direct {p1}, La6/v1;-><init>()V
...
.method public static r(Landroid/content/Context;Lcom/android/camera/litegallery/a;)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-direct {v1, p1, p0}, La6/s1;-><init>(Lcom/android/camera/litegallery/a;Landroid/content/Context;)V
...
.method public static s([B)I
    ...
    invoke-direct {p0, v1}, Lwb/e;-><init>(Ljava/io/InputStream;)V
...
.method public static u([BIII)Landroid/util/Size;
    ...
    invoke-virtual {p0, v5, v4}, Lwb/e;->n(Ljava/lang/String;I)I

    move-result v5

    const-string v6, "ImageLength"

    invoke-virtual {p0, v6, v4}, Lwb/e;->n(Ljava/lang/String;I)I
...
.method public static x(Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-static {v0}, Lsq/k;->n(Ljava/io/File;)Ltq/h0;

    move-result-object p0

    if-eqz p0, :cond_0

    invoke-virtual {p0}, Ltq/h0;->J()Ljava/util/Map;
...
.method public static y()Z
    ...
    new-instance v1, La6/a2;

    invoke-direct {v1}, La6/a2;-><init>()V
