...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/camera/k5$c;,
        Lcom/android/camera/k5$b;
    }
.end annotation
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/camera/k5;->s:Ljava/util/concurrent/locks/ReentrantLock;

    const/4 v0, 0x0

    sput v0, Lcom/android/camera/k5;->u:I

    const/4 v0, 0x1

    sput v0, Lcom/android/camera/k5;->v:I

    const/4 v0, 0x2

    sput v0, Lcom/android/camera/k5;->w:I
...
.method public constructor <init>(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)V
    ...
    iput-boolean v0, p0, Lcom/android/camera/k5;->d:Z

    iput-boolean v0, p0, Lcom/android/camera/k5;->e:Z

    iput-boolean v0, p0, Lcom/android/camera/k5;->h:Z

    const/4 v1, -0x1

    iput v1, p0, Lcom/android/camera/k5;->i:I

    iput v1, p0, Lcom/android/camera/k5;->j:I

    const-wide/16 v1, -0x1

    iput-wide v1, p0, Lcom/android/camera/k5;->k:J

    iput-boolean v0, p0, Lcom/android/camera/k5;->l:Z

    iput-object p1, p0, Lcom/android/camera/k5;->a:Landroid/net/Uri;

    invoke-static {p2, p3, p4}, Lcom/android/camera/k5;->a(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/k5;->b:Landroid/graphics/Bitmap;
...
.method public static c(Landroid/database/Cursor;)Lcom/android/camera/k5$b;
    .locals 18
    ...
    invoke-static {v2, v4}, Lcom/android/camera/c6;->r5(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    new-instance v4, Lcom/android/camera/k5$b;
    ...
    invoke-direct/range {v5 .. v17}, Lcom/android/camera/k5$b;-><init>(JIJLjava/lang/String;IIZZJ)V
    :try_end_0
...
.method public static d(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lcom/android/camera/k5;
    .locals 1
    ...
    invoke-direct {v0, p0, p1, p2, p3}, Lcom/android/camera/k5;-><init>(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)V

    return-object v0
.end method

.method public static e([BIILandroid/net/Uri;Z)Lcom/android/camera/k5;
    .locals 4
    ...
    invoke-virtual {v0}, Lwb/e;->M()Landroid/graphics/Bitmap;
    ...
    :cond_3
    invoke-static {p3, v0, p1, p4}, Lcom/android/camera/k5;->d(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lcom/android/camera/k5;
...
.method public static f(Landroid/content/Context;Landroid/net/Uri;Z)Lcom/android/camera/k5;
    .locals 25
    ...
    invoke-static {v6}, Lcom/android/camera/c6;->e1(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6, v13, v12, v11}, Lcom/android/camera/k5;->A(Ljava/lang/String;III)Landroid/graphics/Bitmap;
    ...
    :cond_c
    invoke-static {v6, v13, v12}, Lcom/android/camera/k5;->l(Ljava/lang/String;II)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, v1, v7, v4}, Lcom/android/camera/k5;->d(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lcom/android/camera/k5;

    move-result-object v0

    if-eqz v0, :cond_e

    invoke-virtual {v0, v2, v3}, Lcom/android/camera/k5;->L(J)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/camera/k5;->O(Z)V
...
.method public static g(Landroid/content/Context;Landroid/net/Uri;II)Landroid/graphics/Bitmap;
    ...
    invoke-static/range {v0 .. v6}, Lcom/android/camera/k5;->j(Landroid/media/MediaMetadataRetriever;Ljava/lang/String;Ljava/io/FileDescriptor;Landroid/content/Context;Landroid/net/Uri;II)Landroid/graphics/Bitmap;
...
.method public static j(Landroid/media/MediaMetadataRetriever;Ljava/lang/String;Ljava/io/FileDescriptor;Landroid/content/Context;Landroid/net/Uri;II)Landroid/graphics/Bitmap;
    ...
    new-instance p4, Lcom/android/camera/k5$c;

    invoke-direct {p4, p1, v1}, Lcom/android/camera/k5$c;-><init>(Landroid/util/Size;Lcom/android/camera/k5$a;)V
    ...
    invoke-static {p1}, Lhf/c;->a([B)Landroid/graphics/ImageDecoder$Source;
...
.method public static t(Landroid/content/ContentResolver;)Lcom/android/camera/k5$b;
    .locals 11
    ...
    invoke-static {}, Lcom/android/camera/k5;->o()Ljava/lang/String;
    ...
    invoke-static {v5}, Lcom/android/camera/k5;->c(Landroid/database/Cursor;)Lcom/android/camera/k5$b;
    ...
    invoke-static {p0}, Lcom/android/camera/k5;->c(Landroid/database/Cursor;)Lcom/android/camera/k5$b;
...
.method public static v(Landroid/content/Context;[Lcom/android/camera/k5;Landroid/net/Uri;Lcom/android/camera/k5$b;)I
    .locals 16
    ...
    invoke-static {v7}, Lcom/android/camera/k5;->t(Landroid/content/ContentResolver;)Lcom/android/camera/k5$b;
    ...
    invoke-static {v0, v1}, Lcom/android/camera/k5;->y(J)Lcom/android/camera/k5;
    ...
    :cond_2
    iget-boolean v4, v2, Lcom/android/camera/k5$b;->i:Z
    ...
    iget-wide v14, v11, Lcom/android/camera/k5$b;->c:J

    invoke-static {v14, v15}, Lcom/android/camera/k5;->y(J)Lcom/android/camera/k5;
    ...
    invoke-virtual {v4}, Lcom/android/camera/k5;->E()Landroid/net/Uri;
    ...
    iget-object v3, v11, Lcom/android/camera/k5$b;->d:Landroid/net/Uri;
    ...
    iget-object v1, v11, Lcom/android/camera/k5$b;->d:Landroid/net/Uri;
    ...
    :cond_6
    iget-object v14, v11, Lcom/android/camera/k5$b;->e:Ljava/lang/String;

    invoke-static {v14}, Lcom/android/camera/c6;->e1(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-wide v2, v11, Lcom/android/camera/k5$b;->a:J

    iget v4, v11, Lcom/android/camera/k5$b;->b:I
    ...
    invoke-static/range {v1 .. v6}, Lcom/android/camera/k5;->z(Landroid/content/Context;JILjava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    :cond_7
    iget-wide v0, v11, Lcom/android/camera/k5$b;->a:J
    ...
    iget v0, v11, Lcom/android/camera/k5$b;->f:I

    iget v1, v11, Lcom/android/camera/k5$b;->g:I

    iget v2, v11, Lcom/android/camera/k5$b;->b:I

    invoke-static {v14, v0, v1, v2}, Lcom/android/camera/k5;->A(Ljava/lang/String;III)Landroid/graphics/Bitmap;
    ...
    iget-object v3, v12, Lcom/android/camera/k5$b;->d:Landroid/net/Uri;
    ...
    iget-object v1, v12, Lcom/android/camera/k5$b;->d:Landroid/net/Uri;
    ...
    :cond_a
    iget-object v1, v12, Lcom/android/camera/k5$b;->e:Ljava/lang/String;
    ...
    invoke-static {v0, v1, v10}, Lcom/android/camera/k5;->f(Landroid/content/Context;Landroid/net/Uri;Z)Lcom/android/camera/k5;

    move-result-object v0

    if-eqz v0, :cond_c

    iget-object v0, v0, Lcom/android/camera/k5;->b:Landroid/graphics/Bitmap;
    ...
    :cond_d
    :goto_6
    iget-object v0, v11, Lcom/android/camera/k5$b;->d:Landroid/net/Uri;

    invoke-static {v0, v7}, Lcom/android/camera/c6;->B3(Landroid/net/Uri;Landroid/content/ContentResolver;)Z
    ...
    iget-object v2, v11, Lcom/android/camera/k5$b;->d:Landroid/net/Uri;
    ...
    invoke-static {v0, v1, v10, v10}, Lcom/android/camera/k5;->d(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lcom/android/camera/k5;
    ...
    iget-boolean v1, v11, Lcom/android/camera/k5$b;->h:Z

    if-eqz v1, :cond_e

    invoke-virtual {v0, v13}, Lcom/android/camera/k5;->O(Z)V

    aget-object v0, p1, v10

    iget v1, v11, Lcom/android/camera/k5$b;->f:I

    iget v2, v11, Lcom/android/camera/k5$b;->g:I

    invoke-virtual {v0, v1, v2}, Lcom/android/camera/k5;->N(II)V

    :cond_e
    aget-object v0, p1, v10

    iget-wide v1, v11, Lcom/android/camera/k5$b;->j:J

    invoke-virtual {v0, v1, v2}, Lcom/android/camera/k5;->L(J)V

    aget-object v0, p1, v10

    sget v1, Lcom/android/camera/k5;->v:I

    invoke-virtual {v0, v1}, Lcom/android/camera/k5;->R(I)V
...
.method public static w(Ljava/io/File;Landroid/content/ContentResolver;)Lcom/android/camera/k5;
    .locals 16
    ...
    :try_start_0
    sget-object v5, Lcom/android/camera/k5;->s:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    invoke-static {v8}, Lcom/android/camera/c6;->G(Ljava/io/Closeable;)V
    ...
    invoke-static {v5, v0}, Lcom/android/camera/c6;->B3(Landroid/net/Uri;Landroid/content/ContentResolver;)Z
    ...
    sget-object v0, Lcom/android/camera/k5;->s:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    sget-object v2, Lcom/android/camera/k5;->s:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    :cond_8
    invoke-static {v5, v0, v4, v4}, Lcom/android/camera/k5;->d(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lcom/android/camera/k5;

    move-result-object v0

    if-eqz v0, :cond_9

    invoke-virtual {v0, v11}, Lcom/android/camera/k5;->O(Z)V

    invoke-virtual {v0, v12, v13}, Lcom/android/camera/k5;->N(II)V

    const/4 v2, 0x1

    invoke-virtual {v0, v2}, Lcom/android/camera/k5;->M(Z)V

    invoke-virtual {v0, v3}, Lcom/android/camera/k5;->P(Z)V

    invoke-virtual {v0, v14, v15}, Lcom/android/camera/k5;->L(J)V

    sget v2, Lcom/android/camera/k5;->w:I

    invoke-virtual {v0, v2}, Lcom/android/camera/k5;->R(I)V
    ...
    :goto_c
    invoke-static {v3}, Lcom/android/camera/c6;->G(Ljava/io/Closeable;)V

    invoke-static {v7}, Lcom/android/camera/c6;->G(Ljava/io/Closeable;)V

    invoke-static {v8}, Lcom/android/camera/c6;->G(Ljava/io/Closeable;)V

    sget-object v1, Lcom/android/camera/k5;->s:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public static x(Landroid/content/Context;[Lcom/android/camera/k5;Ljava/util/ArrayList;Landroid/net/Uri;)I
    .locals 5
    ...
    invoke-static {v3, v4}, Lcom/android/camera/c6;->B3(Landroid/net/Uri;Landroid/content/ContentResolver;)Z
    ...
    :cond_1
    invoke-static {p0, v3, v0}, Lcom/android/camera/k5;->f(Landroid/content/Context;Landroid/net/Uri;Z)Lcom/android/camera/k5;
...
.method public static y(J)Lcom/android/camera/k5;
    .locals 6
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    invoke-static {p1, p0}, La8/x;->a0(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    invoke-static {p0, p1, v0, v1}, Lcom/android/camera/k5;->d(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lcom/android/camera/k5;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/camera/k5;->L(J)V

    sget p1, Lcom/android/camera/k5;->u:I

    invoke-virtual {p0, p1}, Lcom/android/camera/k5;->R(I)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static z(Landroid/content/Context;JILjava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, v7, p4}, La8/x;->B(Landroid/content/Context;ZLjava/lang/String;)Landroid/net/Uri;
...
.method public B()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/camera/k5;->g:Ljava/lang/String;
...
.method public C()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/camera/k5;->f:Ljava/lang/String;
...
.method public D()I
    ...
    iget p0, p0, Lcom/android/camera/k5;->m:I
...
.method public E()Landroid/net/Uri;
    ...
    iget-object p0, p0, Lcom/android/camera/k5;->a:Landroid/net/Uri;
...
.method public F()Z
    ...
    iget-object v1, p0, Lcom/android/camera/k5;->a:Landroid/net/Uri;
    ...
    iget-boolean v1, p0, Lcom/android/camera/k5;->l:Z
    ...
    iget-boolean p0, p0, Lcom/android/camera/k5;->l:Z
...
.method public G()Z
    ...
    iget-boolean p0, p0, Lcom/android/camera/k5;->e:Z
...
.method public H()Z
    ...
    invoke-virtual {p0}, Lcom/android/camera/k5;->D()I

    move-result p0

    sget v0, Lcom/android/camera/k5;->u:I
...
.method public I()Z
    ...
    iget-boolean p0, p0, Lcom/android/camera/k5;->d:Z
...
.method public J(Ljava/io/File;)V
    ...
    iget-object v0, p0, Lcom/android/camera/k5;->a:Landroid/net/Uri;
    ...
    :try_start_0
    sget-object v3, Lcom/android/camera/k5;->s:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    :try_start_3
    iget-object p1, p0, Lcom/android/camera/k5;->a:Landroid/net/Uri;
    ...
    invoke-virtual {p0}, Lcom/android/camera/k5;->G()Z
    ...
    invoke-virtual {p0}, Lcom/android/camera/k5;->r()I
    ...
    invoke-virtual {p0}, Lcom/android/camera/k5;->q()I
    ...
    invoke-virtual {p0}, Lcom/android/camera/k5;->p()J
    ...
    invoke-virtual {p0}, Lcom/android/camera/k5;->s()Z
    ...
    iget-object p0, p0, Lcom/android/camera/k5;->b:Landroid/graphics/Bitmap;
    ...
    invoke-static {v4}, Lcom/android/camera/c6;->G(Ljava/io/Closeable;)V

    invoke-static {v5}, Lcom/android/camera/c6;->G(Ljava/io/Closeable;)V
    ...
    invoke-static {p1}, Lcom/android/camera/c6;->G(Ljava/io/Closeable;)V

    invoke-static {v5}, Lcom/android/camera/c6;->G(Ljava/io/Closeable;)V

    invoke-static {v6}, Lcom/android/camera/c6;->G(Ljava/io/Closeable;)V

    sget-object p0, Lcom/android/camera/k5;->s:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    sget-object p1, Lcom/android/camera/k5;->s:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public L(J)V
    ...
    iput-wide p1, p0, Lcom/android/camera/k5;->k:J
...
.method public N(II)V
    ...
    iput p1, p0, Lcom/android/camera/k5;->i:I

    iput p2, p0, Lcom/android/camera/k5;->j:I
...
.method public P(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/camera/k5;->h:Z
...
.method public Q(J)V
    ...
    iput-object v0, p0, Lcom/android/camera/k5;->f:Ljava/lang/String;
    ...
    iput-object p1, p0, Lcom/android/camera/k5;->g:Ljava/lang/String;
...
.method public R(I)V
    ...
    iput p1, p0, Lcom/android/camera/k5;->m:I
...
.method public S(Landroid/net/Uri;)V
    ...
    iput-boolean v2, p0, Lcom/android/camera/k5;->d:Z
...
.method public m()Z
    ...
    iget-boolean p0, p0, Lcom/android/camera/k5;->c:Z
...
.method public p()J
    ...
    iget-wide v0, p0, Lcom/android/camera/k5;->k:J
...
.method public q()I
    ...
    iget p0, p0, Lcom/android/camera/k5;->j:I
...
.method public r()I
    ...
    iget p0, p0, Lcom/android/camera/k5;->i:I
...
.method public s()Z
    ...
    iget-boolean p0, p0, Lcom/android/camera/k5;->h:Z
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/camera/k5;->b:Landroid/graphics/Bitmap;
    ...
    iget-boolean v1, p0, Lcom/android/camera/k5;->c:Z
    ...
    iget-boolean v1, p0, Lcom/android/camera/k5;->d:Z
    ...
    iget v1, p0, Lcom/android/camera/k5;->i:I
    ...
    iget v1, p0, Lcom/android/camera/k5;->j:I
