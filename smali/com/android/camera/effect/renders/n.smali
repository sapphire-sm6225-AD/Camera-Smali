...
.method public constructor <init>(Lcom/android/gallery3d/ui/h;)V
    ...
    iput-object p1, p0, Lcom/android/camera/effect/renders/n;->i:Ljava/util/HashMap;
...
.method public deleteBuffer()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/n;->t()V
...
.method public draw(Lf2/c;)Z
    ...
    iget-object v2, v0, Lcom/android/camera/effect/renders/n;->f:Lh2/a;
    ...
    invoke-static {v10, v11, v12, v13}, Lcf/c;->f(IIII)Landroid/graphics/Rect;
    ...
    invoke-static {v6}, Lcf/c;->g(Landroid/util/Size;)Landroid/graphics/Rect;
    ...
    invoke-static {v10, v6}, Lcf/c;->e(II)Landroid/graphics/Rect;
    ...
    :cond_7
    iget v11, v0, Lcom/android/camera/effect/renders/n;->g:I

    iget v12, v0, Lcom/android/camera/effect/renders/n;->h:I

    invoke-virtual/range {p0 .. p0}, Lcom/android/camera/effect/renders/t;->m()Ljava/util/ArrayList;
    ...
    check-cast v9, Lcom/android/camera/effect/renders/s;
    ...
    iget-object v8, v0, Lcom/android/camera/effect/renders/n;->f:Lh2/a;

    iget v13, v0, Lcom/android/camera/effect/renders/s;->mParentFrameBufferId:I

    invoke-virtual {v8, v13}, Lh2/a;->d(I)Lh2/c;

    move-result-object v8

    invoke-virtual {v0, v8}, Lcom/android/camera/effect/renders/t;->d(Lh2/d;)V
    ...
    invoke-static {v11, v12}, Lcf/c;->e(II)Landroid/graphics/Rect;

    move-result-object v13

    invoke-direct {v8, v10, v13, v6, v15}, Lf2/i;-><init>(ILandroid/graphics/Rect;ZI)V

    invoke-virtual {v9, v8}, Lcom/android/camera/effect/renders/s;->draw(Lf2/c;)Z
    ...
    :cond_b
    invoke-virtual {v9, v1}, Lcom/android/camera/effect/renders/s;->draw(Lf2/c;)Z
    ...
    invoke-virtual {v9, v8, v11, v12}, Lcom/android/camera/effect/renders/s;->setPreviousFrameBufferInfo(III)V
    ...
    :cond_d
    invoke-virtual {v9, v15}, Lcom/android/camera/effect/renders/s;->draw(Lf2/c;)Z

    :goto_5
    if-eqz v7, :cond_e

    invoke-virtual/range {p0 .. p0}, Lcom/android/camera/effect/renders/t;->h()V
    ...
    iget v9, v0, Lcom/android/camera/effect/renders/s;->mParentFrameBufferId:I
...
.method public final declared-synchronized t()V
    ...
    iget-object v2, p0, Lcom/android/camera/effect/renders/n;->i:Ljava/util/HashMap;
    ...
    iget-object v0, p0, Lcom/android/camera/effect/renders/n;->i:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Lcom/android/camera/effect/renders/n;->f:Lh2/a;
    :try_end_0
...
.method public u(Lf2/c;)Z
    ...
    :cond_2
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/t;->m()Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/effect/renders/s;->draw(Lf2/c;)Z
...
.method public v(II)V
    ...
    iget-object v1, p0, Lcom/android/camera/effect/renders/n;->i:Ljava/util/HashMap;
    ...
    iget-object p1, p0, Lcom/android/camera/effect/renders/n;->i:Ljava/util/HashMap;
    ...
    :cond_0
    iput-object v1, p0, Lcom/android/camera/effect/renders/n;->f:Lh2/a;
...
.method public w(II)V
    ...
    iget v0, p0, Lcom/android/camera/effect/renders/n;->g:I

    if-ne v0, p1, :cond_0

    iget v0, p0, Lcom/android/camera/effect/renders/n;->h:I
    ...
    iput p1, p0, Lcom/android/camera/effect/renders/n;->g:I

    iput p2, p0, Lcom/android/camera/effect/renders/n;->h:I

    invoke-virtual {p0, p1, p2}, Lcom/android/camera/effect/renders/n;->v(II)V
