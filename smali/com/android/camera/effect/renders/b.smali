...
.super Lcom/android/camera/effect/renders/v;
.source "SourceFile"
...
.method public constructor <init>(Lcom/android/gallery3d/ui/h;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/camera/effect/renders/v;-><init>(Lcom/android/gallery3d/ui/h;)V
...
.method public final b(FFFFLcom/android/gallery3d/ui/j;)V
    ...
    iget v0, p0, Lcom/android/camera/effect/renders/v;->mProgram:I

    invoke-static {v0}, Landroid/opengl/GLES20;->glUseProgram(I)V

    invoke-virtual {p0}, Lcom/android/camera/effect/renders/b;->l()V

    invoke-virtual {p0}, Lcom/android/camera/effect/renders/s;->updateViewport()V

    const/4 v0, 0x1

    invoke-virtual {p0, p5, v0}, Lcom/android/camera/effect/renders/b;->n(Lcom/android/gallery3d/ui/j;Z)V

    iget-object p5, p0, Lcom/android/camera/effect/renders/s;->mGLCanvas:Lcom/android/gallery3d/ui/h;
    ...
    iget p2, p0, Lcom/android/camera/effect/renders/v;->mUniformMVPMatrixH:I

    iget-object p3, p0, Lcom/android/camera/effect/renders/s;->mGLCanvas:Lcom/android/gallery3d/ui/h;
    ...
    iget p2, p0, Lcom/android/camera/effect/renders/v;->mUniformSTMatrixH:I
    ...
    iget p2, p0, Lcom/android/camera/effect/renders/v;->mUniformAlphaH:I
    ...
    iget p2, p0, Lcom/android/camera/effect/renders/v;->mUniformBlendAlphaH:I
    ...
    iget-object p0, p0, Lcom/android/camera/effect/renders/s;->mGLCanvas:Lcom/android/gallery3d/ui/h;
...
.method public final c(Lcom/android/gallery3d/ui/b;FFIIII)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/camera/effect/renders/v;->bindTexture(Lcom/android/gallery3d/ui/b;I)Z
    ...
    :cond_0
    iget-boolean p1, p0, Lcom/android/camera/effect/renders/v;->mBlendEnabled:Z
    ...
    iget-object p1, p0, Lcom/android/camera/effect/renders/s;->mGLCanvas:Lcom/android/gallery3d/ui/h;
    ...
    :goto_0
    invoke-virtual {p0, p1}, Lcom/android/camera/effect/renders/v;->setBlendEnabled(Z)V

    const p1, 0x8892

    invoke-static {p1, p4}, Landroid/opengl/GLES20;->glBindBuffer(II)V

    iget v2, p0, Lcom/android/camera/effect/renders/v;->mAttributePositionH:I
    ...
    iget p4, p0, Lcom/android/camera/effect/renders/v;->mAttributePositionH:I
    ...
    iget v2, p0, Lcom/android/camera/effect/renders/v;->mAttributeTexCoorH:I

    invoke-static/range {v2 .. v7}, Landroid/opengl/GLES20;->glVertexAttribPointer(IIIZII)V

    iget p4, p0, Lcom/android/camera/effect/renders/v;->mAttributeTexCoorH:I

    invoke-static {p4}, Landroid/opengl/GLES20;->glEnableVertexAttribArray(I)V

    iget-object p4, p0, Lcom/android/camera/effect/renders/s;->mGLCanvas:Lcom/android/gallery3d/ui/h;
    ...
    iget p2, p0, Lcom/android/camera/effect/renders/v;->mUniformTextureH:I
...
.method public final d(Lcom/android/gallery3d/ui/b;IFFFFF)V
    ...
    iget-boolean p2, p0, Lcom/android/camera/effect/renders/v;->mBlendEnabled:Z
    ...
    iget p1, p0, Lcom/android/camera/effect/renders/v;->mUniformMVPMatrixH:I
    ...
    iget p1, p0, Lcom/android/camera/effect/renders/v;->mUniformSTMatrixH:I
    ...
    iget p1, p0, Lcom/android/camera/effect/renders/v;->mUniformAlphaH:I
    ...
    iget p1, p0, Lcom/android/camera/effect/renders/v;->mUniformTextureH:I

    invoke-static {p1, v0}, Landroid/opengl/GLES20;->glUniform1i(II)V

    iget p1, p0, Lcom/android/camera/effect/renders/v;->mUniformBlendAlphaH:I

    iget-object p2, p0, Lcom/android/camera/effect/renders/s;->mGLCanvas:Lcom/android/gallery3d/ui/h;
...
.method public draw(Lf2/c;)Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera/effect/renders/v;->isAttriSupported(I)Z
...
.method public final f(FFFFLcom/android/gallery3d/ui/j;)V
    ...
    iget-object v1, p0, Lcom/android/camera/effect/renders/s;->mGLCanvas:Lcom/android/gallery3d/ui/h;
    ...
    iget p1, p0, Lcom/android/camera/effect/renders/v;->mUniformPointSize:I
...
.method public getFragShaderString()Ljava/lang/String;
    ...
    invoke-static {}, Lxc/a;->b()Landroid/content/Context;

    move-result-object p0

    const-string v0, "shading_script/frag_normal.txt"

    invoke-static {p0, v0}, Lze/i;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
...
.method public final i(Lcom/android/gallery3d/ui/b;Landroid/graphics/RectF;[F)V
    ...
    iget v0, p0, Lcom/android/camera/effect/renders/v;->mUniformTextureH:I
    ...
    iget-object v4, p0, Lcom/android/camera/effect/renders/s;->mGLCanvas:Lcom/android/gallery3d/ui/h;
    ...
    instance-of v5, p1, Lcom/android/gallery3d/ui/t;

    if-eqz v5, :cond_2

    move-object v5, p1

    check-cast v5, Lcom/android/gallery3d/ui/t;

    invoke-virtual {v5}, Lcom/android/gallery3d/ui/t;->isPremultiplied()Z
    ...
    :goto_0
    iget-boolean v6, p0, Lcom/android/camera/effect/renders/v;->mBlendEnabled:Z
    ...
    :goto_1
    invoke-virtual {p0, p1, v5}, Lcom/android/camera/effect/renders/v;->setBlendEnabled(ZZ)V
    ...
    iget p0, p0, Lcom/android/camera/effect/renders/v;->mUniformBlendAlphaH:I
...
.method public initShader()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/v;->getVertexShaderString()Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Llf/i;->a(Ljava/lang/String;Ljava/lang/String;)I

    move-result v0

    iput v0, p0, Lcom/android/camera/effect/renders/v;->mProgram:I
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/v;->mUniformMVPMatrixH:I
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/v;->mUniformSTMatrixH:I
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/v;->mUniformTextureH:I
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/v;->mUniformAlphaH:I
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/v;->mUniformPointSize:I
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/v;->mUniformBlendAlphaH:I
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/v;->mAttributePositionH:I
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/v;->mAttributeTexCoorH:I
...
.method public initSupportAttriList()V
    ...
    iget-object v0, p0, Lcom/android/camera/effect/renders/v;->mAttriSupportedList:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/android/camera/effect/renders/v;->mAttriSupportedList:Ljava/util/ArrayList;
...
.method public initVertexData()V
    ...
    invoke-static {v1}, Lcom/android/camera/effect/renders/v;->allocateByteBuffer(I)Ljava/nio/ByteBuffer;
    ...
    iput-object v1, p0, Lcom/android/camera/effect/renders/v;->mVertexBuffer:Ljava/nio/FloatBuffer;

    invoke-virtual {v1, v0}, Ljava/nio/FloatBuffer;->put([F)Ljava/nio/FloatBuffer;

    iget-object v0, p0, Lcom/android/camera/effect/renders/v;->mVertexBuffer:Ljava/nio/FloatBuffer;
    ...
    invoke-static {v2}, Lcom/android/camera/effect/renders/v;->allocateByteBuffer(I)Ljava/nio/ByteBuffer;
    ...
    iput-object v2, p0, Lcom/android/camera/effect/renders/v;->mTexCoorBuffer:Ljava/nio/FloatBuffer;

    invoke-virtual {v2, v0}, Ljava/nio/FloatBuffer;->put([F)Ljava/nio/FloatBuffer;

    iget-object p0, p0, Lcom/android/camera/effect/renders/v;->mTexCoorBuffer:Ljava/nio/FloatBuffer;
...
.method public final l()V
    ...
    iget v0, p0, Lcom/android/camera/effect/renders/v;->mAttributePositionH:I
    ...
    iget-object v5, p0, Lcom/android/camera/effect/renders/v;->mVertexBuffer:Ljava/nio/FloatBuffer;

    invoke-static/range {v0 .. v5}, Landroid/opengl/GLES20;->glVertexAttribPointer(IIIZILjava/nio/Buffer;)V

    iget v6, p0, Lcom/android/camera/effect/renders/v;->mAttributeTexCoorH:I
    ...
    iget-object v11, p0, Lcom/android/camera/effect/renders/v;->mTexCoorBuffer:Ljava/nio/FloatBuffer;
    ...
    iget p0, p0, Lcom/android/camera/effect/renders/v;->mAttributeTexCoorH:I
...
.method public final m(IZ)V
    ...
    iget-boolean v2, p0, Lcom/android/camera/effect/renders/v;->mBlendEnabled:Z
    ...
    iget-object v3, p0, Lcom/android/camera/effect/renders/s;->mGLCanvas:Lcom/android/gallery3d/ui/h;
    ...
    :goto_0
    invoke-virtual {p0, v2, p2}, Lcom/android/camera/effect/renders/v;->setBlendEnabled(ZZ)V
...
.method public final o(Ljava/nio/FloatBuffer;)V
    ...
    iget p0, p0, Lcom/android/camera/effect/renders/v;->mAttributePositionH:I
