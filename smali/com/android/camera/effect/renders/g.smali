...
# instance fields
.field public f:Lcom/android/camera/effect/renders/t;

.field public g:Lcom/android/camera/effect/renders/o;

.field public h:Lcom/android/camera/effect/renders/n;
...
.method public constructor <init>(Lcom/android/gallery3d/ui/h;)V
    ...
    iput-object v0, p0, Lcom/android/camera/effect/renders/g;->f:Lcom/android/camera/effect/renders/t;
    ...
    iput-object v0, p0, Lcom/android/camera/effect/renders/g;->g:Lcom/android/camera/effect/renders/o;
    ...
    invoke-direct {v0, p1}, Lcom/android/camera/effect/renders/n;-><init>(Lcom/android/gallery3d/ui/h;)V

    iput-object v0, p0, Lcom/android/camera/effect/renders/g;->h:Lcom/android/camera/effect/renders/n;

    iget-object p1, p0, Lcom/android/camera/effect/renders/g;->g:Lcom/android/camera/effect/renders/o;

    invoke-virtual {p0, p1}, Lcom/android/camera/effect/renders/t;->b(Lcom/android/camera/effect/renders/s;)V
...
.method public draw(Lf2/c;)Z
    ...
    :cond_1
    iget-object v0, p0, Lcom/android/camera/effect/renders/g;->g:Lcom/android/camera/effect/renders/o;

    invoke-virtual {v0}, Lcom/android/camera/effect/renders/o;->y()V
...
.method public final u(Lf2/c;)Z
    ...
    iget-object v0, p0, Lcom/android/camera/effect/renders/g;->h:Lcom/android/camera/effect/renders/n;

    invoke-virtual {v0}, Lcom/android/camera/effect/renders/t;->l()I
    ...
    invoke-virtual {v0, v2}, Lcom/android/camera/effect/renders/o;->C(Lcom/android/camera/effect/renders/s;)V
    ...
    iget-object v2, p0, Lcom/android/camera/effect/renders/g;->h:Lcom/android/camera/effect/renders/n;
    ...
    invoke-virtual {v0, v2}, Lcom/android/camera/effect/renders/o;->D(Z)V

    iget-object v0, p0, Lcom/android/camera/effect/renders/g;->g:Lcom/android/camera/effect/renders/o;

    invoke-virtual {v0, p1}, Lcom/android/camera/effect/renders/o;->draw(Lf2/c;)Z
...
.method public final v(I)Lcom/android/camera/effect/renders/s;
    .locals 2

    iget-object v0, p0, Lcom/android/camera/effect/renders/g;->f:Lcom/android/camera/effect/renders/t;
    ...
    iget-object p0, p0, Lcom/android/camera/effect/renders/g;->f:Lcom/android/camera/effect/renders/t;
...
.method public final w()Lcom/android/camera/effect/renders/s;
    .locals 2
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera/effect/renders/g;->v(I)Lcom/android/camera/effect/renders/s;
...
.method public final y(Z)Z
    ...
    iget-object v1, p0, Lcom/android/camera/effect/renders/g;->h:Lcom/android/camera/effect/renders/n;

    invoke-virtual {v1}, Lcom/android/camera/effect/renders/t;->g()V
    ...
    invoke-virtual {p0, v1}, Lcom/android/camera/effect/renders/g;->v(I)Lcom/android/camera/effect/renders/s;

    move-result-object v1

    if-eqz v1, :cond_4

    iget-object v4, p0, Lcom/android/camera/effect/renders/g;->h:Lcom/android/camera/effect/renders/n;

    invoke-virtual {v4, v1}, Lcom/android/camera/effect/renders/t;->b(Lcom/android/camera/effect/renders/s;)V
    ...
    invoke-virtual {v1, v4}, Lcom/android/camera/effect/renders/s;->setKaleidoscope(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v1}, Lcom/android/camera/effect/renders/t;->b(Lcom/android/camera/effect/renders/s;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/g;->w()Lcom/android/camera/effect/renders/s;
    ...
    invoke-virtual {v1}, Lcom/android/camera/effect/renders/t;->m()Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/camera/effect/renders/n;->w(II)V
