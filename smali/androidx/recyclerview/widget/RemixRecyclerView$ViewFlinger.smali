...
.field private mHapticFeedbackCompat:Lfp/b;
...
.method public constructor <init>(Landroidx/recyclerview/widget/RemixRecyclerView;)V
    ...
    invoke-direct {v1, p1, v0}, Lho/c;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;)V

    iput-object v1, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lho/c;
...
.method private getHapticFeedbackCompat()Lfp/b;
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mHapticFeedbackCompat:Lfp/b;
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mHapticFeedbackCompat:Lfp/b;

    :cond_0
    iget-object p0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mHapticFeedbackCompat:Lfp/b;
...
.method public fling(II)V
    ...
    invoke-direct {v2, v4, v3}, Lho/c;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;)V

    iput-object v2, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lho/c;
    ...
    :cond_7
    :goto_0
    iget-object v2, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lho/c;
    ...
    invoke-virtual/range {v2 .. v10}, Lho/c;->d(IIIIIIII)V
...
.method public run()V
    ...
    iget-object v1, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lho/c;

    invoke-virtual {v1}, Lho/c;->b()Z

    move-result v4

    if-eqz v4, :cond_21

    invoke-virtual {v1}, Lho/c;->j()I

    move-result v4

    invoke-virtual {v1}, Lho/c;->k()I

    move-result v5

    iget-object v6, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lho/c;

    invoke-virtual {v6}, Lho/c;->o()I

    move-result v6

    if-ne v6, v3, :cond_1

    invoke-virtual {v1}, Lho/c;->h()F
    ...
    iget-object v4, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lho/c;

    invoke-virtual {v4}, Lho/c;->o()I
    ...
    iget-object v8, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lho/c;

    invoke-virtual {v8}, Lho/c;->h()F

    move-result v8

    iget-object v9, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lho/c;

    invoke-virtual {v9}, Lho/c;->i()F

    move-result v9

    invoke-interface {v7, v8, v9}, Ldn/a;->a(FF)Z
    ...
    iget-object v5, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lho/c;

    invoke-virtual {v5}, Lho/c;->q()I
    ...
    invoke-direct/range {p0 .. p0}, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->getHapticFeedbackCompat()Lfp/b;

    move-result-object v1

    const/16 v4, 0xc9

    invoke-virtual {v1, v4}, Lfp/b;->d(I)Z
...
.method public smoothScrollBy(IIILandroid/view/animation/Interpolator;)V
    ...
    :cond_2
    iget-object p3, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lho/c;

    invoke-virtual {p3}, Lho/c;->o()I
    ...
    invoke-direct {p3, v2, p4}, Lho/c;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;)V

    iput-object p3, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lho/c;
    ...
    iget-object v1, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lho/c;
    ...
    invoke-virtual/range {v1 .. v7}, Lho/c;->G(IIIIII)V
...
.method public stop()V
    ...
    iget-object p0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lho/c;
