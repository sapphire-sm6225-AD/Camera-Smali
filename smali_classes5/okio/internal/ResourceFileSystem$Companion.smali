...
.method private final keepPath(Lokio/Path;)Z
    ...
    invoke-static {p0, p1, v0}, Lvl/b0;->J1(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method public final removeBase(Lokio/Path;Lokio/Path;)Lokio/Path;
    ...
    invoke-static {p1, p2}, Lvl/c0;->d4(Ljava/lang/String;Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    invoke-static/range {v0 .. v5}, Lvl/b0;->k2(Ljava/lang/String;CCZILjava/lang/Object;)Ljava/lang/String;
...
.method public final toClasspathRoots(Ljava/lang/ClassLoader;)Ljava/util/List;
    ...
    invoke-virtual {v4, v2}, Lokio/internal/ResourceFileSystem$Companion;->toFileRoot(Ljava/net/URL;)Lkk/u0;
    ...
    invoke-virtual {v2, v0}, Lokio/internal/ResourceFileSystem$Companion;->toJarRoot(Ljava/net/URL;)Lkk/u0;
    ...
    :cond_3
    invoke-static {v1, p1}, Lmk/e0;->y4(Ljava/util/Collection;Ljava/lang/Iterable;)Ljava/util/List;
...
.method public final toFileRoot(Ljava/net/URL;)Lkk/u0;
    .locals 4
...
.method public final toJarRoot(Ljava/net/URL;)Lkk/u0;
    .locals 9
    .param p1    # Ljava/net/URL;
        .annotation build Lyq/d;
        .end annotation
    ...
    invoke-static {p1, v0, v7, v1, v8}, Lvl/b0;->v2(Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)Z
    ...
    invoke-static {p1, v0, v1}, Lokio/internal/ZipKt;->openZip(Lokio/Path;Lokio/FileSystem;Lhl/l;)Lokio/ZipFileSystem;
