...
.field public K0:Lrm/ContextMenuBuilder;

.field public K1:Lim/a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v3, p1, p2}, Lim/a;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    iput-object v3, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->K1:Lim/a;
    ...
    .line 20
    sget p3, Lgm/b$r;->Window_isMiuixFloatingTheme:I
    ...
    .line 22
    sget p1, Lgm/b$r;->Window_contentAutoFitSystemWindow:I
    ...
    .line 23
    sget p1, Lgm/b$r;->Window_contentHeaderBackground:I
    ...
    .line 24
    :cond_0
    sget p1, Lgm/b$r;->Window_windowExtraPaddingHorizontal:I
    ...
    :cond_2
    :goto_0
    sget p1, Lgm/b$r;->Window_windowExtraPaddingHorizontalEnable:I
...
.method private setFloatingMode(Z)V
    ...
    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->K1:Lim/a;

    invoke-virtual {v0, p1}, Lim/a;->q(Z)V
...
.method public fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    sget v5, Lgm/b$g;->miuix_appcompat_floating_window_top_offset:I
    ...
    invoke-static {v1, v4, v2}, Ltn/d;->k(Landroid/content/Context;II)I
    ...
    invoke-virtual {v0, v5}, Lpm/d;->u(Landroid/graphics/Rect;)V
...
.method public final k()V
    ...
    iput-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->K0:Lrm/ContextMenuBuilder;
...
.method public final n(Landroid/view/View;FF)Z
    ...
    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->K0:Lrm/ContextMenuBuilder;

    if-nez v0, :cond_0

    new-instance v0, Lrm/ContextMenuBuilder;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-direct {v0, v1}, Lrm/ContextMenuBuilder;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p1, v1, p2, p3}, Lrm/ContextMenuBuilder;->l0(Landroid/view/View;Landroid/os/IBinder;FF)Lrm/d;

    move-result-object p2

    iput-object p2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->p1:Lrm/d;
    ...
    invoke-virtual {p2, p0}, Lrm/d;->d(Lmiuix/appcompat/internal/view/menu/k$a;)V
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-static {p1, v0}, Lom/f;->a(Landroid/content/Context;I)I

    move-result p1

    iput p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->C2:I

    iget-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->K1:Lim/a;

    invoke-virtual {p1}, Lim/a;->p()V

    iget-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->K0:Lrm/ContextMenuBuilder;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lrm/ContextMenuBuilder;->i0()Z

    move-result p1

    if-eqz p1, :cond_0

    iget-object p0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->K0:Lrm/ContextMenuBuilder;

    invoke-virtual {p0}, Lrm/ContextMenuBuilder;->j0()V
...
.method public onMeasure(II)V
    ...
    iget-object v0, v7, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->K1:Lim/a;

    move/from16 v1, p1

    invoke-virtual {v0, v1}, Lim/a;->m(I)I
    ...
    invoke-virtual {v0, v1}, Lim/a;->e(I)I
...
.method public setContentMask(Landroid/view/View;)V
    ...
    sget v1, Lgm/b$h;->miuix_appcompat_window_content_mask_oled:I
...
.method public setExtraHorizontalPaddingLevel(I)V
    ...
    invoke-static {v0, p1}, Lom/f;->a(Landroid/content/Context;I)I
...
.method public showContextMenuForChild(Landroid/view/View;)Z
    ...
    invoke-virtual {v0, p1, v1}, Lrm/ContextMenuBuilder;->k0(Landroid/view/View;Landroid/os/IBinder;)Lmiuix/appcompat/internal/view/menu/h;
...
.method public final w()V
    ...
    sget v0, Lgm/b$j;->action_bar_container:I
