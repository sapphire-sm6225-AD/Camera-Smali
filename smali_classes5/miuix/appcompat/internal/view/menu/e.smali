...
.method public constructor <init>(Lmiuix/appcompat/app/b;Landroid/view/Menu;)V
    ...
    invoke-direct {p0, v0}, Lvn/e;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1}, Lvn/e;->setAdapter(Landroid/widget/ListAdapter;)V
...
.method public final S(Landroid/view/View;Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {p0, v2}, Lvn/e;->setVerticalOffset(I)V

    invoke-static {p2}, Ltn/k;->g(Landroid/view/View;)Z

    move-result v2

    if-eqz v2, :cond_1

    invoke-virtual {p0}, Lvn/e;->w()I
    ...
    :goto_0
    invoke-virtual {p0, p1}, Lvn/e;->setHorizontalOffset(I)V
