...
# direct methods
.method public constructor <init>(Lmiuix/appcompat/app/AppCompatActivity;Lmiuix/appcompat/app/d;Lim/j;)V
    .locals 2
    ...
    iput-object p3, p0, Lmiuix/appcompat/app/l;->k0:Lim/j;
...
.method public static d0(Landroid/content/Context;)Z
    ...
    sget v0, Lgm/b$d;->windowActionBar:I

    const/4 v1, 0x1

    invoke-static {p0, v0, v1}, Ltn/d;->d(Landroid/content/Context;IZ)Z
...
.method public K()V
    ...
    iget-object p0, p0, Lmiuix/appcompat/app/l;->q1:Ljm/a;

    if-eqz p0, :cond_0

    invoke-interface {p0}, Lim/f;->V2()V
...
.method public L()V
    ...
    invoke-interface {p0}, Lim/f;->X2()V
...
.method public M()V
    ...
    invoke-interface {p0}, Lim/f;->k0()V
...
.method public N()V
    ...
    invoke-interface {p0}, Lim/f;->k1()V
...
.method public final Q(Landroid/view/Window;)I
    ...
    sget v1, Lgm/b$d;->windowActionBar:I

    const/4 v2, 0x0

    invoke-static {v0, v1, v2}, Ltn/d;->d(Landroid/content/Context;IZ)Z

    move-result v1

    if-eqz v1, :cond_1

    sget v1, Lgm/b$d;->windowActionBarMovable:I
    ...
    sget v1, Lgm/b$m;->miuix_appcompat_screen_action_bar_movable:I

    goto :goto_0

    :cond_0
    sget v1, Lgm/b$m;->miuix_appcompat_screen_action_bar:I

    goto :goto_0

    :cond_1
    sget v1, Lgm/b$m;->miuix_appcompat_screen_simple:I

    :goto_0
    sget v3, Lgm/b$d;->startingWindowOverlay:I

    invoke-static {v0, v3}, Ltn/d;->c(Landroid/content/Context;I)I
    ...
    sget p0, Lgm/b$d;->windowTranslucentStatus:I

    invoke-static {v0, p0, v2}, Ltn/d;->k(Landroid/content/Context;II)I

    move-result p0

    invoke-static {p1, p0}, Lcn/b;->a(Landroid/view/Window;I)Z
...
.method public S()Landroid/view/View;
    ...
    invoke-virtual {p0}, Ljm/a;->c()Landroid/view/View;
...
.method public V(ZLandroid/os/Bundle;)V
    ...
    invoke-static {p0, p1, p2}, Lkm/g;->N(Lmiuix/appcompat/app/AppCompatActivity;Landroid/content/Intent;Landroid/os/Bundle;)V
...
.method public final W()V
    ...
    :cond_1
    sget v3, Lgm/b$r;->Window_windowActionBar:I
    ...
    :cond_2
    sget v3, Lgm/b$r;->Window_windowActionBarOverlay:I
    ...
    :cond_3
    sget v3, Lgm/b$r;->Window_isMiuixFloatingTheme:I
    ...
    sget v3, Lgm/b$r;->Window_windowFloating:I
    ...
    sget v3, Lgm/b$r;->Window_windowTranslucentStatus:I
    ...
    sget v3, Lgm/b$j;->action_bar_container:I
    ...
    :cond_5
    sget v1, Lgm/b$r;->Window_immersionMenuLayout:I
    ...
    sget v5, Lgm/b$e;->abc_split_action_bar_is_narrow:I
    ...
    :cond_8
    sget v3, Lgm/b$r;->Window_windowSplitActionBar:I
    ...
    :cond_a
    sget v1, Lgm/b$r;->Window_immersionMenuEnabled:I
...
.method public final X(Landroid/view/Window;)V
    ...
    invoke-static {v0}, Ljm/b;->a(Lmiuix/appcompat/app/AppCompatActivity;)Ljm/a;
    ...
    :goto_0
    iput-object v0, p0, Lmiuix/appcompat/app/l;->q1:Ljm/a;
    ...
    iget-object v2, p0, Lmiuix/appcompat/app/l;->q1:Ljm/a;
    ...
    iget-object v3, p0, Lmiuix/appcompat/app/l;->q1:Ljm/a;

    invoke-virtual {v3, v2}, Ljm/a;->n(Z)V

    iget-object v2, p0, Lmiuix/appcompat/app/l;->q1:Ljm/a;

    iget-boolean v3, p0, Lmiuix/appcompat/app/l;->k1:Z

    invoke-virtual {v2, v0, v3}, Ljm/a;->k(Landroid/view/View;Z)Landroid/view/ViewGroup;
    ...
    :cond_1
    sget v2, Lgm/b$j;->action_bar_overlay_layout:I
    ...
    :cond_4
    iget-object p1, p0, Lmiuix/appcompat/app/l;->q1:Ljm/a;
    ...
    invoke-virtual {p1, v0, p0}, Ljm/a;->g(Landroid/view/View;Z)V
...
.method public final e0(Z)V
    ...
    iget-object p0, p0, Lmiuix/appcompat/app/l;->k0:Lim/j;

    invoke-interface {p0, p1}, Lim/j;->a(Z)V
...
.method public f0()V
    ...
    :cond_1
    iget-object v0, p0, Lmiuix/appcompat/app/l;->q1:Ljm/a;

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Ljm/a;->j()Z
...
.method public h0(Landroid/os/Bundle;)V
    ...
    invoke-static {v0, p1}, Lim/b;->E(Lmiuix/appcompat/app/AppCompatActivity;Landroid/os/Bundle;)V
    ...
    invoke-static {v0, v1, p1}, Lkm/g;->a0(ILjava/lang/String;Landroid/os/Bundle;)V
...
.method public l0(Z)V
    ...
    invoke-virtual {p0, p1}, Ljm/a;->l(Z)V
...
.method public o0(Z)V
    ...
    invoke-virtual {p0, p1}, Ljm/a;->m(Z)V
...
.method public final q0(ZIZZ)V
    ...
    invoke-static {p4}, Ltn/e;->e(Landroid/content/Context;)Z
    ...
    iget-object p4, p0, Lmiuix/appcompat/app/l;->k0:Lim/j;

    invoke-interface {p4, p1}, Lim/j;->b(Z)Z
    ...
    iget-object p2, p0, Lmiuix/appcompat/app/l;->q1:Ljm/a;

    invoke-virtual {p2, p1}, Ljm/a;->n(Z)V
    ...
    invoke-virtual {p2}, Ljm/a;->d()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Ljm/a;->n(Z)V
...
.method public r0(Lim/i;)V
    ...
    invoke-virtual {p0, p1}, Ljm/a;->o(Lim/i;)V

    :cond_0
    return-void
.end method

.method public s0(Lim/h;)V
    .locals 0
    ...
    invoke-virtual {p0, p1}, Ljm/a;->p(Lim/h;)V
...
.method public w(Landroid/os/Bundle;)V
    ...
    invoke-static {v0}, Lom/c;->b(Landroid/content/Context;)V
    ...
    sget v0, Lgm/b$d;->windowExtraPaddingHorizontal:I

    invoke-static {p1, v0, v2}, Ltn/d;->k(Landroid/content/Context;II)I
    ...
    sget v2, Lgm/b$d;->windowExtraPaddingHorizontalEnable:I

    invoke-static {v0, v2, v1}, Ltn/d;->d(Landroid/content/Context;IZ)Z
