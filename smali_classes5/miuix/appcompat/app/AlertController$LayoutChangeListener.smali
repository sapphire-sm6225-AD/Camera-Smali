...
.method private handleImeChange(Landroid/view/View;Landroid/graphics/Rect;Lmiuix/appcompat/app/AlertController;)V
    ...
    invoke-static {p3}, Lmiuix/appcompat/app/AlertController;->t(Lmiuix/appcompat/app/AlertController;)I
    ...
    invoke-static {}, Lsm/a;->a()V

    :cond_2
    invoke-static {p3, p2}, Lmiuix/appcompat/app/AlertController;->m(Lmiuix/appcompat/app/AlertController;I)V
...
.method private handleMultiWindowLandscapeChange(Lmiuix/appcompat/app/AlertController;I)V
    ...
    invoke-static {p1}, Lmiuix/appcompat/app/AlertController;->u(Lmiuix/appcompat/app/AlertController;)Landroid/content/Context;
    ...
    invoke-static {p1}, Lmiuix/appcompat/app/AlertController;->v(Lmiuix/appcompat/app/AlertController;)Lmiuix/appcompat/internal/widget/DialogRootView;
...
.method public hasNavigationBarHeightInMultiWindowMode()Z
    ...
    invoke-static {v0}, Lmiuix/appcompat/app/AlertController;->u(Lmiuix/appcompat/app/AlertController;)Landroid/content/Context;
    ...
    invoke-static {v1}, Lmiuix/appcompat/app/AlertController;->w(Lmiuix/appcompat/app/AlertController;)Landroid/graphics/Point;

    move-result-object v1

    invoke-static {v0, v1}, Lzm/n;->f(Landroid/content/Context;Landroid/graphics/Point;)V
    ...
    invoke-static {p0}, Lmiuix/appcompat/app/AlertController;->u(Lmiuix/appcompat/app/AlertController;)Landroid/content/Context;

    move-result-object p0

    invoke-static {p0}, Lzm/h;->h(Landroid/content/Context;)I
...
.method public isInMultiScreenTop()Z
    ...
    invoke-static {v0}, Lmiuix/appcompat/app/AlertController;->w(Lmiuix/appcompat/app/AlertController;)Landroid/graphics/Point;

    move-result-object v3

    invoke-static {v2, v3}, Lzm/n;->f(Landroid/content/Context;Landroid/graphics/Point;)V
...
.method public onLayoutChange(Landroid/view/View;IIIIIIII)V
    ...
    invoke-static {p2}, Lmiuix/appcompat/app/AlertController;->s(Lmiuix/appcompat/app/AlertController;)Z
    ...
    invoke-static {p2, p0}, Lmiuix/appcompat/app/AlertController;->m(Lmiuix/appcompat/app/AlertController;I)V
