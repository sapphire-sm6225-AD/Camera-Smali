...
.method private synthetic f(Landroid/view/View;Lmiuix/appcompat/app/AppCompatActivity;)V
    ...
    invoke-static {p1, v1}, Lim/d;->e(Landroid/view/View;Lmiuix/animation/base/AnimConfig;)V
...
.method public final d(Lmiuix/appcompat/app/AppCompatActivity;)V
    ...
    invoke-static {p1}, Lim/c;->h(Lmiuix/appcompat/app/AppCompatActivity;)I
    ...
    invoke-static {p1, p0}, Lim/c;->j(Lmiuix/appcompat/app/AppCompatActivity;Z)V
...
.method public final e(Lmiuix/appcompat/app/AppCompatActivity;)V
    ...
    invoke-virtual {v0}, Lim/b;->r()Landroid/view/View;
    ...
    invoke-direct {v1, p0, v0, p1}, Lim/k;-><init>(Lmiuix/appcompat/app/floatingactivity/SingleAppFloatingLifecycleObserver;Landroid/view/View;Lmiuix/appcompat/app/AppCompatActivity;)V
...
.method public final g(Lmiuix/appcompat/app/AppCompatActivity;)V
    ...
    invoke-virtual {v0, v1}, Lim/b;->p(I)Ljava/util/ArrayList;

    move-result-object v1

    if-eqz v1, :cond_0

    invoke-virtual {v0, p1}, Lim/b;->o(Lmiuix/appcompat/app/AppCompatActivity;)I
...
.method public onCreate()V
    ...
    invoke-virtual {v0, v1, v2}, Lim/b;->m(Ljava/lang/String;I)Lmiuix/appcompat/app/AppCompatActivity;

    move-result-object v1

    if-eqz v1, :cond_2

    invoke-virtual {v0, v1}, Lim/b;->t(Lmiuix/appcompat/app/AppCompatActivity;)Lmiuix/appcompat/app/AppCompatActivity;
    ...
    invoke-virtual {v0, v1}, Lim/b;->B(Lmiuix/appcompat/app/AppCompatActivity;)Z

    move-result p0

    if-nez p0, :cond_2

    invoke-virtual {v0, v1}, Lim/b;->D(Lmiuix/appcompat/app/AppCompatActivity;)V

    invoke-static {v1}, Lim/c;->k(Lmiuix/appcompat/app/AppCompatActivity;)V
    ...
    invoke-static {v1, p0}, Lim/c;->j(Lmiuix/appcompat/app/AppCompatActivity;Z)V
...
.method public onDestroy()V
    ...
    invoke-virtual {v0, v1, p0}, Lim/b;->G(Ljava/lang/String;I)V
