...
.method private getWatermarkParagraph(Ljava/lang/String;I)Lorg/apache/poi/xwpf/usermodel/XWPFParagraph;
    ...
    invoke-static {}, Lfr/d$a;->a()Lfr/d;

    move-result-object v2

    invoke-interface {v2}, Lfr/d;->yl()Lfr/j;

    move-result-object v3

    const-string v4, "_x0000_t136"

    invoke-interface {v3, v4}, Lfr/j;->setId(Ljava/lang/String;)V

    const-string v4, "1600,21600"

    invoke-interface {v3, v4}, Lfr/j;->j6(Ljava/lang/String;)V

    const/high16 v4, 0x43080000    # 136.0f

    invoke-interface {v3, v4}, Lfr/j;->f8(F)V

    const-string v4, "10800"

    invoke-interface {v3, v4}, Lfr/j;->u8(Ljava/lang/String;)V

    const-string v4, "m@7,0l@8,0m@5,21600l@6,21600e"

    invoke-interface {v3, v4}, Lfr/j;->E8(Ljava/lang/String;)V

    invoke-interface {v3}, Lfr/j;->o1()Lfr/c;

    move-result-object v4

    invoke-interface {v4}, Lfr/c;->addNewF()Lfr/a;

    move-result-object v5

    const-string/jumbo v6, "sum #0 0 10800"

    invoke-interface {v5, v6}, Lfr/a;->ca(Ljava/lang/String;)V
    ...
    invoke-interface {v4, v5}, Lfr/a;->ca(Ljava/lang/String;)V

    invoke-interface {v3}, Lfr/j;->addNewPath()Lfr/g;

    move-result-object v4

    sget-object v5, Lfr/q;->J6:Lfr/q$a;

    invoke-interface {v4, v5}, Lfr/g;->el(Lfr/q$a;)V

    sget-object v6, Ldr/d;->U5:Ldr/d$a;

    invoke-interface {v4, v6}, Lfr/g;->Uq(Ldr/d$a;)V

    const-string v6, "@9,0;@10,10800;@11,21600;@12,10800"

    invoke-interface {v4, v6}, Lfr/g;->Uk(Ljava/lang/String;)V

    const-string v6, "270,180,90,0"

    invoke-interface {v4, v6}, Lfr/g;->yi(Ljava/lang/String;)V

    invoke-interface {v3}, Lfr/j;->c2()Lfr/l;

    move-result-object v4

    invoke-interface {v4, v5}, Lfr/l;->q(Lfr/q$a;)V

    invoke-interface {v4, v5}, Lfr/l;->Pw(Lfr/q$a;)V

    invoke-interface {v3}, Lfr/j;->D4()Lfr/f;

    move-result-object v4

    invoke-interface {v4}, Lfr/f;->addNewH()Lfr/e;

    move-result-object v4

    const-string v5, "#0,bottomRight"

    invoke-interface {v4, v5}, Lfr/e;->setPosition(Ljava/lang/String;)V

    const-string v5, "6629,14971"

    invoke-interface {v4, v5}, Lfr/e;->rg(Ljava/lang/String;)V

    invoke-interface {v3}, Lfr/j;->addNewLock()Ldr/b;

    move-result-object v3

    sget-object v4, Lfr/o;->w6:Lfr/o$a;

    invoke-interface {v3, v4}, Ldr/b;->d3(Lfr/o$a;)V

    invoke-interface {v2}, Lfr/d;->bB()Lfr/i;
    ...
    invoke-interface {v3, v4}, Lfr/i;->setId(Ljava/lang/String;)V
    ...
    invoke-interface {v3, p2}, Lfr/i;->c0(Ljava/lang/String;)V

    const-string p2, "#_x0000_t136"

    invoke-interface {v3, p2}, Lfr/i;->setType(Ljava/lang/String;)V
    ...
    invoke-interface {v3, p2}, Lfr/i;->l(Ljava/lang/String;)V
    ...
    invoke-interface {v3, p2}, Lfr/i;->L4(Ljava/lang/String;)V

    const-string p2, "black"

    invoke-interface {v3, p2}, Lfr/i;->V2(Ljava/lang/String;)V

    sget-object p2, Lfr/q;->M6:Lfr/q$a;

    invoke-interface {v3, p2}, Lfr/i;->e7(Lfr/q$a;)V

    invoke-interface {v3}, Lfr/i;->c2()Lfr/l;

    move-result-object p2

    const-string v3, "font-family:&quot;Cambria&quot;;font-size:1pt"

    invoke-interface {p2, v3}, Lfr/l;->l(Ljava/lang/String;)V

    invoke-interface {p2, p1}, Lfr/l;->pF(Ljava/lang/String;)V
