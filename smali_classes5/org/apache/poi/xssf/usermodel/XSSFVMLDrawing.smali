...
.method private newDrawing()V
    ...
    invoke-static {}, Ldr/c$a;->a()Ldr/c;

    move-result-object v0

    sget-object v1, Lfr/o;->w6:Lfr/o$a;

    invoke-interface {v0, v1}, Ldr/c;->d3(Lfr/o$a;)V

    invoke-interface {v0}, Ldr/c;->wp()Ldr/a;

    move-result-object v2

    invoke-interface {v2, v1}, Ldr/a;->d3(Lfr/o$a;)V

    const-string v1, "1"

    invoke-interface {v2, v1}, Ldr/a;->setData(Ljava/lang/String;)V
    ...
    invoke-interface {v0, v1}, Lfr/j;->setId(Ljava/lang/String;)V

    const-string v1, "21600,21600"

    invoke-interface {v0, v1}, Lfr/j;->j6(Ljava/lang/String;)V

    const/high16 v1, 0x434a0000    # 202.0f

    invoke-interface {v0, v1}, Lfr/j;->f8(F)V

    const-string v1, "m,l,21600r21600,l21600,xe"

    invoke-interface {v0, v1}, Lfr/j;->E8(Ljava/lang/String;)V

    invoke-interface {v0}, Lfr/j;->s6()Lfr/k;

    move-result-object v1

    sget-object v2, Lfr/p;->E6:Lfr/p$a;

    invoke-interface {v1, v2}, Lfr/k;->Yl(Lfr/p$a;)V

    invoke-interface {v0}, Lfr/j;->addNewPath()Lfr/g;

    move-result-object v1

    sget-object v2, Lfr/q;->J6:Lfr/q$a;

    invoke-interface {v1, v2}, Lfr/g;->lf(Lfr/q$a;)V

    sget-object v2, Ldr/d;->S5:Ldr/d$a;

    invoke-interface {v1, v2}, Lfr/g;->Uq(Ldr/d$a;)V
...
.method public findCommentShape(II)Lfr/i;
    .locals 5
    ...
    instance-of v1, v0, Lfr/i;

    if-eqz v1, :cond_0

    check-cast v0, Lfr/i;

    invoke-interface {v0}, Lfr/i;->H0()I
    ...
    invoke-interface {v0, v1}, Lfr/i;->w6(I)Lbr/a;

    move-result-object v2

    invoke-interface {v2}, Lbr/a;->SD()Lbr/b$a;

    move-result-object v3

    sget-object v4, Lbr/b;->M:Lbr/b$a;

    if-ne v3, v4, :cond_0

    invoke-interface {v2, v1}, Lbr/a;->getRowArray(I)Ljava/math/BigInteger;
    ...
    invoke-interface {v2, v1}, Lbr/a;->Lo(I)Ljava/math/BigInteger;
...
.method public newCommentShape()Lfr/i;
    .locals 5

    invoke-static {}, Lfr/i$a;->a()Lfr/i;
    ...
    invoke-interface {v0, v1}, Lfr/i;->setId(Ljava/lang/String;)V
    ...
    invoke-interface {v0, v1}, Lfr/i;->setType(Ljava/lang/String;)V

    const-string v1, "position:absolute; visibility:hidden"

    invoke-interface {v0, v1}, Lfr/i;->l(Ljava/lang/String;)V

    const-string v1, "#ffffe1"

    invoke-interface {v0, v1}, Lfr/i;->V2(Ljava/lang/String;)V

    sget-object v2, Ldr/e;->a6:Ldr/e$a;

    invoke-interface {v0, v2}, Lfr/i;->s(Ldr/e$a;)V

    invoke-interface {v0}, Lfr/i;->addNewFill()Lfr/b;

    move-result-object v2

    invoke-interface {v2, v1}, Lfr/b;->setColor(Ljava/lang/String;)V

    invoke-interface {v0}, Lfr/i;->addNewShadow()Lfr/h;

    move-result-object v1

    sget-object v2, Lfr/q;->J6:Lfr/q$a;

    invoke-interface {v1, v2}, Lfr/h;->q(Lfr/q$a;)V

    const-string v3, "black"

    invoke-interface {v1, v3}, Lfr/h;->setColor(Ljava/lang/String;)V

    invoke-interface {v1, v2}, Lfr/h;->j9(Lfr/q$a;)V

    invoke-interface {v0}, Lfr/i;->addNewPath()Lfr/g;

    move-result-object v1

    sget-object v2, Ldr/d;->R5:Ldr/d$a;

    invoke-interface {v1, v2}, Lfr/g;->Uq(Ldr/d$a;)V

    invoke-interface {v0}, Lfr/i;->U()Lfr/m;

    move-result-object v1

    const-string v2, "mso-direction-alt:auto"

    invoke-interface {v1, v2}, Lfr/m;->l(Ljava/lang/String;)V

    invoke-interface {v0}, Lfr/i;->addNewClientData()Lbr/a;

    move-result-object v1

    sget-object v2, Lbr/b;->M:Lbr/b$a;

    invoke-interface {v1, v2}, Lbr/a;->WC(Lbr/b$a;)V

    invoke-interface {v1}, Lbr/a;->Ka()Lbr/c;

    invoke-interface {v1}, Lbr/a;->wA()Lbr/c;

    invoke-interface {v1}, Lbr/a;->addNewAnchor()Lorg/apache/xmlbeans/XmlString;
    ...
    invoke-interface {v1}, Lbr/a;->Ly()Lbr/c;
    ...
    invoke-interface {v1}, Lbr/a;->addNewRow()Lorg/apache/xmlbeans/XmlInteger;
    ...
    invoke-interface {v1}, Lbr/a;->G8()Lorg/apache/xmlbeans/XmlInteger;
...
.method public read(Ljava/io/InputStream;)V
    ...
    invoke-static {v2}, Ldr/c$a;->k(Ljava/lang/String;)Ldr/c;
    ...
    invoke-static {v2}, Lfr/j$a;->k(Ljava/lang/String;)Lfr/j;
    ...
    invoke-interface {v2}, Lfr/j;->getId()Ljava/lang/String;
    ...
    invoke-static {v2}, Lfr/i$a;->k(Ljava/lang/String;)Lfr/i;

    move-result-object v2

    invoke-interface {v2}, Lfr/i;->getId()Ljava/lang/String;
...
.method public removeCommentShape(II)Z
    ...
    invoke-virtual {p0, p1, p2}, Lorg/apache/poi/xssf/usermodel/XSSFVMLDrawing;->findCommentShape(II)Lfr/i;
