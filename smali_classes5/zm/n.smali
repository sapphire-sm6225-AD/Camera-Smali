...
.method public static a(Landroid/content/Context;)Landroid/view/WindowMetrics;
    ...
    invoke-static {p0}, Lzm/n;->i(Landroid/content/Context;)Landroid/view/WindowManager;

    move-result-object p0

    invoke-static {p0}, Lcom/android/camera/a5;->a(Landroid/view/WindowManager;)Landroid/view/WindowMetrics;
...
.method public static c(Landroid/content/Context;Landroid/graphics/Point;Landroid/graphics/Point;)V
    ...
    invoke-static {v0}, Lzm/g;->a(Landroid/view/WindowManager;)Landroid/view/WindowMetrics;

    move-result-object p0

    invoke-static {p0}, Lcom/android/camera/b5;->a(Landroid/view/WindowMetrics;)Landroid/graphics/Rect;
    ...
    invoke-static {v1}, Lcom/android/camera/b5;->a(Landroid/view/WindowMetrics;)Landroid/graphics/Rect;
    ...
    :cond_4
    invoke-static {p0}, Lzm/h;->l(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_5

    invoke-static {p0}, Lzm/n;->b(Landroid/content/Context;)Landroid/view/Display;
...
.method public static d(Landroid/content/Context;Landroid/graphics/Point;Landroid/graphics/Point;)V
    ...
    invoke-static {p0, p1, p2}, Lzm/n;->c(Landroid/content/Context;Landroid/graphics/Point;Landroid/graphics/Point;)V
...
.method public static e(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    invoke-static {p0, v0}, Lzm/n;->f(Landroid/content/Context;Landroid/graphics/Point;)V
...
.method public static f(Landroid/content/Context;Landroid/graphics/Point;)V
    ...
    invoke-static {p0}, Lzm/g;->a(Landroid/view/WindowManager;)Landroid/view/WindowMetrics;
...
.method public static g(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    invoke-static {p0}, Lzm/n;->e(Landroid/content/Context;)Landroid/graphics/Point;
...
.method public static h(Landroid/content/Context;)I
    ...
    invoke-static {p0}, Lzm/n;->j(Landroid/content/Context;)Landroid/graphics/Point;
...
.method public static j(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    invoke-static {p0, v0}, Lzm/n;->l(Landroid/content/Context;Landroid/graphics/Point;)V
...
.method public static n(Landroid/view/View;)Landroid/graphics/Point;
    ...
    invoke-static {p0}, Lzm/n;->k(Landroid/view/View;)Landroid/graphics/Point;
...
.method public static p(Landroid/content/Context;)Landroid/graphics/Rect;
    ...
    invoke-static {p0}, Lzm/n;->a(Landroid/content/Context;)Landroid/view/WindowMetrics;
