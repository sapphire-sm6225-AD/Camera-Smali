...
.field public static final d:Lzm/j$f;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lzm/j$f<",
...
.field public static final e:Lzm/j$f;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lzm/j$f<",
...
.field public static final f:Lzm/j$f;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lzm/j$f<",
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lzm/f;->b:Ljava/lang/ThreadLocal;

    new-instance v0, Ljava/lang/ThreadLocal;

    invoke-direct {v0}, Ljava/lang/ThreadLocal;-><init>()V

    sput-object v0, Lzm/f;->c:Ljava/lang/ThreadLocal;

    new-instance v0, Lzm/f$a;

    invoke-direct {v0}, Lzm/f$a;-><init>()V
    ...
    sput-object v0, Lzm/f;->d:Lzm/j$f;

    new-instance v0, Lzm/f$b;

    invoke-direct {v0}, Lzm/f$b;-><init>()V

    invoke-static {v0, v1}, Lzm/j;->d(Lzm/j$e;I)Lzm/j$i;

    move-result-object v0

    sput-object v0, Lzm/f;->e:Lzm/j$f;

    new-instance v0, Lzm/f$c;

    invoke-direct {v0}, Lzm/f$c;-><init>()V

    invoke-static {v0, v1}, Lzm/j;->d(Lzm/j$e;I)Lzm/j$i;

    move-result-object v0

    sput-object v0, Lzm/f;->f:Lzm/j$f;
    ...
    sput-object v3, Lzm/f;->g:Ljava/lang/String;

    invoke-virtual {v2}, Ljava/io/PrintWriter;->close()V

    invoke-interface {v0, v1}, Lzm/j$f;->release(Ljava/lang/Object;)V
...
.method public static A(Ljava/io/Reader;)Ljava/lang/String;
    ...
    sget-object v0, Lzm/f;->f:Lzm/j$f;
    ...
    invoke-static {p0, v1}, Lzm/f;->g(Ljava/io/Reader;Ljava/io/Writer;)J
...
.method public static K(Ljava/io/OutputStream;Ljava/util/Collection;Ljava/lang/String;)V
    ...
    sget-object p2, Lzm/f;->g:Ljava/lang/String;
...
.method public static h(Ljava/io/InputStream;Ljava/io/Writer;)V
    ...
    invoke-static {v0, p1}, Lzm/f;->g(Ljava/io/Reader;Ljava/io/Writer;)J
...
.method public static j(Ljava/io/Reader;Ljava/io/OutputStream;)V
    ...
    invoke-static {p0, v0}, Lzm/f;->g(Ljava/io/Reader;Ljava/io/Writer;)J
...
.method public static l()[B
    ...
    sget-object v0, Lzm/f;->b:Ljava/lang/ThreadLocal;
...
.method public static m()[C
    ...
    sget-object v0, Lzm/f;->c:Ljava/lang/ThreadLocal;
...
.method public static n(Ljava/io/InputStream;)Ljava/util/List;
    ...
    invoke-static {v0}, Lzm/f;->p(Ljava/io/Reader;)Ljava/util/List;
...
.method public static q(Ljava/io/InputStream;)[B
    ...
    sget-object v0, Lzm/f;->d:Lzm/j$f;
    ...
    invoke-static {p0, v1}, Lzm/f;->f(Ljava/io/InputStream;Ljava/io/OutputStream;)J
...
.method public static r(Ljava/io/Reader;)[B
    ...
    invoke-static {p0, v1}, Lzm/f;->j(Ljava/io/Reader;Ljava/io/OutputStream;)V
...
.method public static s(Ljava/io/Reader;Ljava/lang/String;)[B
    ...
    invoke-static {p0, v1, p1}, Lzm/f;->k(Ljava/io/Reader;Ljava/io/OutputStream;Ljava/lang/String;)V
...
.method public static t(Ljava/io/InputStream;)[C
    ...
    sget-object v0, Lzm/f;->e:Lzm/j$f;
    ...
    invoke-static {p0, v1}, Lzm/f;->h(Ljava/io/InputStream;Ljava/io/Writer;)V
...
.method public static u(Ljava/io/InputStream;Ljava/lang/String;)[C
    ...
    invoke-static {p0, v1, p1}, Lzm/f;->i(Ljava/io/InputStream;Ljava/io/Writer;Ljava/lang/String;)V
