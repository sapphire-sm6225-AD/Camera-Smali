...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 1
    invoke-direct {p0, p1, v0}, Lzn/d;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 2
    invoke-direct {p0, p1, p2, v0}, Lzn/d;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 6
    iput v0, p0, Lzn/d;->c:I

    .line 7
    iput v0, p0, Lzn/d;->a:I

    .line 8
    sget-object v0, Lyn/b$n;->FloatingActionButton:[I

    sget v1, Lyn/b$m;->Widget_FloatingActionButton:I
    ...
    .line 9
    sget p3, Lyn/b$n;->FloatingActionButton_fabShadowEnabled:I
    ...
    iput-boolean p3, p0, Lzn/d;->d:Z

    .line 10
    sget p3, Lyn/b$n;->FloatingActionButton_fabColor:I

    invoke-virtual {p2, p3}, Landroid/content/res/TypedArray;->hasValue(I)Z

    move-result v1

    iput-boolean v1, p0, Lzn/d;->g:Z
    ...
    sget v1, Lyn/b$e;->miuix_appcompat_fab_color_light:I
    ...
    iput p1, p0, Lzn/d;->f:I

    .line 13
    invoke-virtual {p2}, Landroid/content/res/TypedArray;->recycle()V

    .line 14
    new-instance p1, Lzn/d$a;
    ...
    sget p3, Lyn/b$g;->miuix_appcompat_fab_empty_holder:I

    invoke-virtual {p2, p3}, Landroid/content/res/Resources;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    invoke-direct {p1, p0, p2}, Lzn/d$a;-><init>(Lzn/d;Landroid/graphics/drawable/Drawable;)V

    iput-object p1, p0, Lzn/d;->h:Lzn/d$a;

    .line 15
    invoke-virtual {p0}, Lzn/d;->c()V

    .line 16
    invoke-virtual {p0}, Lzn/d;->e()V
...
.method private getDefaultBackground()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lzn/d;->e:Landroid/graphics/drawable/Drawable;
    ...
    iput v0, p0, Lzn/d;->f:I

    const/4 v0, 0x1

    iput-boolean v0, p0, Lzn/d;->g:Z

    invoke-virtual {p0}, Lzn/d;->b()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    iput-object v0, p0, Lzn/d;->e:Landroid/graphics/drawable/Drawable;

    :cond_0
    iget-object p0, p0, Lzn/d;->e:Landroid/graphics/drawable/Drawable;
...
.method public final b()Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v1, p0}, Lzn/d$b;-><init>(Landroid/view/View;)V

    invoke-direct {v0, v1}, Landroid/graphics/drawable/ShapeDrawable;-><init>(Landroid/graphics/drawable/shapes/Shape;)V

    iget-boolean v1, p0, Lzn/d;->d:Z
    ...
    invoke-virtual {p0, v1}, Lzn/d;->a(I)I
    ...
    iget v4, p0, Lzn/d;->a:I

    int-to-float v4, v4

    iget v5, p0, Lzn/d;->b:I

    int-to-float v5, v5

    iget v6, p0, Lzn/d;->c:I
    ...
    iget-object v0, p0, Lzn/d;->h:Lzn/d$a;
    ...
    invoke-direct {v3, p0}, Lzn/d$b;-><init>(Landroid/view/View;)V
...
.method public final c()V
    ...
    :cond_0
    invoke-direct {p0}, Lzn/d;->getDefaultBackground()Landroid/graphics/drawable/Drawable;
...
.method public final d()V
    ...
    iget-object p0, p0, Lzn/d;->h:Lzn/d$a;
...
.method public final e()V
    ...
    iget v2, p0, Lzn/d;->a:I

    iget v3, p0, Lzn/d;->c:I
