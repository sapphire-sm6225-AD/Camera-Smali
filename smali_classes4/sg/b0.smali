...
.method public constructor <init>(Ljava/lang/String;IILandroid/content/Context;)V
    ...
    iput-object p1, p0, Lsg/b0;->a:Ljava/lang/Object;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lsg/b0;->j:Z

    iput-boolean p1, p0, Lsg/b0;->k:Z

    iput-boolean p1, p0, Lsg/b0;->m:Z

    iput-boolean p1, p0, Lsg/b0;->n:Z

    iput-boolean p1, p0, Lsg/b0;->o:Z

    iput-boolean p1, p0, Lsg/b0;->p:Z

    iput-boolean p1, p0, Lsg/b0;->q:Z

    new-instance p1, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>()V

    iput-object p1, p0, Lsg/b0;->u:Ljava/util/concurrent/atomic/AtomicInteger;

    iput p2, p0, Lsg/b0;->c:I

    iput p3, p0, Lsg/b0;->d:I

    iput-object p4, p0, Lsg/b0;->f:Landroid/content/Context;

    return-void
.end method

.method public static synthetic a(Lsg/b0;)Lcom/arcsoft/avatar2/emoticon/AvatarEmoManager;
    .locals 0

    iget-object p0, p0, Lsg/b0;->t:Lcom/arcsoft/avatar2/emoticon/AvatarEmoManager;

    return-object p0
.end method

.method public static synthetic b(Lsg/b0;Ljava/util/ArrayList;)V
    .locals 0

    invoke-virtual {p0, p1}, Lsg/b0;->l(Ljava/util/ArrayList;)V

    return-void
.end method

.method public static synthetic c(Lsg/b0;)Ljava/util/concurrent/atomic/AtomicInteger;
    .locals 0

    iget-object p0, p0, Lsg/b0;->u:Ljava/util/concurrent/atomic/AtomicInteger;

    return-object p0
.end method

.method public static synthetic d(Lsg/b0;Z)V
    .locals 0

    invoke-virtual {p0, p1}, Lsg/b0;->k(Z)V

    return-void
.end method

.method public static synthetic e(Lsg/b0;Ljava/lang/String;)Z
    .locals 0

    invoke-virtual {p0, p1}, Lsg/b0;->o(Ljava/lang/String;)Z
...
.method public static synthetic f(Lsg/b0;)V
    .locals 0

    invoke-virtual {p0}, Lsg/b0;->s()V

    return-void
.end method

.method public static synthetic g(Lsg/b0;Lcom/arcsoft/avatar2/AvatarConfig$ASAvatarConfigInfo;)V
    .locals 0

    invoke-virtual {p0, p1}, Lsg/b0;->r(Lcom/arcsoft/avatar2/AvatarConfig$ASAvatarConfigInfo;)V

    return-void
.end method

.method public static synthetic h(Lsg/b0;)V
    .locals 0

    invoke-virtual {p0}, Lsg/b0;->q()V

    return-void
.end method

.method public static synthetic i(Lsg/b0;)V
    .locals 0

    invoke-virtual {p0}, Lsg/b0;->p()V

    return-void
.end method

.method public static synthetic j(Lsg/b0;Ljava/util/ArrayList;)V
    .locals 0

    invoke-virtual {p0, p1}, Lsg/b0;->n(Ljava/util/ArrayList;)V
...
.method public A(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lsg/b0;->g:Lsg/b0$b;
    ...
    iget-object p0, p0, Lsg/b0;->g:Lsg/b0$b;
...
.method public B()V
    ...
    iget-object v0, p0, Lsg/b0;->e:Lcom/arcsoft/avatar2/AvatarEngine;
    ...
    :cond_0
    iget-object v0, p0, Lsg/b0;->t:Lcom/arcsoft/avatar2/emoticon/AvatarEmoManager;
    ...
    iget-object v1, p0, Lsg/b0;->e:Lcom/arcsoft/avatar2/AvatarEngine;
    ...
    invoke-virtual {v3}, Lvg/a;->d()Lcom/arcsoft/avatar2/AvatarConfig$ASAvatarConfigValue;

    move-result-object v3

    iget v3, v3, Lcom/arcsoft/avatar2/AvatarConfig$ASAvatarConfigValue;->configFaceColorID:I

    new-instance v4, Lsg/b0$a;

    invoke-direct {v4, p0}, Lsg/b0$a;-><init>(Lsg/b0;)V
    ...
    iput-object v0, p0, Lsg/b0;->t:Lcom/arcsoft/avatar2/emoticon/AvatarEmoManager;
    ...
    invoke-virtual {v0, p0}, Lvg/a;->M(Lcom/arcsoft/avatar2/emoticon/AvatarEmoManager;)V
...
.method public final C()V
    ...
    iget v1, p0, Lsg/b0;->c:I

    iget v2, p0, Lsg/b0;->d:I

    invoke-direct {v0, v1, v2}, Lsg/d;-><init>(II)V

    iput-object v0, p0, Lsg/b0;->b:Lsg/d;
...
.method public final G()V
    ...
    iput-object v1, p0, Lsg/b0;->e:Lcom/arcsoft/avatar2/AvatarEngine;

    :cond_0
    iget-object v0, p0, Lsg/b0;->b:Lsg/d;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lsg/d;->i()V

    iput-object v1, p0, Lsg/b0;->b:Lsg/d;
    ...
    iput-object v1, p0, Lsg/b0;->t:Lcom/arcsoft/avatar2/emoticon/AvatarEmoManager;
...
.method public H()V
    ...
    invoke-virtual {p0, v0}, Lsg/b0;->M(Z)V
...
.method public final I(Ljava/util/ArrayList;)V
    ...
    iget-object p1, p0, Lsg/b0;->i:Ljava/lang/String;
    ...
    :cond_0
    iget-object v2, p0, Lsg/b0;->r:Lug/b;
    ...
    invoke-virtual {v2, v0, v3}, Lug/b;->b(Lcom/arcsoft/avatar2/AvatarEngine;Lcom/arcsoft/avatar2/AvatarConfig$ASAvatarConfigValue;)V
    ...
    invoke-virtual {v2}, Lvg/a;->d()Lcom/arcsoft/avatar2/AvatarConfig$ASAvatarConfigValue;
    ...
    iget-object p0, p0, Lsg/b0;->e:Lcom/arcsoft/avatar2/AvatarEngine;
...
.method public N(Landroid/os/Handler;)V
    ...
    iput-object p1, p0, Lsg/b0;->h:Landroid/os/Handler;
...
.method public O()V
    ...
    iget-object v0, p0, Lsg/b0;->a:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-boolean v1, p0, Lsg/b0;->j:Z
    :try_end_0
    ...
    :try_start_1
    iget-object p0, p0, Lsg/b0;->a:Ljava/lang/Object;
...
.method public final k(Z)V
    ...
    :cond_1
    iget-boolean v0, p0, Lsg/b0;->p:Z

    if-eqz v0, :cond_2

    invoke-virtual {p0}, Lsg/b0;->x()V
    ...
    iget v3, p0, Lsg/b0;->l:I

    sub-int/2addr v3, v2

    iput v3, p0, Lsg/b0;->l:I
    ...
    invoke-virtual {p0, p1}, Lsg/b0;->w(Z)V
...
.method public final l(Ljava/util/ArrayList;)V
    ...
    sget-object v0, Ldg/w;->W:Ljava/lang/String;
    ...
    :try_start_0
    iget-object v6, p0, Lsg/b0;->t:Lcom/arcsoft/avatar2/emoticon/AvatarEmoManager;
    ...
    new-instance v8, La8/r$a;

    invoke-direct {v8}, La8/r$a;-><init>()V
    ...
    invoke-static {v9, v10}, Lcom/android/camera/c6;->Y(J)Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v8, v6}, La8/g$a;->T(Ljava/lang/String;)La8/g$a;
    ...
    invoke-virtual {v8, v5}, La8/g$a;->O(Z)La8/g$a;

    const/4 v6, -0x1

    invoke-virtual {v8, v6}, La8/g$a;->S(I)La8/g$a;

    iget-object v6, p0, Lsg/b0;->f:Landroid/content/Context;

    check-cast v6, Lcom/android/camera/ActivityBase;

    invoke-interface {v6}, Lcom/android/camera/j;->S0()La8/h;

    move-result-object v6

    const/4 v9, 0x0

    invoke-virtual {v6, v8, v9}, La8/h;->t(La8/g$a;Landroid/hardware/camera2/CaptureResult;)V
    ...
    :goto_1
    invoke-interface {v0, v7, v4, v6}, Lkg/a$c$a;->s4(Ljava/lang/String;Lcom/arcsoft/avatar2/emoticon/EmoInfo;Z)V
    :try_end_0
...
.method public final n(Ljava/util/ArrayList;)V
    ...
    iget-object v0, p0, Lsg/b0;->u:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    sget-object v0, Ldg/w;->V:Ljava/lang/String;
    ...
    sget-object v2, Ldg/w;->U:Ljava/lang/String;
    ...
    iget-object v3, p0, Lsg/b0;->t:Lcom/arcsoft/avatar2/emoticon/AvatarEmoManager;
    ...
    iget-object v1, p0, Lsg/b0;->t:Lcom/arcsoft/avatar2/emoticon/AvatarEmoManager;
    ...
    iget-object p1, p0, Lsg/b0;->u:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-interface {p0}, Lkg/a$c$a;->pg()V
...
.method public final o(Ljava/lang/String;)Z
    ...
    iput-object v0, p0, Lsg/b0;->e:Lcom/arcsoft/avatar2/AvatarEngine;

    sget-object v3, Lvg/a;->r:Ljava/lang/String;

    sget-object v4, Lvg/a;->s:Ljava/lang/String;
    ...
    iput-object p1, p0, Lsg/b0;->i:Ljava/lang/String;

    new-instance p1, Lug/b;

    invoke-direct {p1}, Lug/b;-><init>()V

    iput-object p1, p0, Lsg/b0;->r:Lug/b;

    iput-boolean v2, p0, Lsg/b0;->k:Z
...
.method public final p()V
    ...
    iput-boolean v0, p0, Lsg/b0;->k:Z

    invoke-virtual {p0}, Lsg/b0;->G()V
...
.method public final q()V
    ...
    invoke-virtual {p0, v0}, Lsg/b0;->t(Z)V
...
.method public run()V
    ...
    new-instance v0, Lsg/b0$b;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lsg/b0$b;-><init>(Lsg/b0;Lsg/b0$a;)V

    iput-object v0, p0, Lsg/b0;->g:Lsg/b0$b;
    ...
    :try_start_0
    iput-boolean v3, p0, Lsg/b0;->q:Z

    invoke-virtual {p0}, Lsg/b0;->C()V

    iput-boolean v0, p0, Lsg/b0;->q:Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :goto_0
    iget-object v2, p0, Lsg/b0;->a:Ljava/lang/Object;

    monitor-enter v2

    :try_start_1
    iput-boolean v0, p0, Lsg/b0;->j:Z
    ...
    :try_start_2
    iput-boolean v3, p0, Lsg/b0;->j:Z

    iput-object v1, p0, Lsg/b0;->g:Lsg/b0$b;
...
.method public w(Z)V
    ...
    iget-object v0, p0, Lsg/b0;->i:Ljava/lang/String;
    ...
    iget-object v4, p0, Lsg/b0;->f:Landroid/content/Context;

    invoke-virtual {v3, v4, v0}, Lvg/a;->u(Landroid/content/Context;I)Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget-object v7, v5, Lrg/a;->b:Ljava/lang/String;
    ...
    iget-object v5, v5, Lrg/a;->a:Ljava/util/ArrayList;
    ...
    :cond_5
    iget-object v8, p0, Lsg/b0;->r:Lug/b;

    iget-object v9, p0, Lsg/b0;->e:Lcom/arcsoft/avatar2/AvatarEngine;

    invoke-static {}, Lvg/a;->n()Lvg/a;

    move-result-object v10

    invoke-virtual {v10}, Lvg/a;->d()Lcom/arcsoft/avatar2/AvatarConfig$ASAvatarConfigValue;

    move-result-object v10

    iget v10, v10, Lcom/arcsoft/avatar2/AvatarConfig$ASAvatarConfigValue;->gender:I

    sget-object v11, Lsg/b0;->q1:[F

    invoke-virtual {v8, v9, v7, v10, v11}, Lug/b;->a(Lcom/arcsoft/avatar2/AvatarEngine;Lcom/arcsoft/avatar2/AvatarConfig$ASAvatarConfigInfo;I[F)V

    iget-object v7, p0, Lsg/b0;->h:Landroid/os/Handler;

    invoke-virtual {v7}, Landroid/os/Handler;->obtainMessage()Landroid/os/Message;

    move-result-object v7

    iget-boolean v8, p0, Lsg/b0;->n:Z

    if-eqz v8, :cond_6

    iput-boolean v2, p0, Lsg/b0;->m:Z

    iput-boolean v2, p0, Lsg/b0;->n:Z

    iput-boolean v2, p0, Lsg/b0;->o:Z

    invoke-static {}, Lvg/a;->n()Lvg/a;

    move-result-object v1

    invoke-virtual {v1}, Lvg/a;->G()V

    invoke-static {}, Lvg/a;->n()Lvg/a;

    move-result-object v1

    invoke-virtual {v1, v0, v2}, Lvg/a;->S(IZ)V

    invoke-virtual {p0, v5}, Lsg/b0;->I(Ljava/util/ArrayList;)V

    invoke-virtual {p0, p1}, Lsg/b0;->t(Z)V

    return-void

    :cond_6
    iget-boolean v8, p0, Lsg/b0;->m:Z
    ...
    invoke-virtual {v1, v0, p1}, Lvg/a;->S(IZ)V

    const/4 p1, 0x6

    iput p1, v7, Landroid/os/Message;->what:I

    iget-object p0, p0, Lsg/b0;->h:Landroid/os/Handler;
    ...
    iget-object v8, p0, Lsg/b0;->h:Landroid/os/Handler;
    ...
    invoke-virtual {p1, v0, v2}, Lvg/a;->S(IZ)V

    invoke-static {}, Lug/a;->b()Lug/a;

    move-result-object p1

    invoke-virtual {p1, v2}, Lug/a;->c(Z)V
...
.method public final x()V
    ...
    iget-object v5, p0, Lsg/b0;->t:Lcom/arcsoft/avatar2/emoticon/AvatarEmoManager;

    sget-object v6, Lvg/a;->Z:Landroid/util/Size;
    ...
    sget-object v7, Lsg/b0;->v1:[I

    aget v7, v7, v3

    invoke-interface {v6, v3, v4, v7}, Lkg/a$c$a;->x4(ILcom/arcsoft/avatar2/emoticon/EmoInfo;I)V
