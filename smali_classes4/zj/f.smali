...
# direct methods
.method public constructor <init>(Lzj/c;Landroid/graphics/SurfaceTexture;[I)V
    .locals 0
    .param p1    # Lzj/c;
    ...
    .line 5
    invoke-direct {p0, p1}, Lzj/e;-><init>(Lzj/c;)V
    ...
    iput-object p1, p0, Lzj/f;->g:Ljava/lang/Object;

    .line 8
    invoke-virtual {p0, p2, p3}, Lzj/f;->p(Ljava/lang/Object;[I)V

    return-void
.end method

.method public constructor <init>(Lzj/c;Landroid/view/Surface;[I)V
    .locals 0
    .param p1    # Lzj/c;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public g()Z
    ...
    iget-object v0, p0, Lzj/f;->g:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-boolean v1, p0, Lzj/f;->f:Z

    if-eqz v1, :cond_0

    invoke-super {p0}, Lzj/e;->g()Z
...
.method public j()Z
    ...
    iput-boolean v2, p0, Lzj/f;->f:Z

    invoke-super {p0}, Lzj/e;->j()Z
...
.method public final m(Landroid/graphics/SurfaceTexture;[I)Landroid/opengl/EGLSurface;
    ...
    invoke-virtual {p0, p1, p2}, Lzj/f;->o(Ljava/lang/Object;[I)Landroid/opengl/EGLSurface;
...
.method public final o(Ljava/lang/Object;[I)Landroid/opengl/EGLSurface;
    ...
    invoke-virtual {v1}, Lzj/c;->e()Landroid/opengl/EGLDisplay;

    move-result-object v1

    iget-object v3, p0, Lzj/e;->a:Lzj/c;

    invoke-virtual {v3}, Lzj/c;->c()Landroid/opengl/EGLConfig;
...
.method public final p(Ljava/lang/Object;[I)V
    ...
    invoke-virtual {p0, p1, p2}, Lzj/f;->n(Landroid/view/Surface;[I)Landroid/opengl/EGLSurface;

    move-result-object p1

    iput-object p1, p0, Lzj/e;->b:Landroid/opengl/EGLSurface;
    ...
    invoke-virtual {p0, p1, p2}, Lzj/f;->m(Landroid/graphics/SurfaceTexture;[I)Landroid/opengl/EGLSurface;
...
.method public q()Z
    ...
    invoke-virtual {p0, v1}, Lzj/e;->f(Landroid/opengl/EGLSurface;)Z
    ...
    invoke-virtual {p0, v1}, Lzj/e;->h(Landroid/opengl/EGLSurface;)Z
