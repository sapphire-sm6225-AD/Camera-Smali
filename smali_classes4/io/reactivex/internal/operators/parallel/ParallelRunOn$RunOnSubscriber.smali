...
# direct methods
.method public constructor <init>(Lzq/p;ILio/reactivex/internal/queue/SpscArrayQueue;Lio/reactivex/Scheduler$Worker;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Lzq/p;
...
.method public onSubscribe(Lzq/q;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lzq/q;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lzq/q;

    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Lzq/p;
...
.method public run()V
    ...
    iget-object v3, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Lzq/p;
    ...
    invoke-interface {v3, v15}, Lzq/p;->onError(Ljava/lang/Throwable;)V
    ...
    :cond_6
    invoke-interface {v3, v15}, Lzq/p;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v13, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lzq/q;

    int-to-long v14, v1

    invoke-interface {v13, v14, v15}, Lzq/q;->request(J)V
    ...
    invoke-interface {v3, v13}, Lzq/p;->onError(Ljava/lang/Throwable;)V
