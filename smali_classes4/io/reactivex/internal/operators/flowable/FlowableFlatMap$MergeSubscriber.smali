...
.method public constructor <init>(Lzq/p;Lio/reactivex/functions/Function;ZII)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->downstream:Lzq/p;
...
.method public addInner(Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;)Z
    ...
    invoke-static {v1, v0, v3}, Lk9/a;->a(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->upstream:Lzq/q;
...
.method public checkTerminate()Z
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->downstream:Lzq/p;
...
.method public drainLoop()V
    ...
    iget-object v2, v1, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->downstream:Lzq/p;
    ...
    :cond_4
    invoke-interface {v2, v10}, Lzq/p;->onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v2}, Lzq/p;->onComplete()V
    ...
    :cond_17
    invoke-interface {v2, v14}, Lzq/p;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v0, v1, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->upstream:Lzq/q;
    ...
    invoke-interface {v0, v3, v4}, Lzq/q;->request(J)V
...
.method public innerError(Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;Ljava/lang/Throwable;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->upstream:Lzq/q;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->upstream:Lzq/q;
    ...
    invoke-interface {p1, v0}, Lzq/o;->subscribe(Lzq/p;)V
...
.method public onSubscribe(Lzq/q;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->upstream:Lzq/q;

    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->downstream:Lzq/p;
...
.method public tryEmitScalar(Ljava/lang/Object;)V
    ...
    :cond_0
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->downstream:Lzq/p;

    invoke-interface {v1, p1}, Lzq/p;->onNext(Ljava/lang/Object;)V
