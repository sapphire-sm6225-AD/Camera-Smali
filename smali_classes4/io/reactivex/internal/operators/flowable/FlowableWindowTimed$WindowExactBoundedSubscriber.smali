...
# direct methods
.method public constructor <init>(Lzq/p;JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;IJZ)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, v0}, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;-><init>(Lzq/p;Lio/reactivex/internal/fuseable/SimplePlainQueue;)V
...
.method public drainLoop()V
    ...
    iget-object v2, v0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lzq/p;
    ...
    iget-object v2, v0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Lzq/q;
    ...
    invoke-interface {v2, v3}, Lzq/p;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v1, v0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Lzq/q;

    invoke-interface {v1}, Lzq/q;->cancel()V
    ...
    invoke-interface {v2, v1}, Lzq/p;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v6, v0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lzq/p;

    invoke-interface {v6, v5}, Lzq/p;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v1, v0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lzq/p;
    ...
    invoke-interface {v1, v2}, Lzq/p;->onError(Ljava/lang/Throwable;)V
...
.method public onComplete()V
    ...
    :cond_0
    iget-object p0, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lzq/p;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lzq/p;
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Lzq/q;

    invoke-interface {p1}, Lzq/q;->cancel()V

    iget-object p1, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lzq/p;
    ...
    invoke-interface {p1, v0}, Lzq/p;->onError(Ljava/lang/Throwable;)V
...
.method public onSubscribe(Lzq/q;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Lzq/q;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Lzq/q;
    ...
    invoke-interface {v0, p0}, Lzq/p;->onError(Ljava/lang/Throwable;)V
