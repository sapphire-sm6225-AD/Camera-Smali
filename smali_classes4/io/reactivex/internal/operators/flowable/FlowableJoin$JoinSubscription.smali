...
.method public constructor <init>(Lzq/p;Lio/reactivex/functions/Function;Lio/reactivex/functions/Function;Lio/reactivex/functions/BiFunction;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->downstream:Lzq/p;
...
.method public drain()V
    ...
    iget-object v3, v1, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->downstream:Lzq/p;
    ...
    invoke-virtual {v1, v3}, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->errorAll(Lzq/p;)V
    ...
    invoke-interface {v3}, Lzq/p;->onComplete()V
    ...
    invoke-interface {v7, v8}, Lzq/o;->subscribe(Lzq/p;)V
    ...
    invoke-virtual {v1, v0, v3, v2}, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->fail(Ljava/lang/Throwable;Lzq/p;Lio/reactivex/internal/fuseable/SimpleQueue;)V
    ...
    invoke-interface {v3, v8}, Lzq/p;->onNext(Ljava/lang/Object;)V
...
.method public errorAll(Lzq/p;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public fail(Ljava/lang/Throwable;Lzq/p;Lio/reactivex/internal/fuseable/SimpleQueue;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p2}, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->errorAll(Lzq/p;)V
