...
# virtual methods
.method public checkTerminated(ZZZLzq/p;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZZ",
    ...
    invoke-interface {p4, p0}, Lzq/p;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {p4, p1}, Lzq/p;->onError(Ljava/lang/Throwable;)V

    goto :goto_0

    :cond_2
    invoke-interface {p4}, Lzq/p;->onComplete()V
...
.method public drain()V
    ...
    invoke-virtual {p0, v0}, Lio/reactivex/processors/UnicastProcessor;->drainFused(Lzq/p;)V

    goto :goto_1

    :cond_1
    invoke-virtual {p0, v0}, Lio/reactivex/processors/UnicastProcessor;->drainRegular(Lzq/p;)V
...
.method public drainFused(Lzq/p;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_2
    invoke-interface {p1, v4}, Lzq/p;->onNext(Ljava/lang/Object;)V
...
.method public drainRegular(Lzq/p;)V
    .locals 17
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual/range {v0 .. v5}, Lio/reactivex/processors/UnicastProcessor;->checkTerminated(ZZZLzq/p;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    invoke-interface {v5, v8}, Lzq/p;->onNext(Ljava/lang/Object;)V
