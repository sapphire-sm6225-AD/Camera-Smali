...
.method public static a(Landroid/content/Context;Lyj/b;Ljava/lang/String;I)I
    .locals 9
    ...
    invoke-static {v2}, Lzj/g;->b(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, v2}, Lzj/g;->c(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    iget-boolean p1, p1, Lyj/b;->i:Z

    if-eqz p1, :cond_2

    invoke-static {p2}, Lzj/g;->b(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    :cond_2
    invoke-static {p0, p2}, Lzj/g;->c(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    sget-object p0, Lxj/b;->b:Lxj/b;

    goto :goto_2

    :cond_4
    sget-object p0, Lxj/b;->c:Lxj/b;

    :goto_2
    invoke-virtual {p0}, Lxj/b;->a()I
