...
.method private doJpeg(Ldd/x;Landroid/media/Image;I)V
    .locals 8
    ...
    invoke-direct/range {v2 .. v7}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->generateReprocessData(Ldd/x;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;

    move-result-object p1

    const/4 p2, 0x0

    invoke-static {p3, p2}, Lyc/e;->d(II)V
...
.method private generateReprocessData(Ldd/x;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
    .locals 16
    ...
    invoke-virtual/range {p1 .. p1}, Ldd/x;->l0()Z
    ...
    invoke-virtual/range {p1 .. p1}, Ldd/x;->m0()Z
    ...
    invoke-virtual/range {p1 .. p1}, Ldd/x;->P()Landroid/media/Image;
    ...
    invoke-virtual/range {p1 .. p1}, Ldd/x;->K()I

    move-result v1

    invoke-virtual/range {p1 .. p1}, Ldd/x;->J()I
    ...
    invoke-virtual/range {p1 .. p1}, Ldd/x;->x()Ljava/lang/String;
...
.method private handleDataBeanIfReady(Lcom/xiaomi/camera/mivi/mtk/OfflineImageData;Z)V
    ...
    invoke-virtual {p2, v0}, Lb7/n;->s(Ljava/lang/String;)J

    invoke-virtual {p1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageData;->getTimestamp()J

    move-result-wide v0

    invoke-virtual {p0, v0, v1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->getParallelTaskData(J)Ldd/x;
    ...
    :cond_1
    invoke-virtual {p2}, Ldd/x;->w()J

    move-result-wide v0

    invoke-virtual {p2}, Ldd/x;->x()Ljava/lang/String;
    ...
    invoke-static {v0}, Lyc/d;->g(Landroid/media/Image;)[B
    ...
    invoke-virtual {p2, v0, v1}, Ldd/x;->a([BI)V
    ...
    invoke-virtual {p2, v0}, Ldd/x;->v1(Landroid/media/Image;)V
    ...
    invoke-direct {p0, v1, p2, v0}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->postCvWaterMark(Landroid/media/Image;Ldd/x;I)V
    ...
    invoke-direct {p0, p2, v0, v1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->doJpeg(Ldd/x;Landroid/media/Image;I)V
...
.method private handleRawImageData([BLjava/lang/String;)V
    ...
    invoke-static {p0, p1}, Lcom/xiaomi/camera/mivi/MIVICaptureManager;->notifyFinish(Ldd/x;Ljava/lang/String;)V

    :cond_0
    return-void
.end method

.method private postCvWaterMark(Landroid/media/Image;Ldd/x;I)V
    .locals 5
    ...
    invoke-static {p1}, Lyc/d;->f(Landroid/media/Image;)[B
    ...
    invoke-virtual {p2, v0}, Ldd/x;->b1(Z)V
...
# virtual methods
.method public getParallelTaskData(J)Ldd/x;
    .locals 3
...
.method public putParallelTaskData(JLdd/x;)V
    .locals 4
