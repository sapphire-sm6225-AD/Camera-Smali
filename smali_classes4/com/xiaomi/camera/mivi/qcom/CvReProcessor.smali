...
.method public submit(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;Lcom/xiaomi/camera/mivi/qcom/IReProcessor$Callback;)V
    ...
    invoke-static {v4}, Lyc/d;->f(Landroid/media/Image;)[B
    ...
    invoke-static {v5, v6, v7, v15}, Lcom/xiaomi/camera/mivi/MIVICaptureManager;->getParallelTaskData(Ljava/lang/String;JZ)Ldd/x;
    ...
    invoke-virtual/range {v16 .. v16}, Ldd/x;->s()Ldd/y;

    move-result-object v5

    invoke-virtual {v5}, Ldd/y;->l0()I
