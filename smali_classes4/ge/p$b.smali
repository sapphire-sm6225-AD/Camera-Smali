...
# instance fields
.field public final synthetic f:Lge/p;


# direct methods
.method public constructor <init>(Lge/p;Ljava/lang/String;)V
    .locals 1

    iput-object p1, p0, Lge/p$b;->f:Lge/p;

    const-string p1, "10000000-0000-1000-8000-00805f9b34fq"

    const-string v0, "JSON-RPC-SERVICE"

    invoke-direct {p0, p1, v0, p2}, Lhe/c$b;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public onAdvertisingResult(Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;)V
    ...
    iget-object p0, p0, Lge/p$b;->f:Lge/p;

    iget-object p0, p0, Lge/c;->J:Lge/c$i;

    invoke-virtual {p0, p1}, Lge/c$i;->f(Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;)V
...
.method public onServiceConnectStatus(ILjava/lang/String;Lcom/xiaomi/idm/bean/EndPoint;Lcom/xiaomi/idm/bean/ConnParam;)Z
    ...
    iget-object p1, p0, Lge/p$b;->f:Lge/p;

    invoke-static {p1, p2}, Lge/p;->D1(Lge/p;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput p2, p1, Lge/c;->T:I

    iget-object p0, p0, Lge/p$b;->f:Lge/p;

    iget-object p1, p0, Lge/c;->J:Lge/c$i;

    invoke-static {p0}, Lge/p;->C1(Lge/p;)Ljava/lang/String;

    move-result-object p0

    invoke-virtual {p1, p0, p3, p4}, Lge/c$i;->d(Ljava/lang/String;Lcom/xiaomi/idm/bean/EndPoint;Lcom/xiaomi/idm/bean/ConnParam;)V
    ...
    invoke-virtual {p0, p2, p3, p4, p1}, Lge/c$i;->i(Ljava/lang/String;Lcom/xiaomi/idm/bean/EndPoint;Lcom/xiaomi/idm/bean/ConnParam;Lcom/xiaomi/idm/constant/ResponseCode$ConnectCode;)V
