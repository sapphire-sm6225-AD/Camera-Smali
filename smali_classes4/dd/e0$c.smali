...
.method public constructor <init>(Ldd/e0;)V
    ...
    iput-object p1, p0, Ldd/e0$c;->a:Ldd/e0;
...
.method public a(Ldd/e;)V
    ...
    invoke-virtual {p0, p1, v0}, Ldd/e0$c;->d(Ldd/e;Ljava/lang/String;)V
...
.method public c(Ldd/e;)V
    ...
    iget-object v5, p0, Ldd/e0$c;->a:Ldd/e0;

    invoke-virtual {v5}, Ldd/e0;->z0()Z
    ...
    iget-object v6, p0, Ldd/e0$c;->a:Ldd/e0;

    invoke-static {v6, v7, v8}, Ldd/e0;->N(Ldd/e0;J)Ldd/x;

    move-result-object v6

    invoke-virtual {v5}, Ldd/e$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {v6, v9, v10}, Ldd/x;->u1(J)V

    iget-object v11, p0, Ldd/e0$c;->a:Ldd/e0;

    invoke-static {v11, v7, v8}, Ldd/e0;->l(Ldd/e0;J)Ldd/x;

    iget-object v11, p0, Ldd/e0$c;->a:Ldd/e0;

    invoke-static {v11, v9, v10, v6}, Ldd/e0;->K(Ldd/e0;JLdd/x;)V

    :cond_1
    if-ne v1, v0, :cond_4

    iget-object v1, p0, Ldd/e0$c;->a:Ldd/e0;

    invoke-virtual {v1}, Ldd/e0;->z0()Z
    ...
    invoke-virtual {v0}, Ldd/e$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v4, p0, Ldd/e0$c;->a:Ldd/e0;

    invoke-static {v4, v7, v8}, Ldd/e0;->N(Ldd/e0;J)Ldd/x;

    move-result-object v4

    if-eqz v4, :cond_9

    invoke-virtual {v4, v1}, Ldd/x;->I0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V

    invoke-virtual {v4}, Ldd/x;->s()Ldd/y;

    move-result-object v1

    invoke-virtual {v1}, Ldd/y;->d1()Z
    ...
    invoke-virtual {v4}, Ldd/x;->L()Lik/b;
    ...
    invoke-direct/range {v0 .. v6}, Ldd/i0;-><init>(Ljava/util/List;ZJZLik/b;)V

    invoke-virtual {p1}, Ldd/e;->c()I

    move-result v0

    invoke-virtual {p0, v0}, Ldd/i0;->h(I)V
    ...
    iget-object v0, p1, Ldd/l;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {p1, p0}, Ldd/l;->e(Ldd/i0;)I

    goto/16 :goto_1

    :cond_8
    iget-object p1, p0, Ldd/e0$c;->a:Ldd/e0;

    invoke-static {p1}, Ldd/e0;->d(Ldd/e0;)Ldd/l$a;

    move-result-object p1

    invoke-interface {p1, v7, v8, v3}, Ldd/l$a;->c(JI)V
    ...
    invoke-virtual {p1, v1}, Lb7/n;->s(Ljava/lang/String;)J
    ...
    invoke-virtual {p1, v1}, Lb7/n;->Y(Ljava/lang/String;)V
    ...
    invoke-interface {p1, v0, v3, v3}, Ldd/l$a;->f(Landroid/media/Image;IZ)V

    invoke-virtual {v0}, Landroid/media/Image;->close()V

    invoke-virtual {p0, v0}, Ldd/e0$c;->b(Landroid/media/Image;)V
    ...
    :cond_a
    iget-object v0, p0, Ldd/e0$c;->a:Ldd/e0;

    invoke-static {v0, v7, v8}, Ldd/e0;->N(Ldd/e0;J)Ldd/x;
    ...
    invoke-virtual {v5}, Ldd/e$a;->e()Landroid/media/Image;

    move-result-object v1

    invoke-virtual {v0, v6}, Ldd/x;->I0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V
    ...
    invoke-static {v5, v1, v4}, Lyc/d;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;
    ...
    invoke-direct {v5, v4, v3, v6}, Ldd/j;-><init>(Landroid/media/Image;IZ)V

    invoke-virtual {v0, v5}, Ldd/l;->d(Ldd/j;)V
    ...
    :cond_b
    invoke-virtual {p0, v1}, Ldd/e0$c;->b(Landroid/media/Image;)V

    goto :goto_1

    :cond_c
    invoke-virtual {p0, p1, v1}, Ldd/e0$c;->d(Ldd/e;Ljava/lang/String;)V
...
.method public final d(Ldd/e;Ljava/lang/String;)V
    .locals 13
    .param p1    # Ldd/e;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {v7}, Ldd/e$a;->p()Z

    move-result v9

    if-eqz v9, :cond_2

    invoke-virtual {v7}, Ldd/e$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {v5, v9, v10}, Ldd/e0;->N(Ldd/e0;J)Ldd/x;
    ...
    iget-object v7, p0, Ldd/e0$c;->a:Ldd/e0;

    invoke-virtual {p1}, Ldd/e;->b()I

    move-result v9

    invoke-static {v7, p1, v9}, Ldd/e0;->O(Ldd/e0;Ldd/e;I)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v7

    invoke-virtual {v5, v7}, Ldd/x;->I0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V
    ...
    invoke-static {v7, v10, v11}, Ldd/e0;->N(Ldd/e0;J)Ldd/x;
    ...
    iget-object v8, p0, Ldd/e0$c;->a:Ldd/e0;

    invoke-virtual {p1}, Ldd/e;->b()I

    move-result v9

    invoke-static {v8, p1, v9}, Ldd/e0;->O(Ldd/e0;Ldd/e;I)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v8

    invoke-virtual {v7, v8}, Ldd/x;->I0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V
    ...
    invoke-static {v0, p2, p0}, Ldd/e0;->k(Ldd/e0;Ldd/e$a;Ldd/f;)V
    ...
    invoke-virtual {v0}, Ldd/i0;->a()Z

    move-result v5

    if-eqz v5, :cond_9

    iget-object v5, v4, Ldd/l;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v5}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndIncrement()I

    :cond_9
    iget-object p0, p0, Ldd/e0$c;->a:Ldd/e0;
    ...
    invoke-virtual {v0, v2}, Ldd/i0;->i(I)V

    :cond_b
    if-eqz v4, :cond_c

    invoke-virtual {v4, v0}, Ldd/l;->e(Ldd/i0;)I
