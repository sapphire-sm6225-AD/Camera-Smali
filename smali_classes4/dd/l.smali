...
.method public constructor <init>(Ldd/l$a;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    iput-object v0, p0, Ldd/l;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    iput-object v0, p0, Ldd/l;->c:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    iput-object v0, p0, Ldd/l;->d:Ljava/util/concurrent/atomic/AtomicInteger;

    const/4 v0, 0x4

    iput v0, p0, Ldd/l;->e:I

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, Ldd/l;->g:Ljava/lang/Object;

    new-instance v2, Landroid/os/ConditionVariable;

    invoke-direct {v2}, Landroid/os/ConditionVariable;-><init>()V

    iput-object v2, p0, Ldd/l;->k:Landroid/os/ConditionVariable;

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, Ldd/l;->o:Ljava/lang/Object;

    new-instance v2, Ljava/util/LinkedList;

    invoke-direct {v2}, Ljava/util/LinkedList;-><init>()V

    iput-object v2, p0, Ldd/l;->p:Ljava/util/LinkedList;

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, Ldd/l;->q:Ljava/lang/Object;

    iput v1, p0, Ldd/l;->r:I
    ...
    iput-object p1, p0, Ldd/l;->j:Ldd/l$a;
    ...
    :goto_0
    iput-boolean p1, p0, Ldd/l;->n:Z

    sget-object p1, Ljava/util/Locale;->ENGLISH:Ljava/util/Locale;

    new-array v0, v0, [Ljava/lang/Object;

    invoke-virtual {p0}, Ldd/l;->i()Ljava/lang/String;
    ...
    iput-object p1, p0, Ldd/l;->m:Ljava/lang/String;
    ...
    iput-object v0, p0, Ldd/l;->h:Landroid/os/HandlerThread;

    new-instance p1, Ldd/i;

    invoke-direct {p1}, Ldd/i;-><init>()V

    iput-object p1, p0, Ldd/l;->l:Ldd/i;
    ...
    invoke-virtual {p1, p0}, Ldd/i;->d(Landroid/util/Size;)V
...
.method public D(I)V
    ...
    iget-object v0, p0, Ldd/l;->q:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iput p1, p0, Ldd/l;->r:I
...
.method public G()V
    ...
    iget-object v0, p0, Ldd/l;->h:Landroid/os/HandlerThread;
    ...
    :try_start_0
    new-instance v1, Ldd/l$b;

    iget-object v3, p0, Ldd/l;->h:Landroid/os/HandlerThread;

    invoke-virtual {v3}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v3

    invoke-direct {v1, v3, p0}, Ldd/l$b;-><init>(Landroid/os/Looper;Ldd/l;)V

    iput-object v1, p0, Ldd/l;->i:Landroid/os/Handler;
    ...
    invoke-virtual {p0, v0}, Ldd/l;->D(I)V
...
.method public H()V
    ...
    iput-object v3, p0, Ldd/l;->i:Landroid/os/Handler;
...
.method public J()Z
    ...
    invoke-virtual {p0, v2}, Ldd/l;->D(I)V
...
.method public K()V
    ...
    invoke-virtual {p0}, Ldd/l;->s()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Ldd/l;->p()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Ldd/l;->H()V
...
.method public abstract e(Ldd/i0;)I
    .param p1    # Ldd/i0;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method public f(Ldd/j;)V
    ...
    iget-object v0, p1, Ldd/j;->a:Landroid/media/Image;

    invoke-virtual {v0}, Landroid/media/Image;->getTimestamp()J

    move-result-wide v1

    iget v3, p1, Ldd/j;->b:I

    iget-object v4, p0, Ldd/l;->j:Ldd/l$a;
    ...
    invoke-interface {v4, v1, v2}, Ldd/l$a;->d(J)Ldd/x;
    ...
    :cond_0
    sget-boolean v8, Ldd/e0;->V:Z

    if-nez v8, :cond_1

    invoke-virtual {v4}, Ldd/x;->e()I

    move-result v8

    invoke-static {v8}, Lyc/c;->d(I)Z
    ...
    iget-object v1, p0, Ldd/l;->l:Ldd/i;

    invoke-virtual {v1, v4, v0, v3}, Ldd/i;->a(Ldd/x;Landroid/media/Image;I)V
    ...
    :goto_1
    iget-object v2, p0, Ldd/l;->j:Ldd/l$a;

    iget-boolean p1, p1, Ldd/j;->c:Z

    invoke-interface {v2, v0, v3, p1}, Ldd/l$a;->f(Landroid/media/Image;IZ)V
    ...
    :cond_6
    iget-object p1, p0, Ldd/l;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_7
    iget-object p1, p0, Ldd/l;->c:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_8
    iget-object p1, p0, Ldd/l;->b:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public y(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;)Landroid/media/Image;
    ...
    invoke-static {p1, p2, p0}, Lyc/d;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;
...
.method public z()V
    ...
    iput-object v0, p0, Ldd/l;->l:Ldd/i;
