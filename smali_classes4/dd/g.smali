...
.method public constructor <init>(Ldd/l$a;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-direct {p0, p1, p2}, Ldd/c;-><init>(Ldd/l$a;Lcom/xiaomi/engine/BufferFormat;)V
...
.method public X(Ldd/i0;)V
    ...
    invoke-virtual {p1}, Ldd/i0;->f()Lik/b;
    ...
    :cond_1
    invoke-virtual {p0, p1}, Ldd/g;->g0(Ldd/i0;)V

    goto :goto_1

    :cond_2
    :goto_0
    invoke-virtual {p0, p1}, Ldd/g;->h0(Ldd/i0;)V
...
.method public b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/List;
    ...
    iput-object v1, p0, Ldd/c;->K:Landroid/media/ImageReader;

    new-instance v2, Ldd/g$a;

    invoke-direct {v2, p0}, Ldd/g$a;-><init>(Ldd/g;)V
    ...
    iget-object v2, p0, Ldd/c;->K:Landroid/media/ImageReader;
    ...
    iput-object v1, p0, Ldd/c;->L:Landroid/media/ImageReader;

    new-instance v2, Ldd/g$b;

    invoke-direct {v2, p0}, Ldd/g$b;-><init>(Ldd/g;)V
    ...
    iget-object v2, p0, Ldd/c;->L:Landroid/media/ImageReader;
    ...
    iput-object p1, p0, Ldd/c;->M:Landroid/media/ImageReader;

    new-instance v1, Ldd/g$c;

    invoke-direct {v1, p0}, Ldd/g$c;-><init>(Ldd/g;)V
    ...
    iget-object p0, p0, Ldd/c;->M:Landroid/media/ImageReader;
...
.method public final f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    :cond_2
    new-instance p1, Ldd/g$d;

    invoke-direct {p1, p0}, Ldd/g$d;-><init>(Ldd/g;)V
    ...
    iget-object p1, p0, Ldd/c;->O:Ljava/lang/Object;
    ...
    :try_start_1
    iget-object p2, p0, Ldd/c;->I:Lcom/xiaomi/engine/TaskSession;

    goto :goto_2

    :cond_3
    iget-object p2, p0, Ldd/c;->J:Ldd/k0;

    invoke-virtual {p2}, Ldd/k0;->b()Lcom/xiaomi/engine/TaskSession;
    ...
    :cond_4
    new-instance p1, Ldd/g$e;

    invoke-direct {p1, p0}, Ldd/g$e;-><init>(Ldd/g;)V
...
.method public final g0(Ldd/i0;)V
    .locals 9
    .param p1    # Ldd/i0;
    ...
    invoke-virtual {v1}, Ldd/e$a;->k()Landroid/media/Image;

    move-result-object v3

    invoke-virtual {p0, v2}, Ldd/l;->q(Landroid/media/Image;)Z

    move-result v4

    invoke-virtual {p0, v3}, Ldd/l;->q(Landroid/media/Image;)Z
    ...
    invoke-static {v8, v7}, Lyc/e;->b(Ljava/lang/String;I)V

    invoke-virtual {v1}, Ldd/e$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {p1}, Ldd/i0;->e()I

    move-result v4

    invoke-virtual {p0, v1, v2, v7, v4}, Ldd/g;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    invoke-virtual {p0, v1, v3, v2, v4}, Ldd/g;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
...
.method public final h0(Ldd/i0;)V
    .locals 7
    .param p1    # Ldd/i0;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {v4, v5}, Lyc/e;->b(Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, v1, v2, v5, v4}, Ldd/g;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
...
.method public p()Z
    ...
    iget-object v1, p0, Ldd/l;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, Ldd/l;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, Ldd/l;->c:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p0, p0, Ldd/l;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-interface {v0, p0}, Ldd/l$a;->a(Ldd/l;)Z
    ...
    iget-object p0, p0, Ldd/l;->b:Ljava/util/concurrent/atomic/AtomicInteger;
