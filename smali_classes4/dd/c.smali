...
# direct methods
.method public constructor <init>(Ldd/l$a;Lcom/xiaomi/engine/BufferFormat;)V
    .locals 2

    invoke-direct {p0, p1, p2}, Ldd/l;-><init>(Ldd/l$a;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    iput-object p1, p0, Ldd/c;->F:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, Ljava/lang/Object;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ldd/c;->O:Ljava/lang/Object;

    new-instance p1, Landroid/util/LongSparseArray;

    invoke-direct {p1}, Landroid/util/LongSparseArray;-><init>()V

    iput-object p1, p0, Ldd/c;->P:Landroid/util/LongSparseArray;
    ...
    iget-object v1, p0, Ldd/l;->m:Ljava/lang/String;
    ...
    iput-object p1, p0, Ldd/c;->G:Landroid/os/HandlerThread;
    ...
    iget-object p0, p0, Ldd/l;->m:Ljava/lang/String;
...
.method public static synthetic L(Ldd/c;Landroid/media/ImageReader;)V
    .locals 0

    invoke-direct {p0, p1}, Ldd/c;->S(Landroid/media/ImageReader;)V
...
.method private synthetic S(Landroid/media/ImageReader;)V
    ...
    invoke-virtual {p0, v2, p1}, Ldd/l;->y(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;)Landroid/media/Image;
    ...
    invoke-virtual {p0, p1}, Ldd/l;->d(Ldd/j;)V
...
.method public E(Lcom/xiaomi/engine/TaskSession;)V
    ...
    iget-object v0, p0, Ldd/c;->O:Ljava/lang/Object;
    ...
    iput-object p1, p0, Ldd/c;->I:Lcom/xiaomi/engine/TaskSession;

    monitor-exit v0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1

    invoke-virtual {p0}, Ldd/l;->n()Z

    move-result p1

    if-eqz p1, :cond_0

    iget-object p1, p0, Ldd/l;->o:Ljava/lang/Object;

    monitor-enter p1

    :try_start_1
    iget-object v0, p0, Ldd/l;->p:Ljava/util/LinkedList;
...
.method public F(Ldd/k0;)V
    ...
    iput-object p1, p0, Ldd/c;->J:Ldd/k0;
...
.method public G()V
    ...
    invoke-super {p0}, Ldd/l;->G()V

    iget-object v1, p0, Ldd/c;->G:Landroid/os/HandlerThread;

    invoke-virtual {v1}, Ljava/lang/Thread;->start()V

    new-instance v1, Landroid/os/Handler;

    iget-object v3, p0, Ldd/c;->G:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, Ldd/c;->H:Landroid/os/Handler;
    ...
    iget-object p0, p0, Ldd/l;->h:Landroid/os/HandlerThread;
...
.method public H()V
    ...
    invoke-super {p0}, Ldd/l;->H()V

    iget-object v0, p0, Ldd/c;->G:Landroid/os/HandlerThread;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->quitSafely()Z

    iget-object v0, p0, Ldd/c;->H:Landroid/os/Handler;
    ...
    iput-object v2, p0, Ldd/c;->H:Landroid/os/Handler;

    :cond_0
    iget-object v0, p0, Ldd/l;->l:Ldd/i;

    if-eqz v0, :cond_1

    iput-object v2, p0, Ldd/l;->l:Ldd/i;

    :cond_1
    invoke-virtual {p0}, Ldd/c;->N()V

    invoke-virtual {p0}, Ldd/c;->O()V

    invoke-virtual {p0}, Ldd/c;->z()V
...
.method public J()Z
    ...
    :try_start_0
    iget-object v2, p0, Ldd/c;->I:Lcom/xiaomi/engine/TaskSession;
    ...
    invoke-virtual {p0, v3}, Ldd/l;->D(I)V
...
.method public final M(Ldd/j0;Ljava/lang/String;)V
    .locals 6
    .param p1    # Ldd/j0;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {p0, p1}, Ldd/c;->c0(Ldd/j0;)V

    iget-object v0, p0, Ldd/c;->F:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndDecrement()I

    iget-object v0, p0, Ldd/l;->j:Ldd/l$a;

    if-eqz v0, :cond_0

    iget-wide v4, p1, Ldd/j0;->a:J

    invoke-interface {v0, v4, v5}, Ldd/l$a;->d(J)Ldd/x;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-object p0, p0, Ldd/l;->j:Ldd/l$a;

    iget-wide v4, p1, Ldd/j0;->a:J

    invoke-interface {p0, v4, v5, p2}, Ldd/l$a;->g(JLjava/lang/String;)V
...
.method public final N()V
    ...
    :try_start_0
    iget-object v1, p0, Ldd/c;->I:Lcom/xiaomi/engine/TaskSession;

    const/4 v2, 0x0

    iput-object v2, p0, Ldd/c;->I:Lcom/xiaomi/engine/TaskSession;
...
.method public final O()V
    ...
    :try_start_0
    iget-object v1, p0, Ldd/c;->J:Ldd/k0;

    const/4 v2, 0x0

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Ldd/k0;->b()Lcom/xiaomi/engine/TaskSession;
    ...
    :goto_0
    iput-object v2, p0, Ldd/c;->J:Ldd/k0;
...
.method public final P(ZJ)V
    ...
    :try_start_0
    iget-object p0, p0, Ldd/c;->J:Ldd/k0;

    if-eqz p0, :cond_0

    invoke-virtual {p0}, Ldd/k0;->b()Lcom/xiaomi/engine/TaskSession;
    ...
    :cond_1
    iget-object p0, p0, Ldd/c;->I:Lcom/xiaomi/engine/TaskSession;
...
.method public Q()Landroid/os/Handler;
    ...
    iget-object p0, p0, Ldd/c;->H:Landroid/os/Handler;
...
.method public final T(Ldd/i0;)V
    .locals 6
    .annotation build Lcom/android/camera/jacoco/JacocoForceIgnore;
    .end annotation
    ...
    invoke-virtual {p1}, Ldd/i0;->c()Ljava/util/List;
    ...
    :cond_0
    invoke-virtual {p0, p1}, Ldd/c;->W(Ldd/i0;)V
    ...
    invoke-virtual {p0, v4}, Ldd/c;->Z(Ldd/e$a;)V
    ...
    :cond_1
    invoke-virtual {v1}, Ldd/e$a;->e()Landroid/media/Image;
    ...
    invoke-virtual {p0, v5, p1}, Ldd/l;->y(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;)Landroid/media/Image;

    move-result-object p1

    invoke-virtual {p0, v1}, Ldd/c;->Z(Ldd/e$a;)V

    new-instance v1, Ldd/j;

    invoke-direct {v1, p1, v0, v2}, Ldd/j;-><init>(Landroid/media/Image;IZ)V

    invoke-virtual {p0, v1}, Ldd/l;->d(Ldd/j;)V

    invoke-virtual {p0, v3, v4}, Ldd/c;->V(J)V
...
.method public final U(Ldd/i0;)V
    .locals 11
    ...
    iget-object v0, p0, Ldd/l;->o:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    invoke-virtual {p1}, Ldd/i0;->d()J

    move-result-wide v3

    invoke-virtual {p1}, Ldd/i0;->a()Z
    ...
    invoke-direct {v1, v3, v4, v7, v8}, Ldd/j0;-><init>(JJ)V

    invoke-virtual {v1, p1}, Ldd/j0;->a(Ldd/i0;)V

    iget-object v5, p0, Ldd/c;->P:Landroid/util/LongSparseArray;
    ...
    :cond_1
    iget-object v1, p0, Ldd/c;->P:Landroid/util/LongSparseArray;
    ...
    iget-object v1, v1, Ldd/j0;->c:Ljava/util/List;
...
.method public V(J)V
    ...
    iget-object p1, p0, Ldd/l;->p:Ljava/util/LinkedList;
...
.method public W(Ldd/i0;)V
    ...
    iget-object p0, p0, Ldd/c;->F:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public abstract X(Ldd/i0;)V
.end method

.method public final Y(Ldd/i0;)V
    .locals 1

    sget-boolean v0, Ldd/e0;->U:Z

    if-eqz v0, :cond_0

    invoke-virtual {p0, p1}, Ldd/c;->T(Ldd/i0;)V

    return-void

    :cond_0
    invoke-virtual {p0, p1}, Ldd/c;->U(Ldd/i0;)V

    invoke-virtual {p0, p1}, Ldd/c;->X(Ldd/i0;)V

    return-void
.end method

.method public final Z(Ldd/e$a;)V
    .locals 3
    ...
    iget-object v1, p0, Ldd/l;->j:Ldd/l$a;

    invoke-virtual {p0, v0, v1}, Ldd/c;->b0(Landroid/media/Image;Ldd/l$a;)V
    ...
    invoke-virtual {p0, p1, v0}, Ldd/c;->b0(Landroid/media/Image;Ldd/l$a;)V
...
.method public a(J)V
    ...
    iget-object v1, p0, Ldd/l;->o:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, Ldd/c;->P:Landroid/util/LongSparseArray;
    ...
    iget-object v6, p0, Ldd/c;->P:Landroid/util/LongSparseArray;

    invoke-virtual {v6, v2}, Landroid/util/LongSparseArray;->valueAt(I)Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Ldd/j0;

    iget-wide v7, v6, Ldd/j0;->b:J

    sub-long v7, p1, v7

    invoke-virtual {p0}, Ldd/c;->R()J
    ...
    check-cast p2, Ldd/j0;

    const-string v0, "engine timeout"

    invoke-virtual {p0, p2, v0}, Ldd/c;->M(Ldd/j0;Ljava/lang/String;)V
...
.method public final a0()V
    ...
    iget-object v0, p0, Ldd/c;->N:Landroid/media/ImageReader;
    ...
    iput-object v0, p0, Ldd/c;->N:Landroid/media/ImageReader;

    :cond_0
    return-void
.end method

.method public b0(Landroid/media/Image;Ldd/l$a;)V
    .locals 0
    ...
    invoke-interface {p2, p1}, Ldd/l$a;->b(Landroid/media/Image;)V
...
.method public c(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/List;
    ...
    iput-object p1, p0, Ldd/c;->N:Landroid/media/ImageReader;
    ...
    iget-object p1, p0, Ldd/c;->N:Landroid/media/ImageReader;

    new-instance v1, Ldd/b;

    invoke-direct {v1, p0}, Ldd/b;-><init>(Ldd/c;)V

    invoke-virtual {p0}, Ldd/c;->Q()Landroid/os/Handler;
    ...
    iget-object p0, p0, Ldd/c;->N:Landroid/media/ImageReader;
...
.method public final c0(Ldd/j0;)V
    .locals 2

    if-eqz p1, :cond_1

    iget-object p1, p1, Ldd/j0;->c:Ljava/util/List;
    ...
    invoke-virtual {v0}, Ldd/i0;->c()Ljava/util/List;
...
.method public final d0()V
    ...
    iget-object v0, p0, Ldd/l;->g:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Ldd/l;->i:Landroid/os/Handler;
...
.method public e(Ldd/i0;)I
    ...
    :try_start_0
    iget-object v1, p0, Ldd/l;->p:Ljava/util/LinkedList;
    ...
    invoke-virtual {p0, v2}, Ldd/l;->C(Z)V

    iget-object v3, p0, Ldd/c;->O:Ljava/lang/Object;

    monitor-enter v3

    :try_start_1
    iget-object v0, p0, Ldd/c;->I:Lcom/xiaomi/engine/TaskSession;
...
.method public final e0()V
    ...
    iget-object p0, p0, Ldd/l;->i:Landroid/os/Handler;
...
.method public g(J)V
    ...
    invoke-virtual {p0, v1, p1, p2}, Ldd/c;->P(ZJ)V

    const/4 v0, 0x1

    invoke-virtual {p0, v0, p1, p2}, Ldd/c;->P(ZJ)V
...
.method public k()Lcom/xiaomi/engine/TaskSession;
    ...
    iget-object v3, p0, Ldd/c;->I:Lcom/xiaomi/engine/TaskSession;
...
.method public l()Ldd/k0;
    ...
    iget-object v3, p0, Ldd/c;->J:Ldd/k0;
...
.method public u()Ljava/util/List;
    ...
    :try_start_0
    iput-object v1, p0, Ldd/c;->I:Lcom/xiaomi/engine/TaskSession;

    iput-object v1, p0, Ldd/c;->J:Ldd/k0;
    ...
    :try_start_1
    iget-object v3, p0, Ldd/c;->P:Landroid/util/LongSparseArray;
    ...
    iget-object v4, p0, Ldd/c;->P:Landroid/util/LongSparseArray;
    ...
    invoke-virtual {p0, v4}, Ldd/c;->c0(Ldd/j0;)V

    iget-object v5, p0, Ldd/c;->F:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_0
    iget-object v3, p0, Ldd/l;->p:Ljava/util/LinkedList;
    ...
    check-cast v4, Ldd/i0;

    invoke-virtual {v4}, Ldd/i0;->a()Z

    move-result v5

    if-eqz v5, :cond_1

    invoke-virtual {v4}, Ldd/i0;->d()J
    ...
    :cond_1
    invoke-virtual {v4}, Ldd/i0;->c()Ljava/util/List;
    ...
    invoke-virtual {p0, v6}, Ldd/c;->Z(Ldd/e$a;)V
...
.method public v(J)Z
    ...
    iget-object p2, p0, Ldd/c;->P:Landroid/util/LongSparseArray;
    ...
    invoke-virtual {p0, p2, p1}, Ldd/c;->M(Ldd/j0;Ljava/lang/String;)V
...
.method public w(J)V
    ...
    :cond_0
    iget-object p1, p0, Ldd/l;->i:Landroid/os/Handler;
...
.method public x()V
    ...
    invoke-virtual {p0, v0}, Ldd/c;->Y(Ldd/i0;)V
...
.method public z()V
    ...
    invoke-super {p0}, Ldd/l;->z()V

    const/4 v0, 0x0

    iput-object v0, p0, Ldd/l;->j:Ldd/l$a;

    iget-object v1, p0, Ldd/c;->K:Landroid/media/ImageReader;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Landroid/media/ImageReader;->close()V

    iput-object v0, p0, Ldd/c;->K:Landroid/media/ImageReader;

    :cond_0
    iget-object v1, p0, Ldd/c;->L:Landroid/media/ImageReader;

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Landroid/media/ImageReader;->close()V

    iput-object v0, p0, Ldd/c;->L:Landroid/media/ImageReader;

    :cond_1
    iget-object v1, p0, Ldd/c;->M:Landroid/media/ImageReader;

    if-eqz v1, :cond_2

    invoke-virtual {v1}, Landroid/media/ImageReader;->close()V

    iput-object v0, p0, Ldd/c;->M:Landroid/media/ImageReader;

    :cond_2
    invoke-virtual {p0}, Ldd/c;->a0()V
