...
.method public constructor <init>(Ldd/e0;)V
    ...
    iput-object p1, p0, Ldd/e0$e;->a:Ldd/e0;
...
.method public a(Ldd/l;)Z
    ...
    invoke-virtual {p0, p1}, Ldd/s;->z(Ldd/l;)Z
...
.method public b(Landroid/media/Image;)V
    ...
    iget-object p0, p0, Ldd/e0$e;->a:Ldd/e0;

    invoke-static {p0}, Ldd/e0;->i(Ldd/e0;)Ldd/f;

    move-result-object p0

    invoke-interface {p0, p1}, Ldd/f;->b(Landroid/media/Image;)V
...
.method public c(JI)V
    ...
    iget-object v0, p0, Ldd/e0$e;->a:Ldd/e0;

    invoke-static {v0}, Ldd/e0;->p(Ldd/e0;)Ldd/e0$j;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {p0, p1, p2}, Ldd/e0$e;->d(J)Ldd/x;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Ldd/x;->j0()Z
    ...
    invoke-virtual {v1, p1}, Lb7/n;->Y(Ljava/lang/String;)V

    iget-object p0, p0, Ldd/e0$e;->a:Ldd/e0;

    invoke-static {p0}, Ldd/e0;->p(Ldd/e0;)Ldd/e0$j;

    move-result-object p0

    invoke-interface {p0, v0, p3}, Ldd/e0$j;->a(Ldd/x;I)V
...
.method public d(J)Ldd/x;
    .locals 0

    iget-object p0, p0, Ldd/e0$e;->a:Ldd/e0;

    invoke-static {p0, p1, p2}, Ldd/e0;->N(Ldd/e0;J)Ldd/x;
...
.method public e(ILjava/lang/Object;)V
    ...
    invoke-virtual {p0, p2}, Ldd/e0$e;->i(Lcom/xiaomi/engine/ResultData;)V
    ...
    invoke-virtual {p0, p2}, Ldd/e0$e;->j(Lcom/xiaomi/engine/ResultData;)V
...
.method public f(Landroid/media/Image;IZ)V
    ...
    invoke-static {v8, v13}, Lyc/e;->d(II)V

    invoke-static/range {p1 .. p1}, Lyc/d;->g(Landroid/media/Image;)[B

    move-result-object v0

    if-eqz v0, :cond_12

    iget-object v1, v1, Ldd/e0$e;->a:Ldd/e0;

    invoke-static {v1}, Ldd/e0;->m(Ldd/e0;)Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
    ...
    :cond_0
    invoke-virtual {v1, v9, v10}, Ldd/e0$e;->d(J)Ldd/x;
    ...
    invoke-virtual {v15}, Ldd/x;->l()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {v15}, Ldd/x;->s()Ldd/y;

    move-result-object v3

    invoke-virtual {v3}, Ldd/y;->s0()I
    ...
    invoke-static {v5}, Lyc/c;->d(I)Z

    move-result v4

    if-nez v4, :cond_8

    invoke-virtual {v3}, Ldd/y;->Z0()Z
    ...
    iget-object v2, v1, Ldd/e0$e;->a:Ldd/e0;
    ...
    invoke-static/range {v2 .. v7}, Ldd/e0;->n(Ldd/e0;Ldd/x;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
    ...
    invoke-static {v3, v0, v7}, Lyc/d;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;

    move-result-object v3

    iget-object v4, v1, Ldd/e0$e;->a:Ldd/e0;

    invoke-static {v4}, Ldd/e0;->i(Ldd/e0;)Ldd/f;

    move-result-object v4

    invoke-interface {v4, v0}, Ldd/f;->b(Landroid/media/Image;)V
    ...
    iget-object v3, v1, Ldd/e0$e;->a:Ldd/e0;

    invoke-static {v3}, Ldd/e0;->q(Ldd/e0;)La8/h;

    move-result-object v3

    iget-object v4, v1, Ldd/e0$e;->a:Ldd/e0;

    invoke-static {v4}, Ldd/e0;->o(Ldd/e0;)La8/d$a;

    move-result-object v4

    invoke-virtual {v3, v0, v2, v15, v4}, La8/h;->s(Landroid/media/Image;Landroid/hardware/camera2/CaptureResult;Ldd/x;La8/d$a;)V

    invoke-static {v5}, Lyc/c;->c(I)Z

    move-result v0

    if-eqz v0, :cond_7

    iget-object v0, v1, Ldd/e0$e;->a:Ldd/e0;

    invoke-static {v0}, Ldd/e0;->r(Ldd/e0;)Ljava/util/Map;
    ...
    invoke-static {v3}, Ldd/e0;->s(Ldd/e0;)Ljava/util/Map;
    ...
    invoke-static {v3, v5}, Ldd/e0;->t(Ldd/e0;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {v3}, Ldd/e0;->u(Ldd/e0;)Ljava/util/Map;
    ...
    invoke-static {v3, v5}, Ldd/e0;->v(Ldd/e0;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-virtual {v15}, Ldd/x;->K()I

    move-result v5

    invoke-virtual {v15}, Ldd/x;->J()I

    move-result v6

    invoke-virtual {v15}, Ldd/x;->d()Landroid/graphics/Rect;

    move-result-object v7

    invoke-virtual {v15}, Ldd/x;->Q()F

    move-result v8

    invoke-static {v3, v5, v6, v7, v8}, Lcom/android/camera/c6;->O(Landroid/graphics/Rect;IILandroid/graphics/Rect;F)Z
    ...
    invoke-static {v0}, Ldd/e0;->u(Ldd/e0;)Ljava/util/Map;
    ...
    invoke-static {v0}, Ldd/e0;->s(Ldd/e0;)Ljava/util/Map;
    ...
    invoke-static {v2}, Ldd/e0;->m(Ldd/e0;)Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
    ...
    invoke-static {v2}, Ldd/e0;->u(Ldd/e0;)Ljava/util/Map;
    ...
    invoke-static {v1}, Ldd/e0;->s(Ldd/e0;)Ljava/util/Map;
    ...
    invoke-virtual/range {v1 .. v7}, Ldd/e0$e;->h(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;ZLdd/x;J)V
    ...
    invoke-static {v2, v0, v3}, Lyc/d;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;

    move-result-object v2

    iget-object v3, v1, Ldd/e0$e;->a:Ldd/e0;

    invoke-static {v3}, Ldd/e0;->i(Ldd/e0;)Ldd/f;

    move-result-object v3

    invoke-interface {v3, v0}, Ldd/f;->b(Landroid/media/Image;)V

    iget-object v0, v1, Ldd/e0$e;->a:Ldd/e0;

    invoke-static {v0, v9, v10, v2}, Ldd/e0;->w(Ldd/e0;JLandroid/media/Image;)V
    ...
    invoke-static {v1, v9, v10, v0}, Ldd/e0;->w(Ldd/e0;JLandroid/media/Image;)V
...
.method public final h(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;ZLdd/x;J)V
    .locals 6
    ...
    invoke-static {p2}, Lyc/d;->f(Landroid/media/Image;)[B
    ...
    invoke-virtual {p4, v3, v0}, Ldd/x;->a([BI)V

    const-string p2, "JPEG"

    invoke-virtual {p4, p2}, Ldd/x;->b0(Ljava/lang/String;)Z
    ...
    invoke-virtual {p4, p2}, Ldd/x;->X0(Z)V
    ...
    iget-object p2, p0, Ldd/e0$e;->a:Ldd/e0;

    invoke-static {p2}, Ldd/e0;->q(Ldd/e0;)La8/h;

    move-result-object p2

    const/4 p3, 0x0

    invoke-virtual {p2, p4, p1, p3, p3}, La8/h;->k(Ldd/x;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z

    move-result p1

    iget-object p2, p0, Ldd/e0$e;->a:Ldd/e0;

    invoke-virtual {p4}, Ldd/x;->P()Landroid/media/Image;
    ...
    invoke-virtual {p4}, Ldd/x;->v0()V

    :cond_3
    iget-object p1, p0, Ldd/e0$e;->a:Ldd/e0;

    invoke-static {p1, p4}, Ldd/e0;->y(Ldd/e0;Ldd/x;)Z
    ...
    invoke-interface {p1, p4}, Ldd/e0$j;->b(Ldd/x;)V
    ...
    invoke-static {p1, p5, p6}, Ldd/e0;->l(Ldd/e0;J)Ldd/x;
...
.method public final i(Lcom/xiaomi/engine/ResultData;)V
    ...
    invoke-virtual {p0, v0, v1}, Ldd/e0$e;->d(J)Ldd/x;
    ...
    invoke-static {p1}, Ldd/m;->a(Lcom/xiaomi/engine/ResultData;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p1}, Ldd/a0;->F(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Ldd/y;->c1(B)V

    invoke-virtual {v0, p1}, Ldd/a0;->d0(B)V
...
.method public final j(Lcom/xiaomi/engine/ResultData;)V
    ...
    invoke-virtual {v1, v2, v3}, Ldd/e0$e;->d(J)Ldd/x;
    ...
    :goto_1
    iget-object v11, v1, Ldd/e0$e;->a:Ldd/e0;

    invoke-static {v11}, Ldd/e0;->u(Ldd/e0;)Ljava/util/Map;
    ...
    invoke-static {v11, v12}, Ldd/e0;->v(Ldd/e0;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {v0, v7}, Ldd/e0;->t(Ldd/e0;Ljava/util/Map;)Ljava/util/Map;
    ...
    iget-object v7, v1, Ldd/e0$e;->a:Ldd/e0;

    invoke-static {v7}, Ldd/e0;->u(Ldd/e0;)Ljava/util/Map;
    ...
    invoke-virtual {v4}, Ldd/x;->K()I

    move-result v8

    invoke-virtual {v4}, Ldd/x;->J()I

    move-result v11

    invoke-virtual {v4}, Ldd/x;->d()Landroid/graphics/Rect;

    move-result-object v12

    invoke-virtual {v4}, Ldd/x;->Q()F

    move-result v4

    invoke-static {v7, v8, v11, v12, v4}, Lcom/android/camera/c6;->O(Landroid/graphics/Rect;IILandroid/graphics/Rect;F)Z
    ...
    invoke-static {v4}, Ldd/e0;->m(Ldd/e0;)Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
    ...
    invoke-static {v4}, Ldd/e0;->s(Ldd/e0;)Ljava/util/Map;
    ...
    invoke-static {v1}, Ldd/e0;->u(Ldd/e0;)Ljava/util/Map;
