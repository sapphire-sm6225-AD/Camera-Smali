...
.method public X(Ldd/i0;)V
    ...
    invoke-virtual {p0, v5}, Ldd/l;->q(Landroid/media/Image;)Z
    ...
    invoke-static {v6, v1}, Lyc/e;->b(Ljava/lang/String;I)V

    invoke-virtual {v4}, Ldd/e$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {p0, v6, v5, v1, v7}, Ldd/h0;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    invoke-virtual {p0, v6, v5, v7, v8}, Ldd/h0;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V

    :goto_3
    invoke-virtual {v4}, Ldd/e$a;->k()Landroid/media/Image;

    move-result-object v4

    iget-object v5, p0, Ldd/l;->j:Ldd/l$a;

    invoke-virtual {p0, v4, v5}, Ldd/c;->b0(Landroid/media/Image;Ldd/l$a;)V
...
.method public b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/List;
    ...
    new-instance v2, Ldd/h0$a;

    invoke-direct {v2, p0}, Ldd/h0$a;-><init>(Ldd/h0;)V
    ...
    new-instance v2, Ldd/h0$b;

    invoke-direct {v2, p0}, Ldd/h0$b;-><init>(Ldd/h0;)V
    ...
    new-instance v1, Ldd/h0$c;

    invoke-direct {v1, p0}, Ldd/h0$c;-><init>(Ldd/h0;)V
...
.method public final f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    :cond_0
    new-instance p1, Ldd/h0$d;

    invoke-direct {p1, p0}, Ldd/h0$d;-><init>(Ldd/h0;)V
    ...
    :cond_2
    new-instance p1, Ldd/h0$e;

    invoke-direct {p1, p0}, Ldd/h0$e;-><init>(Ldd/h0;)V
