...
.method public e(Ld5/i;)Ljava/util/List;
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0}, Lzf/p;->getModuleId()I

    move-result p0

    const/4 v0, 0x1

    invoke-static {p0, v0}, Lcom/android/camera2/compat/theme/custom/mm/top/TopBarUtils;->getCloseItemBuilder(IZ)Lh5/u2$b;
...
.method public f()Ld5/f;
    ...
    new-instance v0, Lzf/p$a;

    invoke-direct {v0, p0}, Lzf/p$a;-><init>(Lzf/p;)V
