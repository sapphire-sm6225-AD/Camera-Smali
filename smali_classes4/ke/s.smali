...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lke/s;->a:Landroid/media/MediaRecorder;

    return-void
.end method

.method public static synthetic u(Lke/s;Lke/i$b;Landroid/media/MediaRecorder;II)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lke/s;->x(Lke/i$b;Landroid/media/MediaRecorder;II)V

    return-void
.end method

.method public static synthetic v(Lke/s;Lke/i$a;Landroid/media/MediaRecorder;II)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lke/s;->w(Lke/i$a;Landroid/media/MediaRecorder;II)V

    return-void
.end method

.method private synthetic w(Lke/i$a;Landroid/media/MediaRecorder;II)V
    .locals 0

    if-eqz p1, :cond_0

    invoke-interface {p1, p0, p3, p4}, Lke/i$a;->a(Lke/i;II)V

    :cond_0
    return-void
.end method

.method private synthetic x(Lke/i$b;Landroid/media/MediaRecorder;II)V
    .locals 0

    if-eqz p1, :cond_0

    invoke-interface {p1, p0, p3, p4}, Lke/i$b;->b(Lke/i;II)V
...
.method public static z(Landroid/media/MediaRecorder;Lke/j;)Landroid/media/MediaRecorder;
    .locals 4
    ...
    invoke-virtual {p1}, Lke/j;->N()Landroid/util/Size;
    ...
    :cond_3
    invoke-virtual {p1}, Lke/j;->L()Landroid/util/Pair;
    ...
    :cond_5
    invoke-virtual {p1}, Lke/j;->R()Z

    move-result v0

    if-eqz v0, :cond_9

    invoke-virtual {p1}, Lke/j;->x()I
    ...
    :cond_d
    invoke-virtual {p1}, Lke/j;->E()Landroid/util/Pair;
    ...
    :cond_e
    invoke-virtual {p1}, Lke/j;->D()Ljava/util/List;
    ...
    invoke-static {p0, v1}, Lke/s;->y(Landroid/media/MediaRecorder;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1}, Lke/s;->y(Landroid/media/MediaRecorder;Ljava/lang/String;)V
...
.method public a()Landroid/media/MediaRecorder;
    ...
    iget-object p0, p0, Lke/s;->a:Landroid/media/MediaRecorder;
...
.method public c(Lke/j;)V
    ...
    invoke-static {p0, p1}, Lke/s;->z(Landroid/media/MediaRecorder;Lke/j;)Landroid/media/MediaRecorder;
...
.method public j(Lke/i$b;)V
    ...
    iget-object v0, p0, Lke/s;->a:Landroid/media/MediaRecorder;

    new-instance v1, Lke/r;

    invoke-direct {v1, p0, p1}, Lke/r;-><init>(Lke/s;Lke/i$b;)V
...
.method public n(Lke/i$a;)V
    ...
    invoke-direct {v1, p0, p1}, Lke/q;-><init>(Lke/s;Lke/i$a;)V
