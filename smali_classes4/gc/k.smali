...
.method public constructor <init>(Lgc/e;Landroid/os/Looper;)V
    ...
    iput-object p2, p0, Lgc/k;->f:Ljava/util/LinkedList;

    iput-object p1, p0, Lgc/k;->a:Lgc/e;
    ...
    iput-object v0, p0, Lgc/k;->e:Ljava/lang/String;
    ...
    invoke-direct {v0, p1}, Lcom/xiaomi/ai/android/codec/AudioEncoder;-><init>(Lgc/a;)V

    iput-object v0, p0, Lgc/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;
    ...
    iget-object p1, p0, Lgc/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;

    invoke-virtual {p1}, Lcom/xiaomi/ai/android/codec/AudioEncoder;->d()V

    const/4 p1, 0x0

    iput-object p1, p0, Lgc/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;
    ...
    iput-object p1, p0, Lgc/k;->c:Lmc/a;
...
.method public a()V
    ...
    :try_start_0
    iget-object v0, p0, Lgc/k;->f:Ljava/util/LinkedList;
    ...
    iget-object v2, p0, Lgc/k;->f:Ljava/util/LinkedList;
...
.method public b(Landroid/os/Message;)V
    ...
    iget-object v0, p0, Lgc/k;->a:Lgc/e;

    invoke-virtual {v0}, Lgc/e;->R()Lgc/h;
    ...
    invoke-virtual {v0, v1}, Lgc/h;->d(Loc/f;)V
...
.method public final c([BZ)V
    ...
    :cond_2
    iget-object v1, p0, Lgc/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;

    invoke-virtual {v1, p1, p2}, Lcom/xiaomi/ai/android/codec/AudioEncoder;->a([BZ)I

    move-result p1

    iget-object p2, p0, Lgc/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;

    invoke-virtual {p2}, Lcom/xiaomi/ai/android/codec/AudioEncoder;->c()[B

    move-result-object p2

    iget-object v1, p0, Lgc/k;->a:Lgc/e;

    invoke-virtual {v1}, Lgc/e;->O()Lcom/xiaomi/ai/core/b;
    ...
    iget-object p0, p0, Lgc/k;->a:Lgc/e;
    ...
    invoke-virtual {v0, p0}, Lgc/j;->g(Ljava/lang/String;)V
...
.method public final f()V
    ...
    iget-object v1, p0, Lgc/k;->f:Ljava/util/LinkedList;
    ...
    :cond_0
    iget-object p0, p0, Lgc/k;->f:Ljava/util/LinkedList;
...
.method public final g()V
    ...
    invoke-virtual {v0}, Loc/m;->a()Ljava/lang/String;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :cond_1
    iget-object p1, p0, Lgc/k;->a:Lgc/e;
    ...
    invoke-virtual {p1, v0}, Lgc/e;->G(Lrc/a;)V
    ...
    invoke-virtual {p0}, Lgc/e;->P()Lgc/b;

    move-result-object p0

    const/4 p1, 0x0

    invoke-virtual {p0, p1}, Lgc/b;->z(Z)V
    ...
    iget-object v5, p0, Lgc/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;
    ...
    invoke-virtual {p0, v2, p1}, Lgc/k;->c([BZ)V
    ...
    iget-object v4, p0, Lgc/k;->a:Lgc/e;

    invoke-virtual {v4}, Lgc/e;->M()Lgc/f;

    move-result-object v4

    invoke-virtual {v4}, Lgc/f;->g()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {p1, v4}, Lgc/j;->g(Ljava/lang/String;)V
    ...
    :goto_1
    iget-object p1, p0, Lgc/k;->c:Lmc/a;

    if-eqz p1, :cond_c

    if-eqz v2, :cond_c

    invoke-interface {p1, v2}, Lmc/a;->a([B)Z
    ...
    invoke-static {p1}, Loc/a;->e(Loc/l;)Loc/i;
    ...
    invoke-virtual {v1}, Lgc/f;->g()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Loc/k;->l(Ljava/lang/String;)Loc/k;
    ...
    invoke-virtual {v0, p1}, Lgc/j;->A(Loc/i;)V

    iget-object v0, p0, Lgc/k;->a:Lgc/e;

    invoke-virtual {v0}, Lgc/e;->L()Lgc/d;
    ...
    iget-object p0, p0, Lgc/k;->c:Lmc/a;

    invoke-interface {p0}, Lmc/a;->release()V
    ...
    iget-object v2, p0, Lgc/k;->c:Lmc/a;

    invoke-interface {v2}, Lmc/a;->release()V

    iget-object v2, p0, Lgc/k;->c:Lmc/a;

    invoke-interface {v2}, Lmc/a;->init()Z

    :cond_8
    iget-object v2, p0, Lgc/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;
    ...
    invoke-virtual {p0, v1, v3}, Lgc/k;->c([BZ)V
    ...
    invoke-virtual {v1, p1}, Lgc/j;->t(Loc/f;)V
    ...
    invoke-virtual {p0, v1}, Lfc/c;->d(Ljava/lang/String;)V

    :cond_b
    invoke-virtual {v0, p1}, Lcom/xiaomi/ai/core/b;->w(Loc/f;)Z
