...
.method public constructor <init>(Lgc/e;)V
    ...
    iput-object p1, p0, Lgc/h;->b:Lgc/e;
    ...
    iput-object p1, p0, Lgc/h;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    invoke-virtual {p1, v0}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;->setRemoveOnCancelPolicy(Z)V

    iget-object p1, p0, Lgc/h;->b:Lgc/e;
    ...
    iput-object p1, p0, Lgc/h;->e:Ljava/util/Map;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Lgc/h;->f:Ljava/util/Map;

    return-void
.end method

.method public static synthetic a(Lgc/h;)Ljava/util/Map;
    .locals 0

    iget-object p0, p0, Lgc/h;->e:Ljava/util/Map;

    return-object p0
.end method

.method public static synthetic f(Lgc/h;)Lgc/e;
    .locals 0

    iget-object p0, p0, Lgc/h;->b:Lgc/e;
...
.method public b()V
    ...
    invoke-virtual {p0}, Lgc/h;->l()V

    iget-object v0, p0, Lgc/h;->h:Ljava/lang/String;
    ...
    :cond_0
    iget-object v2, p0, Lgc/h;->e:Ljava/util/Map;
    ...
    iget-object p0, p0, Lgc/h;->h:Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {p0, v0}, Lgc/h;->c(Lgc/h$c;)V

    sget-object v1, Lgc/h$b;->g:Lgc/h$b;

    iput-object v1, v0, Lgc/h$c;->g:Lgc/h$b;

    iget v1, v0, Lgc/h$c;->i:I

    add-int/lit8 v1, v1, 0x1

    iput v1, v0, Lgc/h$c;->i:I

    invoke-virtual {p0, v0}, Lgc/h;->h(Lgc/h$c;)V

    return-void
.end method

.method public final c(Lgc/h$c;)V
    .locals 2

    iget-object v0, p0, Lgc/h;->f:Ljava/util/Map;

    iget-object v1, p1, Lgc/h$c;->a:Ljava/lang/String;
    ...
    iget-object v1, p1, Lgc/h$c;->g:Lgc/h$b;
    ...
    iget-object p0, p0, Lgc/h;->f:Ljava/util/Map;

    iget-object p1, p1, Lgc/h$c;->a:Ljava/lang/String;
...
.method public d(Loc/f;)V
    .locals 5

    invoke-virtual {p0}, Lgc/h;->l()V

    iget-object v0, p0, Lgc/h;->e:Ljava/util/Map;
    ...
    sget-object p1, Lgc/h$b;->d:Lgc/h$b;

    iput-object p1, v0, Lgc/h$c;->g:Lgc/h$b;
    ...
    invoke-direct {v0, p0, p1, v1}, Lgc/h$c;-><init>(Lgc/h;Loc/f;Lgc/h$a;)V

    :goto_1
    iget-object v1, p0, Lgc/h;->e:Ljava/util/Map;
    ...
    iput-boolean v3, v0, Lgc/h$c;->d:Z
...
.method public e(Loc/i;)V
    ...
    :pswitch_0
    invoke-virtual {p0, v2}, Lgc/h;->c(Lgc/h$c;)V
    ...
    sget-object p1, Lgc/h$b;->c:Lgc/h$b;

    iput-object p1, v2, Lgc/h$c;->g:Lgc/h$b;

    iget p1, v2, Lgc/h$c;->h:I

    add-int/2addr p1, v4

    iput p1, v2, Lgc/h$c;->h:I

    goto :goto_2

    :cond_8
    sget-object p1, Lgc/h$b;->e:Lgc/h$b;

    iput-object p1, v2, Lgc/h$c;->g:Lgc/h$b;

    iget-boolean p1, v2, Lgc/h$c;->f:Z
    ...
    sget-object p0, Lgc/h$b;->h:Lgc/h$b;

    iput-object p0, v2, Lgc/h$c;->g:Lgc/h$b;
    ...
    iget-object p1, v2, Lgc/h$c;->g:Lgc/h$b;
    ...
    :pswitch_2
    sget-object p1, Lgc/h$b;->i:Lgc/h$b;
    ...
    iget-object p1, v2, Lgc/h$c;->a:Ljava/lang/String;
    ...
    :goto_2
    :pswitch_3
    invoke-virtual {p0, v2}, Lgc/h;->h(Lgc/h$c;)V
    ...
    sget-object p1, Lgc/h$b;->f:Lgc/h$b;

    iput-object p1, v2, Lgc/h$c;->g:Lgc/h$b;

    iget-object p1, v2, Lgc/h$c;->a:Ljava/lang/String;

    iput-object p1, p0, Lgc/h;->h:Ljava/lang/String;
...
.method public g()V
    ...
    check-cast v1, Lgc/h$c;

    invoke-virtual {p0, v1}, Lgc/h;->c(Lgc/h$c;)V
...
.method public final h(Lgc/h$c;)V
    .locals 5

    invoke-virtual {p0, p1}, Lgc/h;->c(Lgc/h$c;)V

    iget-object v0, p1, Lgc/h$c;->b:Ljava/lang/String;
    ...
    iget-object v0, p1, Lgc/h$c;->g:Lgc/h$b;

    invoke-virtual {v0}, Ljava/lang/Enum;->ordinal()I

    move-result v0

    sget-object v1, Lgc/h$b;->f:Lgc/h$b;
    ...
    :goto_1
    iget-object v1, p0, Lgc/h;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    new-instance v2, Lgc/h$e;

    invoke-direct {v2, p0, p1}, Lgc/h$e;-><init>(Lgc/h;Lgc/h$c;)V
...
.method public i()V
    ...
    :try_start_0
    iget-object v0, p0, Lgc/h;->g:Ljava/util/concurrent/ScheduledFuture;
    ...
    iput-object v0, p0, Lgc/h;->g:Ljava/util/concurrent/ScheduledFuture;
...
.method public j()V
    ...
    iget-object v0, p0, Lgc/h;->b:Lgc/e;
    ...
    :try_start_0
    iget-object v1, p0, Lgc/h;->g:Ljava/util/concurrent/ScheduledFuture;
    ...
    invoke-direct {v2, p0, v3}, Lgc/h$d;-><init>(Lgc/h;Lgc/h$a;)V
