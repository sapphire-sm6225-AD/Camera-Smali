...
.method public constructor <init>(Lgc/b;)V
    ...
    iput-object p1, p0, Lgc/b$b;->c:Lgc/b;

    invoke-direct {p0}, Ljava/lang/Thread;-><init>()V

    const/4 p1, 0x0

    iput-boolean p1, p0, Lgc/b$b;->a:Z

    iput-boolean p1, p0, Lgc/b$b;->b:Z

    return-void
.end method

.method public synthetic constructor <init>(Lgc/b;Lgc/b$a;)V
    .locals 0

    invoke-direct {p0, p1}, Lgc/b$b;-><init>(Lgc/b;)V

    return-void
.end method

.method public static synthetic d(Lgc/b$b;)Z
    .locals 0

    invoke-virtual {p0}, Lgc/b$b;->e()Z
...
.method public final a(I)I
    ...
    :cond_1
    iget-object p0, p0, Lgc/b$b;->c:Lgc/b;

    invoke-static {p0}, Lgc/b;->w(Lgc/b;)Lgc/e;
    ...
    invoke-static {p0, v1}, Lsc/a;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public declared-synchronized c()Z
    ...
    :try_start_0
    iget-boolean v0, p0, Lgc/b$b;->b:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final e()Z
    ...
    :try_start_0
    iget-boolean v0, p0, Lgc/b$b;->a:Z
...
.method public run()V
    ...
    iget-object v0, p0, Lgc/b$b;->c:Lgc/b;

    invoke-static {v0}, Lgc/b;->w(Lgc/b;)Lgc/e;
    ...
    invoke-static {p0, v1}, Lgc/b;->v(Lgc/b;Lgc/b$b;)Lgc/b$b;

    return-void

    :cond_0
    iget-object v2, p0, Lgc/b$b;->c:Lgc/b;

    invoke-static {v2}, Lgc/b;->w(Lgc/b;)Lgc/e;

    move-result-object v2

    invoke-virtual {v2}, Lgc/e;->Q()I
    ...
    invoke-static {v4, v5}, Lsc/a;->e(Ljava/lang/String;Ljava/lang/String;)V

    if-eq v2, v3, :cond_1

    iget-object v3, p0, Lgc/b$b;->c:Lgc/b;

    invoke-virtual {v3, v0, v2}, Lgc/b;->e(Lcom/xiaomi/ai/core/b;I)V
    ...
    invoke-static {v0}, Lgc/b;->A(Lgc/b;)Z
    ...
    :try_start_2
    iput-boolean v0, p0, Lgc/b$b;->a:Z
    ...
    invoke-static {v2}, Lgc/b;->B(Lgc/b;)I

    move-result v2

    invoke-virtual {p0, v2}, Lgc/b$b;->a(I)I
    ...
    invoke-static {v3, v4}, Lsc/a;->h(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_5
    iput-boolean v2, p0, Lgc/b$b;->a:Z
    ...
    invoke-static {v3}, Lgc/b;->w(Lgc/b;)Lgc/e;

    move-result-object v3

    invoke-virtual {v3}, Lgc/e;->C()Landroid/content/Context;
    ...
    invoke-virtual {v3}, Lgc/e;->O()Lcom/xiaomi/ai/core/b;
    ...
    iget-object v5, p0, Lgc/b$b;->c:Lgc/b;

    invoke-static {v5}, Lgc/b;->w(Lgc/b;)Lgc/e;

    move-result-object v5

    invoke-virtual {v5}, Lgc/e;->C()Landroid/content/Context;
    ...
    iget-object v4, p0, Lgc/b$b;->c:Lgc/b;

    invoke-static {v4}, Lgc/b;->w(Lgc/b;)Lgc/e;

    move-result-object v4

    invoke-virtual {v4}, Lgc/e;->J()Lcom/xiaomi/ai/core/a;
    ...
    invoke-virtual {v4, v3, v2}, Lgc/b;->e(Lcom/xiaomi/ai/core/b;I)V
    ...
    invoke-virtual {v2}, Lgc/e;->O()Lcom/xiaomi/ai/core/b;
    ...
    invoke-static {v4}, Lgc/b;->C(Lgc/b;)I
    ...
    invoke-static {v2}, Lgc/b;->A(Lgc/b;)Z
    ...
    invoke-virtual {v2}, Lgc/e;->J()Lcom/xiaomi/ai/core/a;
    ...
    :try_start_7
    iput-boolean v0, p0, Lgc/b$b;->b:Z
