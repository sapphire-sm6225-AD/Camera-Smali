...
.method public constructor <init>(Lgc/e;)V
    ...
    iput-object v0, p0, Lgc/c;->j:Ljava/security/SecureRandom;
    ...
    iput-object v0, p0, Lgc/c;->b:Landroid/content/Context;
    ...
    iput-object v1, p0, Lgc/c;->d:Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lgc/e;->V()Lcom/xiaomi/ai/api/o0$e;
    ...
    iput-object p1, p0, Lgc/c;->g:Lokhttp3/OkHttpClient;

    new-instance p1, Lgc/c$a;

    invoke-direct {p1, p0}, Lgc/c$a;-><init>(Lgc/c;)V

    iput-object p1, p0, Lgc/c;->c:Ljava/lang/Runnable;

    return-void
.end method

.method public static synthetic a(Lgc/c;)I
    .locals 0

    iget p0, p0, Lgc/c;->h:I

    return p0
.end method

.method public static synthetic e(Lgc/c;I)V
    .locals 0

    invoke-virtual {p0, p1}, Lgc/c;->c(I)V

    return-void
.end method

.method public static synthetic f(Lgc/c;J)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Lgc/c;->d(J)V

    return-void
.end method

.method public static synthetic k(Lgc/c;I)J
    .locals 0

    invoke-virtual {p0, p1}, Lgc/c;->j(I)J
...
.method public static synthetic m(Lgc/c;)V
    .locals 0

    invoke-virtual {p0}, Lgc/c;->p()V
...
.method public final b(Ljava/lang/String;J)J
    ...
    iget-object p0, p0, Lgc/c;->b:Landroid/content/Context;

    const-string v0, "aivs_cloud_control"

    invoke-static {p0, v0, p1}, Llc/e;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p0}, Lsc/a;->h(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final c(I)V
    ...
    iget-object v1, p0, Lgc/c;->j:Ljava/security/SecureRandom;
    ...
    iput p1, p0, Lgc/c;->h:I

    int-to-long v1, p1

    invoke-virtual {p0, v0, v1, v2}, Lgc/c;->o(Ljava/lang/String;J)V
    ...
    invoke-virtual {p0, v0, v1, v2}, Lgc/c;->b(Ljava/lang/String;J)J
    ...
    iget-object p1, p0, Lgc/c;->j:Ljava/security/SecureRandom;
...
.method public final d(J)V
    ...
    iget-object v0, p0, Lgc/c;->c:Ljava/lang/Runnable;
    ...
    :cond_0
    iget-object v0, p0, Lgc/c;->i:Ljava/util/concurrent/ScheduledFuture;
    ...
    invoke-static {v0}, Lpc/c;->c(Ljava/util/concurrent/ScheduledFuture;)V

    :cond_1
    :try_start_0
    iget-object v0, p0, Lgc/c;->c:Ljava/lang/Runnable;

    invoke-static {v0, p1, p2}, Lpc/c;->a(Ljava/lang/Runnable;J)Ljava/util/concurrent/ScheduledFuture;

    move-result-object p1

    iput-object p1, p0, Lgc/c;->i:Ljava/util/concurrent/ScheduledFuture;
    :try_end_0
...
.method public final g(Ljava/lang/String;)V
    ...
    invoke-static {p0, v0, v1, p1}, Llc/e;->c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    return-void
.end method

.method public final h(Ljc/a$a;)V
    .locals 1

    invoke-virtual {p1}, Ljc/a$a;->b()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lgc/c;->r()V

    :cond_0
    invoke-virtual {p1}, Ljc/a$a;->e()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p0}, Lgc/c;->s()V

    :cond_1
    invoke-virtual {p1}, Ljc/a$a;->a()Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-virtual {p0}, Lgc/c;->t()V

    :cond_2
    invoke-virtual {p1}, Ljc/a$a;->d()Z

    move-result v0

    if-eqz v0, :cond_3

    invoke-virtual {p0}, Lgc/c;->u()V

    :cond_3
    invoke-virtual {p1}, Ljc/a$a;->c()Z

    move-result p1

    if-eqz p1, :cond_4

    invoke-virtual {p0}, Lgc/c;->v()V
...
.method public i()Z
    ...
    iget-object v0, p0, Lgc/c;->a:Lgc/e;
    ...
    :cond_0
    iget-object p0, p0, Lgc/c;->c:Ljava/lang/Runnable;
...
.method public final j(I)J
    ...
    invoke-virtual {p0, v0}, Lgc/c;->n(Ljava/lang/String;)V
...
.method public l()V
    ...
    iput-object v1, p0, Lgc/c;->i:Ljava/util/concurrent/ScheduledFuture;

    :cond_0
    iput-object v1, p0, Lgc/c;->c:Ljava/lang/Runnable;
...
.method public final n(Ljava/lang/String;)V
    ...
    invoke-static {p0, v0, p1}, Llc/e;->e(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final o(Ljava/lang/String;J)V
    ...
    invoke-static {p0, v0, p1, p2}, Llc/e;->c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final p()V
    ...
    invoke-virtual {p0}, Lgc/c;->q()Ljc/a;
    ...
    iget-object v2, p0, Lgc/c;->c:Ljava/lang/Runnable;
    ...
    invoke-virtual {p0, v5, v3, v4}, Lgc/c;->b(Ljava/lang/String;J)J

    move-result-wide v3

    long-to-int v3, v3

    iget-object v4, p0, Lgc/c;->b:Landroid/content/Context;

    const-string v6, "aivs_cloud_control"

    const-string v7, "link_mode"

    invoke-static {v4, v6, v7}, Llc/e;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, p0}, Lsc/a;->h(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v5, v2, v3}, Lgc/c;->o(Ljava/lang/String;J)V

    invoke-virtual {v0}, Ljc/a;->a()Ljc/a$a;
    ...
    invoke-virtual {p0, v2}, Lgc/c;->h(Ljc/a$a;)V
    ...
    invoke-virtual {p0, v2}, Lgc/c;->g(Ljava/lang/String;)V

    invoke-virtual {v0}, Ljc/a;->c()I

    move-result v0

    invoke-virtual {p0, v0}, Lgc/c;->c(I)V
...
.method public final q()Ljc/a;
    ...
    iget-object v2, p0, Lgc/c;->e:Ljava/lang/String;

    invoke-virtual {v0, v1, v2}, Lokhttp3/HttpUrl$Builder;->addQueryParameter(Ljava/lang/String;Ljava/lang/String;)Lokhttp3/HttpUrl$Builder;

    const-string v1, "uid"

    iget-object v2, p0, Lgc/c;->f:Ljava/lang/String;
    ...
    :try_start_0
    iget-object p0, p0, Lgc/c;->g:Lokhttp3/OkHttpClient;
    ...
    invoke-virtual {v0, p0, v3}, Lva/u;->I1(Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;
...
.method public final r()V
    ...
    invoke-virtual {v0, p0, v1}, Lqc/a;->m(Lcom/xiaomi/ai/core/b;Ljava/lang/String;)V
...
.method public final s()V
    ...
    invoke-static {p0, v1}, Lsc/a;->k(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final v()V
    ...
    invoke-virtual {v0, v1}, Lfc/h;->h(Ljava/lang/String;)V
    ...
    invoke-static {p0, v0, v1}, Llc/e;->e(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
