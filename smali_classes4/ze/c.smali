...
.method public static d([BI)Landroid/graphics/Bitmap;
    ...
    :try_start_0
    invoke-static {p0}, Lze/c;->g([B)Landroid/util/Size;
    ...
    invoke-static {v1, v3, p1}, Lze/c;->a(Landroid/util/Size;II)I
...
.method public static l(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0}, Lze/c;->m(Ljava/lang/String;)Landroid/graphics/Bitmap;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-static {p0}, Lze/c;->i(Ljava/lang/String;)I
...
.method public static m(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0}, Lze/c;->f(Ljava/lang/String;)Landroid/util/Size;
    ...
    invoke-static {v0, v2, v3}, Lze/c;->a(Landroid/util/Size;II)I
...
.method public static n(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p1, v0}, Lze/c;->q(Landroid/graphics/Bitmap;IF)Landroid/graphics/Bitmap;
...
.method public static o(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p1, v0, p2}, Lze/c;->r(Landroid/graphics/Bitmap;IFZ)Landroid/graphics/Bitmap;
...
.method public static p(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    ...
    invoke-static/range {v0 .. v6}, Lze/c;->u(Landroid/graphics/Bitmap;IFZZZZ)Landroid/graphics/Bitmap;
...
.method public static q(Landroid/graphics/Bitmap;IF)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p1, p2, v0}, Lze/c;->r(Landroid/graphics/Bitmap;IFZ)Landroid/graphics/Bitmap;
...
.method public static s(Landroid/graphics/Bitmap;F)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, v0, p1}, Lze/c;->q(Landroid/graphics/Bitmap;IF)Landroid/graphics/Bitmap;
