...
.method public static synthetic a(IZ)V
    ...
    invoke-static {p0, p1}, Lai/e;->n(IZ)V

    return-void
.end method

.method public static synthetic b(Ljava/lang/String;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicInteger;Lei/b;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lai/e;->k(Ljava/lang/String;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicInteger;Lei/b;Ljava/util/concurrent/atomic/AtomicBoolean;)V

    return-void
.end method

.method public static synthetic c([B[BLjava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lei/b;Ljava/util/concurrent/atomic/AtomicInteger;)V
    .locals 0

    invoke-static/range {p0 .. p5}, Lai/e;->m([B[BLjava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lei/b;Ljava/util/concurrent/atomic/AtomicInteger;)V

    return-void
.end method

.method public static synthetic d(Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lei/b;Ljava/util/concurrent/atomic/AtomicInteger;ILjava/lang/String;)V
    .locals 0

    invoke-static/range {p0 .. p5}, Lai/e;->l(Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lei/b;Ljava/util/concurrent/atomic/AtomicInteger;ILjava/lang/String;)V
...
.method public static f()Z
    ...
    sget-object v0, Lai/e;->a:Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lij/c;->a(Ljava/lang/String;Ljava/lang/String;)V

    return v4

    :cond_0
    invoke-static {v1}, Lij/i;->o(Ljava/lang/String;)Z
...
.method public static g(Lcom/faceunity/core/avatar/model/Avatar;Ljava/util/List;)Z
    ...
    sget-object p0, Lai/e;->a:Ljava/lang/String;

    const-string p1, "checkAvatarIsLegal avatar isEmpty"

    invoke-static {p0, p1}, Lij/c;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v5}, Lij/i;->o(Ljava/lang/String;)Z
    ...
    invoke-static {v1, v4}, Lai/e;->e(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    sget-object p1, Lai/e;->a:Ljava/lang/String;
    ...
    invoke-static {p1, p0}, Lij/c;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static h(Lti/f;Lcom/faceunity/core/avatar/model/Avatar;)Z
    .locals 5
    ...
    invoke-static {p1}, Lij/i;->o(Ljava/lang/String;)Z
    ...
    :cond_2
    invoke-static {v0, v3}, Lai/e;->e(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    invoke-static {v0, p1}, Lai/e;->e(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    invoke-static {v0, p0}, Lai/e;->e(Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method public static i(ZILei/b;)V
    .locals 0
    ...
    invoke-static {}, Lai/e;->f()Z

    move-result p0

    if-eqz p0, :cond_1

    invoke-static {}, Lai/e;->p()V

    sget-object p0, Lai/e;->a:Ljava/lang/String;

    const-string p1, "initFaceUnity registerFURender finishes SUCCESS"

    invoke-static {p0, p1}, Lij/j;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {p2, p0, p1}, Lei/b;->a(ILjava/lang/String;)V
    ...
    invoke-interface {p2, p0, p1}, Lei/b;->c(ILjava/lang/String;)V
...
.method public static j(Ljava/lang/String;Lei/b;)V
    .locals 13
    ...
    invoke-virtual {v0, v3, v4}, Lij/f;->d([B[B)V
    ...
    invoke-direct/range {v5 .. v10}, Lai/b;-><init>(Ljava/lang/String;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicInteger;Lei/b;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    ...
    invoke-static {p0}, Lai/e;->q(Lcom/faceunity/toolbox/utils/FULogger$LogLevel;)V

    sget-object p0, Lcom/faceunity/toolbox/utils/FULogger$LogLevel;->INFO:Lcom/faceunity/toolbox/utils/FULogger$LogLevel;

    invoke-static {p0}, Lai/e;->r(Lcom/faceunity/toolbox/utils/FULogger$LogLevel;)V
    ...
    invoke-direct/range {v2 .. v8}, Lai/c;-><init>([B[BLjava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lei/b;Ljava/util/concurrent/atomic/AtomicInteger;)V
...
.method public static synthetic k(Ljava/lang/String;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicInteger;Lei/b;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    .locals 3
    ...
    invoke-virtual {v1, v2, p0}, Lpi/e;->G(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p2, v1, p3}, Lai/e;->i(ZILei/b;)V
...
.method public static synthetic l(Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lei/b;Ljava/util/concurrent/atomic/AtomicInteger;ILjava/lang/String;)V
    .locals 2
    ...
    invoke-static {v1, p4, p2}, Lai/e;->i(ZILei/b;)V
    ...
    invoke-interface {p2, p4, p5}, Lei/b;->c(ILjava/lang/String;)V
...
.method public static synthetic m([B[BLjava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lei/b;Ljava/util/concurrent/atomic/AtomicInteger;)V
    .locals 2
    ...
    invoke-direct {v0, p2, p3, p4, p5}, Lai/a;-><init>(Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lei/b;Ljava/util/concurrent/atomic/AtomicInteger;)V
...
.method public static synthetic n(IZ)V
    ...
    invoke-virtual {v1}, Lci/b;->g()Lcom/faceunity/core/avatar/model/Scene;

    move-result-object v2

    invoke-virtual {v1, p0}, Lci/b;->p(I)Lqi/c;
    ...
    invoke-virtual {v3}, Lqi/c;->b()Leg/a;
    ...
    invoke-static {v5, v4}, Lai/e;->g(Lcom/faceunity/core/avatar/model/Avatar;Ljava/util/List;)Z
    ...
    invoke-static {v0, v5}, Lij/c;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v7, v4}, Lpi/e;->f(Lcom/faceunity/core/avatar/model/Avatar;Ljava/util/List;)V

    goto :goto_0

    :cond_1
    invoke-static {v0, v6}, Lij/c;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v4, v5}, Lci/b;->b(Lcom/faceunity/core/avatar/model/Avatar;Ljava/lang/String;)V

    invoke-virtual {v3}, Lqi/c;->a()Lcom/faceunity/core/avatar/model/Avatar;

    move-result-object v4

    sget-object v5, Ldi/b;->a:Ldi/b;

    invoke-virtual {v1, v4, v5}, Lci/b;->q(Lcom/faceunity/core/avatar/model/Avatar;Ldi/b;)Lti/f;
    ...
    invoke-static {v4, v5}, Lai/e;->h(Lti/f;Lcom/faceunity/core/avatar/model/Avatar;)Z
    ...
    invoke-virtual {p1, v4, v5}, Lpi/e;->R(Lti/f;Lcom/faceunity/core/avatar/model/Avatar;)V
    ...
    :cond_5
    :goto_2
    invoke-virtual {v1, v2, v4}, Lci/b;->f(Lcom/faceunity/core/avatar/model/Scene;Lti/f;)V

    invoke-virtual {v1, v2}, Lci/b;->s(Lcom/faceunity/core/avatar/model/Scene;)V

    invoke-virtual {v3}, Lqi/c;->a()Lcom/faceunity/core/avatar/model/Avatar;

    move-result-object p1

    invoke-virtual {v1, v2, p1}, Lci/b;->e(Lcom/faceunity/core/avatar/model/Scene;Lcom/faceunity/core/avatar/model/Avatar;)V
    ...
    invoke-static {p0, p1}, Lai/e;->e(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    invoke-static {v0, p0}, Lij/c;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static o(IZ)V
    ...
    invoke-direct {v1, p0, p1}, Lai/d;-><init>(IZ)V
...
.method public static p()V
    ...
    sget-object v1, Lbi/a;->b:Ljava/lang/String;
