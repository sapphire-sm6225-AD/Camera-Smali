...
.method public constructor <init>(Lkj/d;)V
    ...
    iput-object p1, p0, Lkj/d$n;->a:Lkj/d;
...
.method public onRecordSuccess(Landroid/graphics/Bitmap;Ljava/lang/String;)V
    ...
    invoke-static/range {v0 .. v5}, Lvl/c0;->U4(Ljava/lang/CharSequence;[Ljava/lang/String;ZIILjava/lang/Object;)Ljava/util/List;
    ...
    iget-object p2, p0, Lkj/d$n;->a:Lkj/d;

    invoke-static {p2}, Lkj/d;->x(Lkj/d;)Lni/b;
    ...
    invoke-virtual {p2, v0}, Lni/b;->x(Ljava/lang/String;)Lii/e;

    move-result-object p2

    if-eqz p2, :cond_2

    iget-object p0, p0, Lkj/d$n;->a:Lkj/d;
