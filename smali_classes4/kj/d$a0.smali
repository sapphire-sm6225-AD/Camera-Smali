...
.method public constructor <init>(Lkj/d;)V
    ...
    iput-object p1, p0, Lkj/d$a0;->a:Lkj/d;
...
.method public onCompleted()V
    ...
    iget-object v0, p0, Lkj/d$a0;->a:Lkj/d;
    ...
    invoke-static {v0}, Lkj/d;->q(Lkj/d;)Lhi/a;
    ...
    :cond_1
    sget-object v0, Lkj/d;->F:Lcom/faceunity/core/avatar/model/Avatar;

    if-eqz v0, :cond_5

    iget-object v4, p0, Lkj/d$a0;->a:Lkj/d;

    invoke-static {v4}, Lkj/d;->x(Lkj/d;)Lni/b;
    ...
    :cond_2
    invoke-virtual {v5}, Lni/b;->m()Ljava/util/List;
    ...
    :cond_3
    invoke-virtual {v6}, Lni/b;->n()Ljava/util/HashMap;
    ...
    :cond_4
    invoke-virtual {v7}, Lni/b;->o()Ljava/util/ArrayList;

    move-result-object v1

    new-instance v7, Lhi/a;

    invoke-direct {v7, v0}, Lhi/a;-><init>(Lcom/faceunity/core/avatar/model/Avatar;)V

    invoke-virtual {v7, v5, v6, v1}, Lhi/a;->b(Ljava/util/List;Ljava/util/HashMap;Ljava/util/ArrayList;)V

    invoke-static {v4, v7}, Lkj/d;->K(Lkj/d;Lhi/a;)V
    ...
    :cond_7
    iget-object p0, p0, Lkj/d$a0;->a:Lkj/d;
    ...
    invoke-virtual {p0, v12}, Lhi/a;->g(Lcom/faceunity/core/entity/FUAnimationBundleData;)V
