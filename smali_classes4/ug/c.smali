...
.method public constructor <init>(II)V
    ...
    .line 1
    sget-object v0, Lug/c$b;->a:Lug/c$b;

    invoke-direct {p0, p1, p2, v0}, Lug/c;-><init>(IILug/c$b;)V

    return-void
.end method

.method public constructor <init>(IILug/c$b;)V
    .locals 0
    ...
    .line 5
    iput p2, p0, Lug/c;->c:I

    .line 6
    iput-object p3, p0, Lug/c;->d:Lug/c$b;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget v0, p1, Lug/c;->c:I

    iget v1, p0, Lug/c;->c:I

    if-ne v0, v1, :cond_0

    iget-object p1, p1, Lug/c;->d:Lug/c$b;

    iget-object p0, p0, Lug/c;->d:Lug/c$b;
...
.method public final l(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V
    ...
    sget-object v0, Lug/c$a;->a:[I

    iget-object v1, p0, Lug/c;->d:Lug/c$b;
    ...
    :pswitch_0
    invoke-virtual {p0, p1, p2, p3, p4}, Lug/c;->e(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_1
    invoke-virtual {p0, p1, p2, p3, p4}, Lug/c;->d(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_2
    invoke-virtual {p0, p1, p2, p3, p4}, Lug/c;->h(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_3
    invoke-virtual {p0, p1, p2, p3, p4}, Lug/c;->g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_4
    invoke-virtual {p0, p1, p2, p3, p4}, Lug/c;->j(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_5
    invoke-virtual {p0, p1, p2, p3, p4}, Lug/c;->i(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_6
    invoke-virtual {p0, p1, p2, p3, p4}, Lug/c;->k(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_7
    invoke-virtual {p0, p1, p2, p3, p4}, Lug/c;->f(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_8
    invoke-virtual {p0, p1, p2, p3, p4}, Lug/c;->c(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_9
    invoke-virtual {p0, p1, p2, p3, p4}, Lug/c;->o(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_a
    invoke-virtual {p0, p1, p2, p3, p4}, Lug/c;->b(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_b
    invoke-virtual {p0, p1, p2, p3, p4}, Lug/c;->a(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_c
    invoke-virtual {p0, p1, p2, p3, p4}, Lug/c;->n(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_d
    invoke-virtual {p0, p1, p2, p3, p4}, Lug/c;->m(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V
...
.method public transform(Lcom/bumptech/glide/load/engine/bitmap_recycle/BitmapPool;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, v1, v2, p2, p3}, Lug/c;->l(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V
