...
.method public a(Ldd/e;Lzd/d;Lcom/xiaomi/engine/TaskSession;)V
    ...
    invoke-direct/range {v4 .. v9}, Ldd/e$a;-><init>(IZLik/b;ZZ)V
    ...
    invoke-static {v4, v0}, Lyc/e;->b(Ljava/lang/String;I)V
    ...
    invoke-virtual {v7}, Ldd/e$a;->e()Landroid/media/Image;
    ...
    :cond_3
    invoke-static {v4, v10}, Lyc/e;->b(Ljava/lang/String;I)V
    ...
    :goto_2
    invoke-virtual {v3, v6, v0, v0}, Ldd/e$a;->B(Landroid/media/Image;IZ)V
    ...
    invoke-interface {v6, v11}, Ldd/f;->b(Landroid/media/Image;)V

    invoke-virtual {v8}, Ldd/e$a;->k()Landroid/media/Image;
    ...
    invoke-interface {v6, v8}, Ldd/f;->b(Landroid/media/Image;)V
    ...
    invoke-interface {v6, v1}, Ldd/f;->b(Landroid/media/Image;)V

    invoke-virtual {v3, v5, v10}, Ldd/e$a;->x(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
    ...
    invoke-virtual {v4}, Ldd/e$a;->m()Landroid/media/Image;

    move-result-object v1

    invoke-virtual {v4}, Ldd/e$a;->v()Z

    move-result v5

    invoke-virtual {v3, v1, v9, v5}, Ldd/e$a;->B(Landroid/media/Image;IZ)V
    ...
    invoke-virtual {v3, v1, v10, v0}, Ldd/e$a;->B(Landroid/media/Image;IZ)V

    :cond_9
    invoke-virtual {v3}, Ldd/e$a;->o()Z
    ...
    invoke-virtual {v1, v4, v3, v5}, Lzd/b;->b(Ldd/e;Ldd/e$a;Lzd/d;)V
