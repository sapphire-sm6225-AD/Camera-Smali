...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ls6/d0;->ga:Ls6/l;
    ...
    iput-object v0, p0, Ls6/d0;->ha:Lx0/f1;

    const/4 v0, 0x0

    iput v0, p0, Ls6/d0;->ia:I

    return-void
.end method

.method public static synthetic Br(Ld6/g6$f;Ljava/util/List;)V
    .locals 0

    invoke-static {p0, p1}, Ls6/d0;->Ir(Ld6/g6$f;Ljava/util/List;)V

    return-void
.end method

.method public static synthetic Cr(Lj7/a0;)V
    .locals 0

    invoke-static {p0}, Ls6/d0;->Jr(Lj7/a0;)V
...
.method public static synthetic Jr(Lj7/a0;)V
    .locals 1
...
.method public Bc(II)V
    ...
    invoke-virtual {p2}, Lx0/h1;->i0()Lx0/f1;

    move-result-object p2

    invoke-virtual {p2, p1}, Lx0/f1;->isSwitchOn(I)Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-virtual {p0, p2}, Ls6/d0;->Kr(Lx0/f1;)V

    :cond_0
    return-void
.end method

.method public Dr(Landroid/content/Intent;)V
    .locals 3
    ...
    invoke-virtual {p0, p1}, Ls6/d0;->Gr(Landroid/net/Uri;)V

    goto :goto_0

    :cond_0
    iget-object p1, p0, Ls6/d0;->ha:Lx0/f1;

    invoke-virtual {p1}, Lx0/f1;->j()I

    move-result p1

    iput p1, p0, Ls6/d0;->ia:I

    invoke-virtual {p0, p1}, Ls6/d0;->Lr(I)V

    :cond_1
    :goto_0
    iget-object p0, p0, Ls6/d0;->ha:Lx0/f1;

    const/4 p1, 0x1

    invoke-virtual {p0, p1}, Lx0/f1;->s(Z)V
...
.method public Er()V
    ...
    iget-object p0, p0, Ls6/d0;->ga:Ls6/l;
...
.method public final Fr(Ld6/g6$f;)Ld6/g6$f;
    .locals 0

    new-instance p0, Ls6/c0;

    invoke-direct {p0, p1}, Ls6/c0;-><init>(Ld6/g6$f;)V

    return-object p0
.end method

.method public final Gr(Landroid/net/Uri;)V
    .locals 6

    iget-object v0, p0, Ls6/d0;->ha:Lx0/f1;

    invoke-virtual {p0}, Ld6/j0;->Y()I

    move-result v1

    invoke-virtual {v0, v1}, Lx0/f1;->l(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, v2}, Ls6/d0;->Or(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_3
    invoke-static {v4, v5}, Lcom/android/camera/c6;->U(Ljava/io/FileInputStream;Ljava/io/FileOutputStream;)V
    :try_end_3
    ...
    invoke-virtual {p0, v1}, Ls6/d0;->Mr(I)V
    ...
    iget-object v2, p0, Ls6/d0;->ha:Lx0/f1;

    iget v4, p0, Ld6/j0;->a:I

    invoke-virtual {v2, v0, v4}, Lx0/f1;->h(Lcom/android/camera2/compat/theme/custom/mm/beauty/VideoLogLutWorkspaceItem;I)Z
    ...
    invoke-virtual {p1, v0}, Lx0/f1;->g(Lcom/android/camera2/compat/theme/custom/mm/beauty/VideoLogLutWorkspaceItem;)Z
    ...
    invoke-virtual {p0, p1}, Ls6/d0;->Nr(Ljava/lang/String;)V

    goto :goto_4

    :cond_3
    iput v3, p0, Ls6/d0;->ia:I
...
.method public Hr()V
    ...
    iget-object v1, p0, Ls6/d0;->ga:Ls6/l;
...
.method public final Kr(Lx0/f1;)V
    .locals 4
    ...
    invoke-virtual {p1, v1}, Lx0/f1;->k(I)Lcom/android/camera2/compat/theme/custom/mm/beauty/VideoLogLutWorkSpace;
...
.method public Ll(II)V
    ...
    iget-object v0, p0, Ls6/d0;->ga:Ls6/l;
    ...
    invoke-static {p1, p0}, Lcom/android/camera/t2;->j0(ILcom/android/camera2/f;)[F
    ...
    invoke-direct {v0, v1, p0}, Lyj/j;-><init>(FF)V

    invoke-interface {p2, p1, v0}, Lcom/android/camera/ui/e1;->O0(Lxj/e;Lyj/d;)V
    ...
    invoke-interface {p2, p0}, Lcom/android/camera/ui/e1;->V0(Lxj/e;)V
    ...
    invoke-interface {p2, p0}, Lcom/android/camera/ui/e1;->U0(Lxj/e;)Ldk/t;
...
.method public final Lr(I)V
    ...
    invoke-virtual {p0, p1}, Lx0/f1;->t(I)V
...
.method public Wm(Ld6/g6$f;)V
    ...
    invoke-virtual {p0, p1}, Ls6/d0;->Fr(Ld6/g6$f;)Ld6/g6$f;
...
.method public hr()V
    ...
    invoke-virtual {v0, v1}, Lx0/f1;->isSwitchOn(I)Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-virtual {p0, v0}, Ls6/d0;->Kr(Lx0/f1;)V

    goto :goto_0

    :cond_0
    invoke-super {p0}, Ld6/o7;->hr()V
...
.method public onDestroy()V
    ...
    invoke-interface {v0, p0}, Lcom/android/camera/ui/e1;->a1(Lxj/e;)V
