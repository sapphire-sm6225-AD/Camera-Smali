...
.field public b:Lcom/android/camera/n;
...
.method public h3(Landroid/content/Context;I)V
    .locals 4

    const/4 v0, 0x1

    invoke-static {p1, p2, v0}, Lcom/android/camera/z4;->n(Landroid/content/Context;IZ)V

    invoke-static {p1, p2}, Lcom/android/camera/z4;->c(Landroid/content/Context;I)Z
    ...
    iget-object v1, p0, Ls6/z;->b:Lcom/android/camera/n;

    if-nez v1, :cond_0

    new-instance v1, Lcom/android/camera/n;

    invoke-direct {v1}, Lcom/android/camera/n;-><init>()V

    iput-object v1, p0, Ls6/z;->b:Lcom/android/camera/n;

    :cond_0
    invoke-static {p1, p2}, Lcom/android/camera/z4;->h(Landroid/content/Context;I)V

    iput-boolean v0, p0, Ls6/z;->a:Z

    iget-object p0, p0, Ls6/z;->b:Lcom/android/camera/n;

    if-eqz p0, :cond_1

    invoke-virtual {p0}, Lcom/android/camera/n;->g()V

    :cond_1
    invoke-static {p1, p2}, Lcom/android/camera/z4;->i(Landroid/content/Context;I)V
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-virtual {p0, p1, p2}, Ls6/z;->q7(Landroid/content/Context;I)V
    ...
    invoke-interface {p2}, Ld6/b5;->g()Z
    ...
    invoke-virtual {p0, p1, p2}, Ls6/z;->h3(Landroid/content/Context;I)V
...
.method public q7(Landroid/content/Context;I)V
    .locals 4
    ...
    invoke-virtual {p0}, Lcom/android/camera/n;->i()V

    :cond_0
    invoke-static {p1, p2}, Lcom/android/camera/z4;->b(Landroid/content/Context;I)V

    invoke-static {p1, p2}, Lcom/android/camera/z4;->a(Landroid/content/Context;I)V
