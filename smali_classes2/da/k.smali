...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lda/k;->h:Ljava/util/concurrent/atomic/AtomicInteger;

    const/16 v0, 0x10

    iput v0, p0, Lda/k;->i:I

    iput-boolean v1, p0, Lda/k;->k:Z

    iput-boolean v1, p0, Lda/k;->l:Z

    const/4 v0, 0x1

    iput-boolean v0, p0, Lda/k;->m:Z

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, p0, Lda/k;->o:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-static {}, Lio/reactivex/subjects/PublishSubject;->create()Lio/reactivex/subjects/PublishSubject;

    move-result-object v0

    iput-object v0, p0, Lda/k;->f:Lio/reactivex/subjects/PublishSubject;
    ...
    iput-object v1, p0, Lda/k;->g:Lcom/android/camera/handgesture/HandGesture;
    ...
    invoke-direct {v1, p0}, Lda/i;-><init>(Lda/k;)V
    ...
    invoke-direct {v1, p0}, Lda/j;-><init>(Lda/k;)V
...
.method public static synthetic l(Lda/k;Lda/x;)Ljava/lang/Integer;
    .locals 0

    invoke-direct {p0, p1}, Lda/k;->s(Lda/x;)Ljava/lang/Integer;
...
.method public static synthetic m(Lda/k;Ljava/lang/Integer;)V
    .locals 0

    invoke-direct {p0, p1}, Lda/k;->t(Ljava/lang/Integer;)V
...
.method public static n(Landroid/content/Context;)V
    ...
    invoke-static {}, Lda/k;->r()Ljava/lang/String;

    move-result-object v0

    const-string v1, "hand_gesture_model"

    invoke-static {p0, v1, v0}, Lcom/android/camera/c6;->o5(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p0, v1, v0}, Lcom/android/camera/c6;->T(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
...
.method private synthetic s(Lda/x;)Ljava/lang/Integer;
    .locals 5
    ...
    :cond_0
    :try_start_1
    iget-object p1, p0, Lda/k;->o:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object p0, p0, Lda/k;->g:Lcom/android/camera/handgesture/HandGesture;
    ...
    :cond_1
    iget-object v0, p0, Lda/k;->o:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {p0, p1}, Lda/k;->o(Lda/x;)I
...
.method private synthetic t(Ljava/lang/Integer;)V
    ...
    iget-object p1, p0, Lda/k;->h:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p1, v1}, Ljava/util/concurrent/atomic/AtomicInteger;->set(I)V

    :goto_0
    iget-boolean p1, p0, Lda/k;->k:Z
    ...
    iget-object v2, p0, Lda/k;->h:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-boolean v2, p0, Lda/k;->k:Z

    xor-int/2addr v2, v0

    invoke-virtual {p1, v2}, Lx0/h1;->j1(Z)V

    iput-boolean v1, p0, Lda/k;->m:Z

    const/16 p1, 0x10

    iput p1, p0, Lda/k;->i:I

    :cond_4
    :goto_1
    iget-boolean p1, p0, Lda/k;->m:Z

    if-nez p1, :cond_6

    iget p1, p0, Lda/k;->i:I
    ...
    invoke-virtual {p1, v0}, Lx0/h1;->j1(Z)V
...
.method public c(I)V
    ...
    invoke-virtual {p0}, Lda/k;->u()V

    invoke-static {}, Lcom/android/camera/CameraAppImpl;->i()Landroid/content/Context;

    move-result-object v0

    invoke-static {v0}, Lda/k;->n(Landroid/content/Context;)V

    iput p1, p0, Lda/k;->j:I

    invoke-static {p1}, Lcom/android/camera/c6;->T1(I)I

    move-result p1

    iput p1, p0, Lda/k;->n:I
    ...
    invoke-virtual {p0, p1}, Lx0/h1;->j1(Z)V
...
.method public h(Lda/x;)V
    .locals 0

    iget-object p0, p0, Lda/k;->f:Lio/reactivex/subjects/PublishSubject;
...
.method public j()V
    ...
    iget-object v0, p0, Lda/k;->f:Lio/reactivex/subjects/PublishSubject;

    new-instance v1, Lda/x;

    const/4 v2, 0x1

    iget p0, p0, Lda/k;->j:I

    invoke-direct {v1, v2, p0}, Lda/x;-><init>(II)V
...
.method public k()V
    ...
    iget-object v1, p0, Lda/k;->f:Lio/reactivex/subjects/PublishSubject;

    new-instance v3, Lda/x;

    const/4 v4, 0x3

    iget v5, p0, Lda/k;->j:I

    invoke-direct {v3, v4, v5}, Lda/x;-><init>(II)V
...
.method public o(Lda/x;)I
    .locals 5

    invoke-virtual {p1}, Lda/x;->f()I
    ...
    iget-object v0, p0, Lda/k;->g:Lcom/android/camera/handgesture/HandGesture;

    invoke-virtual {p1}, Lda/x;->c()[B

    move-result-object v2

    invoke-virtual {p1}, Lda/x;->i()I

    move-result v3

    invoke-virtual {p1}, Lda/x;->e()I
    ...
    sget-boolean v1, Lda/k;->q:Z

    if-eqz v1, :cond_1

    invoke-virtual {p0, p1, v0}, Lda/k;->p(Lda/x;I)V

    :cond_1
    return v0
.end method

.method public final p(Lda/x;I)V
    .locals 11
...
.method public u()V
    ...
    iget-object v1, p0, Lda/c;->a:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v1, p0, Lda/k;->h:Ljava/util/concurrent/atomic/AtomicInteger;
