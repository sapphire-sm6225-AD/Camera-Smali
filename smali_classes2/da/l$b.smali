...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lda/l$b;->a:Lcom/google/mlkit/vision/barcode/BarcodeScanner;

    .line 6
    invoke-static {}, Lda/l;->a()V

    return-void
.end method

.method public synthetic constructor <init>(Lda/l$a;)V
    .locals 0

    .line 1
    invoke-direct {p0}, Lda/l$b;-><init>()V

    return-void
.end method

.method public static synthetic a(Lda/l$b$b;Ljava/lang/Exception;)V
    .locals 0

    invoke-static {p0, p1}, Lda/l$b;->f(Lda/l$b$b;Ljava/lang/Exception;)V

    return-void
.end method

.method public static synthetic b(Lda/l$b$b;)V
    .locals 0

    invoke-static {p0}, Lda/l$b;->g(Lda/l$b$b;)V

    return-void
.end method

.method public static synthetic c(Lda/l$b$b;Ljava/util/List;)V
    .locals 0

    invoke-static {p0, p1}, Lda/l$b;->e(Lda/l$b$b;Ljava/util/List;)V

    return-void
.end method

.method public static synthetic e(Lda/l$b$b;Ljava/util/List;)V
    .locals 4
    ...
    invoke-interface {p0}, Lda/l$b$b;->e0()V
    ...
    invoke-interface {p0, p1}, Lda/l$b$b;->a(Ljava/lang/String;)V
...
.method public static synthetic f(Lda/l$b$b;Ljava/lang/Exception;)V
    .locals 2
...
.method public static synthetic g(Lda/l$b$b;)V
    .locals 3
    ...
    invoke-interface {p0}, Lda/l$b$b;->onCanceled()V
...
.method public d()V
    ...
    iget-object p0, p0, Lda/l$b;->a:Lcom/google/mlkit/vision/barcode/BarcodeScanner;
...
.method public h(Lda/l$b$a;Lda/l$b$b;)V
    .locals 6

    iget-object v0, p0, Lda/l$b;->a:Lcom/google/mlkit/vision/barcode/BarcodeScanner;

    invoke-static {p1}, Lda/l$b$a;->a(Lda/l$b$a;)Ljava/nio/ByteBuffer;

    move-result-object v1

    invoke-static {p1}, Lda/l$b$a;->b(Lda/l$b$a;)I

    move-result v2

    invoke-static {p1}, Lda/l$b$a;->c(Lda/l$b$a;)I

    move-result v3

    invoke-static {p1}, Lda/l$b$a;->d(Lda/l$b$a;)I

    move-result v4

    invoke-static {p1}, Lda/l$b$a;->e(Lda/l$b$a;)I
    ...
    invoke-direct {p1, p2}, Lda/m;-><init>(Lda/l$b$b;)V
    ...
    invoke-direct {p1, p2}, Lda/n;-><init>(Lda/l$b$b;)V
    ...
    invoke-direct {p1, p2}, Lda/o;-><init>(Lda/l$b$b;)V
