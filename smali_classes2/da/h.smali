...
.method public static constructor <clinit>()V
    ...
    invoke-static {v0, v1, v2}, Lye/f;->f(Ljava/lang/String;J)J

    move-result-wide v0

    sput-wide v0, Lda/h;->j:J
...
.method public static synthetic l(Landroid/util/Pair;Lj7/d0;)V
    .locals 0

    invoke-static {p0, p1}, Lda/h;->t(Landroid/util/Pair;Lj7/d0;)V

    return-void
.end method

.method public static synthetic m(Lda/h;Lio/reactivex/FlowableEmitter;)V
    .locals 0

    invoke-direct {p0, p1}, Lda/h;->s(Lio/reactivex/FlowableEmitter;)V

    return-void
.end method

.method public static synthetic n(Lda/h;Lda/x;)Landroid/util/Pair;
    .locals 0

    invoke-virtual {p0, p1}, Lda/h;->p(Lda/x;)Landroid/util/Pair;
...
.method public static synthetic o(Landroid/util/Pair;)V
    ...
    invoke-static {p0}, Lda/h;->u(Landroid/util/Pair;)V
...
.method private synthetic s(Lio/reactivex/FlowableEmitter;)V
    ...
    iput-object p1, p0, Lda/h;->f:Lio/reactivex/FlowableEmitter;
...
.method public static synthetic t(Landroid/util/Pair;Lj7/d0;)V
    ...
    invoke-interface {p1, p0}, Lj7/d0;->H6(Landroid/util/Pair;)V
...
.method public static synthetic u(Landroid/util/Pair;)V
    ...
    invoke-direct {v1, p0}, Lda/d;-><init>(Landroid/util/Pair;)V
...
.method public h(Lda/x;)V
    ...
    iget-object p0, p0, Lda/h;->f:Lio/reactivex/FlowableEmitter;
...
.method public j()V
    ...
    invoke-virtual {p0}, Lda/h;->v()Lio/reactivex/disposables/Disposable;
...
.method public k()V
    ...
    iget-object v0, p0, Lda/h;->f:Lio/reactivex/FlowableEmitter;
    ...
    iput-object v0, p0, Lda/h;->f:Lio/reactivex/FlowableEmitter;

    :cond_0
    return-void
.end method

.method public final p(Lda/x;)Landroid/util/Pair;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance v4, Lda/x;

    invoke-direct {v4, p1}, Lda/x;-><init>(Lda/x;)V

    invoke-static {v4, v2}, Landroid/util/Pair;->create(Ljava/lang/Object;Ljava/lang/Object;)Landroid/util/Pair;

    move-result-object v4

    iput-object v4, p0, Lda/h;->g:Landroid/util/Pair;
    ...
    invoke-static {}, Lpj/a$e;->values()[Lpj/a$e;
...
.method public q()Landroid/util/Pair;
    ...
    iget-object p0, p0, Lda/h;->g:Landroid/util/Pair;
...
.method public final v()Lio/reactivex/disposables/Disposable;
    ...
    invoke-direct {v0, p0}, Lda/e;-><init>(Lda/h;)V
    ...
    invoke-direct {v1, p0}, Lda/f;-><init>(Lda/h;)V
