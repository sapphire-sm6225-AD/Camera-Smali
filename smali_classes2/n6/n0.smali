...
.method private synthetic J(Ld6/j0;Lj7/o1;)V
    ...
    :cond_0
    invoke-virtual {p1}, Ld6/j0;->Nh()Lm9/s;
    ...
    :goto_1
    invoke-interface {p2, v0, v1, p0, v2}, Lj7/e1;->jf([Landroid/hardware/camera2/params/MeteringRectangle;Landroid/graphics/Rect;FZ)V
...
.method public F(Ld6/j0;)V
    ...
    invoke-virtual {v0, p0}, Lcom/android/camera/ActivityBase;->uk(Ljava/lang/String;)V
...
.method public G(Lcom/android/camera2/a;Ld6/j0;)Z
    ...
    invoke-static {}, Lcom/android/camera/c6;->m3()Z
    ...
    invoke-static {}, Lcom/android/camera/c6;->o3()Z
...
.method public H(Ld6/j0;Lcom/android/camera2/f;)Z
    ...
    invoke-virtual {p1}, Ld6/j0;->zk()Ljava/util/Optional;
    ...
    check-cast p1, Lcom/android/camera/r2;

    iput-object p1, p0, Ln6/n0;->q1:Lcom/android/camera/r2;
...
.method public K(Landroid/hardware/camera2/CaptureResult;Ld6/j0;Lcom/android/camera2/a;)V
    ...
    invoke-static {p1, p2, p3, v0}, Lcom/android/camera/c6;->N0(Landroid/hardware/camera2/CaptureResult;Ljava/util/List;II)Ljava/lang/String;
...
.method public final L(Landroid/hardware/camera2/CaptureResult;Ld6/j0;)V
    ...
    invoke-virtual {p2}, Ld6/j0;->Fk()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lm6/n;->c(Ljava/lang/String;)V

    iget-object v0, p0, Ln6/n0;->q1:Lcom/android/camera/r2;
    ...
    iget-object v3, p0, Ln6/n0;->q1:Lcom/android/camera/r2;

    invoke-virtual {v3}, Lcom/android/camera/e5;->n()I

    move-result v3

    iget-object v4, p0, Ln6/n0;->q1:Lcom/android/camera/r2;

    invoke-virtual {v4}, Lcom/android/camera/e5;->k()I
    ...
    iget-object v1, p0, Ln6/n0;->q1:Lcom/android/camera/r2;

    invoke-virtual {v1}, Lcom/android/camera/e5;->n()I

    move-result v1

    iget-object v2, p0, Ln6/n0;->q1:Lcom/android/camera/r2;

    invoke-virtual {v2}, Lcom/android/camera/e5;->k()I
...
.method public bridge synthetic r(Landroid/hardware/camera2/CaptureResult;Ld6/b5;Lcom/android/camera2/a;)V
    .locals 0
