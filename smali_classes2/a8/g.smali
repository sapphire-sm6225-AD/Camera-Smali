...
.method public constructor <init>(La8/g$a;)V
    ...
    invoke-static {p1}, La8/g$a;->z(La8/g$a;)Landroid/net/Uri;

    move-result-object v0

    iput-object v0, p0, La8/g;->r:Landroid/net/Uri;

    invoke-static {p1}, La8/g$a;->A(La8/g$a;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, La8/g;->t:Ljava/lang/String;

    invoke-static {p1}, La8/g$a;->B(La8/g$a;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, La8/g;->x:Ljava/lang/String;

    invoke-static {p1}, La8/g$a;->C(La8/g$a;)Z

    move-result v0

    iput-boolean v0, p0, La8/g;->u:Z

    invoke-static {p1}, La8/g$a;->D(La8/g$a;)Z

    move-result v0

    iput-boolean v0, p0, La8/g;->w:Z

    invoke-static {p1}, La8/g$a;->E(La8/g$a;)Z

    move-result v0

    iput-boolean v0, p0, La8/g;->y:Z

    invoke-static {p1}, La8/g$a;->F(La8/g$a;)I

    move-result p1

    iput p1, p0, La8/g;->Y:I

    return-void
.end method

.method public static synthetic s(La8/g;Lcom/android/camera/k5;)V
    .locals 0

    invoke-direct {p0, p1}, La8/g;->v(Lcom/android/camera/k5;)V

    return-void
.end method

.method public static synthetic t(La8/g;Landroid/net/Uri;Lcom/android/camera/k5;)V
    .locals 0

    invoke-direct {p0, p1, p2}, La8/g;->u(Landroid/net/Uri;Lcom/android/camera/k5;)V
...
.method public m()V
    ...
    iget-object v1, v0, La8/g;->r:Landroid/net/Uri;
    ...
    iget-boolean v9, v0, La8/g;->y:Z

    iget-object v10, v0, La8/a;->o:Ljava/lang/String;

    iget-object v11, v0, La8/a;->i:Ldd/a0;
    ...
    invoke-static/range {v5 .. v17}, Lcom/android/camera/d3;->l(Ldd/h;[BJZLjava/lang/String;Ldd/a0;IIILandroid/location/Location;Landroid/hardware/camera2/impl/CameraMetadataNative;Z)[B
    ...
    :goto_1
    iget-object v10, v0, La8/g;->r:Landroid/net/Uri;
    ...
    iget-object v11, v0, La8/g;->t:Ljava/lang/String;
    ...
    iget-object v2, v0, La8/g;->x:Ljava/lang/String;

    move-object/from16 v16, v2

    invoke-static/range {v6 .. v16}, La8/x;->n0(Landroid/content/Context;[BZZLandroid/net/Uri;Ljava/lang/String;Landroid/location/Location;IIILjava/lang/String;)Landroid/net/Uri;
    ...
    iget-object v6, v0, La8/g;->t:Ljava/lang/String;
    ...
    iput-object v1, v0, La8/g;->r:Landroid/net/Uri;
    ...
    invoke-virtual/range {p0 .. p0}, La8/g;->isFinal()Z

    move-result v2

    invoke-interface {v1, v2}, La8/q;->a(Z)Z
    ...
    :goto_3
    iget-object v2, v0, La8/g;->r:Landroid/net/Uri;
    ...
    iget-boolean v8, v0, La8/g;->w:Z

    invoke-static {v2, v7, v1, v6, v8}, Lcom/android/camera/k5;->e([BIILandroid/net/Uri;Z)Lcom/android/camera/k5;
    ...
    invoke-virtual {v1, v7, v8}, Lcom/android/camera/k5;->L(J)V

    iget-object v2, v0, La8/b;->b:La8/q;

    const/4 v7, 0x1

    invoke-interface {v2, v1, v7}, La8/q;->l(Lcom/android/camera/k5;Z)V
    ...
    :cond_8
    invoke-virtual {v1}, Lcom/android/camera/k5;->n()Landroid/graphics/Bitmap;
    ...
    iget-object v7, v0, La8/g;->r:Landroid/net/Uri;

    invoke-direct {v2, v7}, Lcom/android/camera/litegallery/b$b;-><init>(Landroid/net/Uri;)V
    ...
    :goto_7
    invoke-virtual {v2, v7}, Lcom/android/camera/litegallery/b$b;->e(Z)Lcom/android/camera/litegallery/b$b;
    ...
    :cond_a
    invoke-virtual {v2, v5}, Lcom/android/camera/litegallery/b$b;->i(Landroid/graphics/Bitmap;)Lcom/android/camera/litegallery/b$b;
    ...
    :goto_8
    invoke-virtual {v2, v1}, Lcom/android/camera/litegallery/b$b;->g(Z)Lcom/android/camera/litegallery/b$b;

    move-result-object v1

    iget-object v2, v0, La8/g;->t:Ljava/lang/String;

    iget-boolean v5, v0, La8/a;->n:Z

    invoke-static {v2, v5, v4, v4}, La6/d1;->c(Ljava/lang/String;ZZZ)I
    ...
    invoke-direct {v2, v0, v6}, La8/e;-><init>(La8/g;Landroid/net/Uri;)V

    invoke-interface {v1, v2}, La8/q;->b(Ljava/util/function/Consumer;)V
    ...
    invoke-virtual {v1, v4}, Lcom/android/camera/litegallery/b$b;->j(I)Lcom/android/camera/litegallery/b$b;
    ...
    iget-object v8, v0, La8/g;->t:Ljava/lang/String;
    ...
    iget-object v5, v0, La8/a;->d:Ldd/x;
    ...
    invoke-static {v2}, La8/x;->S(Ljava/lang/String;)Z
    ...
    invoke-direct {v2, v0}, La8/f;-><init>(La8/g;)V
...
.method public onFinish()V
    ...
    invoke-virtual {v1, v2}, Lb7/n;->t([Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, La8/g;->getSize()I
...
.method public run()V
    ...
    invoke-virtual {p0}, La8/g;->m()V

    invoke-virtual {p0}, La8/g;->onFinish()V
