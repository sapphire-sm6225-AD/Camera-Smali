...
# direct methods
.method public constructor <init>(La8/m$b;)V
    .locals 2
    ...
    .line 3
    invoke-static {p1}, La8/m$b;->z(La8/m$b;)J

    move-result-wide v0

    iput-wide v0, p0, La8/m;->r:J

    .line 4
    invoke-static {p1}, La8/m$b;->A(La8/m$b;)Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, La8/m;->t:Ljava/lang/String;

    return-void
.end method

.method public synthetic constructor <init>(La8/m$b;La8/m$a;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, La8/m;-><init>(La8/m$b;)V

    return-void
.end method

.method public static synthetic s(La8/m;Landroid/net/Uri;Lcom/android/camera/k5;)V
    .locals 0

    invoke-direct {p0, p1, p2}, La8/m;->w(Landroid/net/Uri;Lcom/android/camera/k5;)V

    return-void
.end method

.method public static synthetic t(Landroid/net/Uri;[BLcom/android/camera/k5;)V
    .locals 0

    invoke-static {p0, p1, p2}, La8/m;->v(Landroid/net/Uri;[BLcom/android/camera/k5;)V

    return-void
.end method

.method public static synthetic v(Landroid/net/Uri;[BLcom/android/camera/k5;)V
    .locals 1
...
.method private synthetic w(Landroid/net/Uri;Lcom/android/camera/k5;)V
    .locals 1
...
.method public m()V
    ...
    iget-object v1, v0, La8/a;->d:Ldd/x;

    invoke-static {v1}, Lcom/android/camera2/compat/theme/custom/cv/cvwatermark/CvWatermarkUtil;->processWatermark(Ldd/x;)V

    invoke-virtual/range {p0 .. p0}, La8/a;->k()V

    iget-object v1, v0, La8/b;->b:La8/q;

    invoke-interface {v1}, La8/q;->e()V

    iget-object v1, v0, La8/a;->e:[B

    if-eqz v1, :cond_18

    iget-object v1, v0, La8/m;->t:Ljava/lang/String;
    ...
    iget-object v3, v0, La8/m;->t:Ljava/lang/String;
    ...
    iget-object v4, v0, La8/m;->t:Ljava/lang/String;
    ...
    iget-object v7, v0, La8/m;->t:Ljava/lang/String;

    invoke-static {v7}, Lcom/android/camera/c6;->e1(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v7

    invoke-static {v7}, La8/x;->S(Ljava/lang/String;)Z
    ...
    iget-object v10, v0, La8/m;->t:Ljava/lang/String;
    ...
    iget-object v9, v0, La8/m;->t:Ljava/lang/String;
    ...
    iget-object v9, v0, La8/a;->d:Ldd/x;

    iget-object v10, v0, La8/a;->e:[B

    invoke-virtual {v9, v10}, Ldd/x;->v([B)Lwb/e;

    move-result-object v9

    invoke-virtual {v9}, Lwb/e;->I()I
    ...
    invoke-static {v5, v6}, Lwd/a;->g(J)Landroid/net/Uri;
    ...
    iget-object v6, v0, La8/m;->t:Ljava/lang/String;

    invoke-static {v5, v3, v6}, La8/x;->B(Landroid/content/Context;ZLjava/lang/String;)Landroid/net/Uri;
    ...
    iget-object v6, v0, La8/a;->d:Ldd/x;

    if-eqz v6, :cond_5

    invoke-virtual {v6}, Ldd/x;->q()I
    ...
    invoke-virtual {v0, v4, v9, v5}, La8/m;->u(Ljava/lang/String;ILandroid/net/Uri;)Z
    ...
    invoke-virtual/range {p0 .. p0}, La8/a;->c()Ldd/h;
    ...
    iget-object v3, v0, La8/a;->i:Ldd/a0;
    ...
    invoke-static/range {v10 .. v22}, Lcom/android/camera/d3;->l(Ldd/h;[BJZLjava/lang/String;Ldd/a0;IIILandroid/location/Location;Landroid/hardware/camera2/impl/CameraMetadataNative;Z)[B
    ...
    invoke-static/range {v10 .. v20}, La8/x;->n0(Landroid/content/Context;[BZZLandroid/net/Uri;Ljava/lang/String;Landroid/location/Location;IIILjava/lang/String;)Landroid/net/Uri;
    ...
    invoke-virtual {v0, v9, v4, v3, v5}, La8/m;->y(ILjava/lang/String;Landroid/net/Uri;[B)V

    goto :goto_2

    :cond_7
    iget-object v5, v0, La8/b;->b:La8/q;
    ...
    invoke-interface/range {v16 .. v21}, La8/q;->j(Landroid/net/Uri;ZLjava/lang/String;IZ)V

    :goto_2
    iget-object v4, v0, La8/b;->b:La8/q;

    new-instance v5, La8/k;

    invoke-direct {v5, v0, v3}, La8/k;-><init>(La8/m;Landroid/net/Uri;)V

    invoke-interface {v4, v5}, La8/q;->b(Ljava/util/function/Consumer;)V

    :cond_8
    iget-object v3, v0, La8/b;->a:Landroid/content/Context;

    invoke-static {v3, v2}, Lwd/a;->k(Landroid/content/Context;Ld1/b;)V
    ...
    invoke-static {v10}, Lcom/android/camera/c6;->e1(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v10, v11}, Lcom/android/camera/c6;->Y(J)Ljava/lang/String;
    ...
    iget-object v6, v0, La8/a;->i:Ldd/a0;
    ...
    invoke-static/range {v10 .. v21}, La8/x;->d(Landroid/content/Context;Ljava/lang/String;JLandroid/location/Location;I[BZIIZZ)Landroid/net/Uri;

    move-result-object v3

    if-eqz v3, :cond_15

    invoke-static/range {v23 .. v23}, La8/x;->S(Ljava/lang/String;)Z
    ...
    invoke-static {v10, v9, v4, v3, v11}, Lcom/android/camera/k5;->e([BIILandroid/net/Uri;Z)Lcom/android/camera/k5;
    ...
    :goto_9
    invoke-virtual {v4, v10, v11}, Lcom/android/camera/k5;->L(J)V

    iget-object v10, v0, La8/b;->b:La8/q;

    const/4 v11, 0x1

    invoke-interface {v10, v4, v11}, La8/q;->l(Lcom/android/camera/k5;Z)V
    ...
    invoke-static {v4, v2}, Lwd/a;->k(Landroid/content/Context;Ld1/b;)V

    iget-object v2, v0, La8/b;->b:La8/q;

    invoke-interface {v2, v3}, La8/q;->g(Landroid/net/Uri;)V
    ...
    invoke-static {v4, v9, v2, v3, v5}, Lcom/android/camera/k5;->e([BIILandroid/net/Uri;Z)Lcom/android/camera/k5;
    ...
    :goto_c
    invoke-virtual {v2, v5, v6}, Lcom/android/camera/k5;->L(J)V

    iget-object v4, v0, La8/b;->b:La8/q;

    invoke-interface {v4, v2, v11}, La8/q;->l(Lcom/android/camera/k5;Z)V
    ...
    iget-object v8, v0, La8/m;->t:Ljava/lang/String;
    ...
    invoke-static/range {v5 .. v18}, Lwd/a;->j(Landroid/content/Context;JLjava/lang/String;Ljava/lang/String;JLjava/lang/String;JIIILjava/lang/String;)V
    ...
    :cond_16
    :goto_d
    iget-object v2, v0, La8/a;->d:Ldd/x;
    ...
    iget-object v0, v0, La8/a;->d:Ldd/x;
...
.method public onFinish()V
    ...
    iget-object v4, p0, La8/a;->d:Ldd/x;

    invoke-virtual {v4}, Ldd/x;->m()J
    ...
    invoke-virtual {v0, v2}, Lb7/n;->t([Ljava/lang/String;)V
    ...
    iget-object v1, p0, La8/a;->d:Ldd/x;

    invoke-virtual {v1}, Ldd/x;->v0()V
...
.method public run()V
    ...
    invoke-virtual {p0}, La8/m;->m()V

    invoke-virtual {p0}, La8/m;->onFinish()V
...
.method public final u(Ljava/lang/String;ILandroid/net/Uri;)Z
    ...
    invoke-virtual {v0}, Ldd/x;->u()Lda/h$a;
    ...
    invoke-virtual {v0}, Ldd/x;->F()Ljava/lang/String;
    ...
    invoke-virtual/range {v1 .. v7}, La8/m;->x(IILda/h$a;Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;)Z
...
.method public final x(IILda/h$a;Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;)Z
    .locals 26
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "isSupportAnchorFrame"
    ...
    invoke-virtual/range {p3 .. p3}, Lda/h$a;->c()Lda/x;

    move-result-object v1

    invoke-virtual/range {p3 .. p3}, Lda/h$a;->b()[F

    move-result-object v6

    invoke-virtual/range {p3 .. p3}, Lda/h$a;->a()Ljava/lang/String;
    ...
    invoke-virtual {v7, v1}, Lwb/e;->K0([B)V
    ...
    invoke-virtual {v7, v1, v2}, Lwb/e;->E0(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v1, v2}, Lwb/e;->w(Ljava/io/OutputStream;[B)Ljava/io/OutputStream;

    move-result-object v2

    sget-object v3, Landroid/graphics/Bitmap$CompressFormat;->JPEG:Landroid/graphics/Bitmap$CompressFormat;

    sget-object v4, Lcom/android/camera/c3;->e:Lcom/android/camera/c3;

    const/4 v5, 0x0

    invoke-virtual {v4, v5}, Lcom/android/camera/c3;->b(Z)I
    ...
    invoke-static/range {v16 .. v21}, La8/x;->g([BJ[FLjava/lang/String;Ljava/lang/String;)[B
    ...
    invoke-static/range {v1 .. v11}, La8/x;->n0(Landroid/content/Context;[BZZLandroid/net/Uri;Ljava/lang/String;Landroid/location/Location;IIILjava/lang/String;)Landroid/net/Uri;
    ...
    invoke-virtual {v0, v13, v14, v1, v12}, La8/m;->y(ILjava/lang/String;Landroid/net/Uri;[B)V

    :cond_4
    iget-object v0, v0, La8/b;->b:La8/q;
...
.method public final y(ILjava/lang/String;Landroid/net/Uri;[B)V
    ...
    :cond_0
    invoke-static {p4, p1, v0, p3, v2}, Lcom/android/camera/k5;->e([BIILandroid/net/Uri;Z)Lcom/android/camera/k5;
    ...
    invoke-virtual {p1, v0, v1}, Lcom/android/camera/k5;->L(J)V

    iget-object p4, p0, La8/b;->b:La8/q;

    invoke-interface {p4, p1, v2}, La8/q;->l(Lcom/android/camera/k5;Z)V

    :cond_1
    iget-object v3, p0, La8/b;->b:La8/q;
    ...
    invoke-interface/range {v3 .. v8}, La8/q;->j(Landroid/net/Uri;ZLjava/lang/String;IZ)V
