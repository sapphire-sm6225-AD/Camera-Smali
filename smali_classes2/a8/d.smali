...
# direct methods
.method public constructor <init>(Landroid/media/Image;Landroid/hardware/camera2/CaptureResult;Ldd/x;La8/d$a;Landroid/os/Handler;)V
    .locals 0
    ...
    iput-object p1, p0, La8/d;->c:Landroid/media/Image;

    iput-object p2, p0, La8/d;->d:Landroid/hardware/camera2/CaptureResult;

    iput-object p3, p0, La8/d;->e:Ldd/x;

    iput-object p4, p0, La8/d;->f:La8/d$a;

    iput-object p5, p0, La8/d;->g:Landroid/os/Handler;

    invoke-virtual {p3}, Ldd/x;->s()Ldd/y;
    ...
    :goto_0
    iget p1, p0, La8/d;->h:I

    iget p2, p0, La8/d;->i:I
...
.method public final a(Landroid/hardware/camera2/CaptureResult;IIIJLandroid/location/Location;)[B
    ...
    :try_start_0
    invoke-static/range {v1 .. v11}, Lcom/android/camera/d3;->e(IIIJLandroid/location/Location;Landroid/hardware/camera2/CaptureResult;JLwb/e;Z)V
    :try_end_0
    ...
    invoke-virtual {v0, v2}, Lwb/e;->v(Ljava/io/OutputStream;)Ljava/io/OutputStream;

    move-result-object v0

    instance-of v3, v0, Lwb/g;
...
.method public final b(Landroid/media/Image;Landroid/util/Size;)[B
    ...
    invoke-static {p1, p0}, Lcom/android/camera/c6;->b2(Landroid/media/Image;[I)[B
    ...
    invoke-static {v4, v1, v3}, Lzj/g;->e(Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0, v1, v3}, Lzj/g;->e(Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
...
.method public final c(Landroid/media/Image;[BZLjava/lang/String;JILjava/lang/String;IILandroid/location/Location;I)Landroid/net/Uri;
    ...
    iget-object v5, v0, La8/d;->g:Landroid/os/Handler;
    ...
    invoke-virtual/range {v0 .. v8}, La8/d;->d(Landroid/media/Image;[BLjava/lang/String;Ljava/io/FileDescriptor;Landroid/os/Handler;III)Z
    ...
    iget-object v1, v0, La8/d;->e:Ldd/x;
    ...
    iget-object v6, v0, La8/d;->g:Landroid/os/Handler;
    ...
    invoke-virtual/range {v0 .. v9}, La8/d;->e(Landroid/media/Image;[BLjava/lang/String;Ljava/io/FileDescriptor;Landroid/util/Size;Landroid/os/Handler;III)Z

    move-result v0

    :goto_2
    invoke-static {v12}, Lzm/f;->a(Ljava/io/Closeable;)V
...
.method public final d(Landroid/media/Image;[BLjava/lang/String;Ljava/io/FileDescriptor;Landroid/os/Handler;III)Z
    ...
    :goto_0
    iget-object p4, p0, La8/d;->e:Ldd/x;

    invoke-virtual {p4}, Ldd/x;->s()Ldd/y;

    move-result-object p4

    invoke-virtual {p4}, Ldd/y;->m0()I
    ...
    invoke-virtual {p3}, Laa/d;->j()Landroid/view/Surface;
    ...
    iput-object p4, p0, La8/d;->k:Landroid/media/ImageWriter;

    invoke-virtual {p3}, Laa/d;->n()V
    ...
    iget-object p4, p0, La8/d;->k:Landroid/media/ImageWriter;
    ...
    invoke-virtual {p3, p4, p5}, Laa/d;->o(J)V
    ...
    :goto_2
    iget-object p2, p0, La8/d;->k:Landroid/media/ImageWriter;
    ...
    iput-object p2, p0, La8/d;->k:Landroid/media/ImageWriter;
...
.method public final e(Landroid/media/Image;[BLjava/lang/String;Ljava/io/FileDescriptor;Landroid/util/Size;Landroid/os/Handler;III)Z
    ...
    invoke-virtual {p0, p1, p5}, La8/d;->b(Landroid/media/Image;Landroid/util/Size;)[B
...
.method public m()V
    ...
    iget-object v0, v14, La8/d;->e:Ldd/x;

    invoke-virtual {v0}, Ldd/x;->M()Ljava/lang/String;

    move-result-object v15

    invoke-static {v15}, Lcom/android/camera/c6;->e1(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v13

    iget-object v0, v14, La8/d;->e:Ldd/x;

    invoke-virtual {v0}, Ldd/x;->t()J
    ...
    iget-object v2, v14, La8/d;->d:Landroid/hardware/camera2/CaptureResult;

    iget v3, v14, La8/d;->h:I

    iget v4, v14, La8/d;->i:I
    ...
    invoke-virtual/range {v1 .. v8}, La8/d;->a(Landroid/hardware/camera2/CaptureResult;IIIJLandroid/location/Location;)[B
    ...
    invoke-static {v13, v5}, La8/x;->m(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-static {v4, v11, v15}, La8/x;->B(Landroid/content/Context;ZLjava/lang/String;)Landroid/net/Uri;
    ...
    iget-object v2, v14, La8/d;->c:Landroid/media/Image;

    iget v1, v14, La8/d;->h:I

    iget v11, v14, La8/d;->i:I
    ...
    invoke-virtual/range {v1 .. v13}, La8/d;->c(Landroid/media/Image;[BZLjava/lang/String;JILjava/lang/String;IILandroid/location/Location;I)Landroid/net/Uri;
    ...
    :try_start_0
    invoke-static {v0, v15}, Lcom/android/camera/e3;->j(Ljava/lang/String;Ljava/lang/String;)Z
    :try_end_0
    ...
    iget v7, v13, La8/d;->h:I

    iget v8, v13, La8/d;->i:I
    ...
    invoke-static/range {v1 .. v8}, La8/x;->m0(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;Landroid/location/Location;III)Landroid/net/Uri;
    ...
    invoke-static {v0, v6}, Lwd/a;->k(Landroid/content/Context;Ld1/b;)V
    ...
    iget-object v2, v13, La8/d;->c:Landroid/media/Image;

    iget v0, v13, La8/d;->h:I

    iget v5, v13, La8/d;->i:I
    ...
    invoke-static {v0, v6, v15}, Lcom/android/camera/k5;->f(Landroid/content/Context;Landroid/net/Uri;Z)Lcom/android/camera/k5;

    move-result-object v0

    if-eqz v0, :cond_3

    iget-object v1, v14, La8/b;->b:La8/q;

    const/4 v2, 0x1

    invoke-interface {v1, v0, v2}, La8/q;->l(Lcom/android/camera/k5;Z)V

    goto :goto_4

    :cond_3
    iget-object v0, v14, La8/b;->b:La8/q;
    ...
    invoke-interface/range {v0 .. v5}, La8/q;->j(Landroid/net/Uri;ZLjava/lang/String;IZ)V
    ...
    invoke-static {v0, v1}, Lwd/a;->k(Landroid/content/Context;Ld1/b;)V
...
.method public onFinish()V
    ...
    iget-object v0, p0, La8/d;->f:La8/d$a;

    iget-object v1, p0, La8/d;->c:Landroid/media/Image;

    iget-object v2, p0, La8/d;->e:Ldd/x;

    invoke-interface {v0, v1, v2}, La8/d$a;->a(Landroid/media/Image;Ldd/x;)V

    iget-object v0, p0, La8/d;->e:Ldd/x;
    ...
    iget-object v5, p0, La8/d;->e:Ldd/x;

    invoke-virtual {v5}, Ldd/x;->m()J
    ...
    iget-object v1, p0, La8/d;->e:Ldd/x;

    invoke-virtual {v1}, Ldd/x;->m()J
    ...
    invoke-virtual {v2, v3}, Lb7/n;->t([Ljava/lang/String;)V

    invoke-static {}, Lwb/d;->a()V

    const/4 v0, 0x0

    iput-object v0, p0, La8/d;->c:Landroid/media/Image;

    iput-object v0, p0, La8/d;->e:Ldd/x;

    iput-object v0, p0, La8/d;->f:La8/d$a;

    iput-object v0, p0, La8/d;->d:Landroid/hardware/camera2/CaptureResult;

    iput-object v0, p0, La8/d;->g:Landroid/os/Handler;

    iget-object v1, p0, La8/b;->b:La8/q;

    invoke-virtual {p0}, La8/d;->getSize()I

    move-result v2

    invoke-interface {v1, v2}, La8/q;->m(I)V

    iput-object v0, p0, La8/b;->b:La8/q;
...
.method public run()V
    ...
    invoke-virtual {p0}, La8/d;->m()V

    invoke-virtual {p0}, La8/d;->onFinish()V
