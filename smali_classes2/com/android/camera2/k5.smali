...
# direct methods
.method public constructor <init>(Lcom/android/camera2/g4;Landroid/hardware/camera2/CaptureResult;)V
    .locals 1

    const/4 v0, 0x0

    .line 1
    invoke-direct {p0, p1, p2, v0}, Lcom/android/camera2/k5;-><init>(Lcom/android/camera2/g4;Landroid/hardware/camera2/CaptureResult;Lp6/a;)V
...
.method public constructor <init>(Lcom/android/camera2/g4;Landroid/hardware/camera2/CaptureResult;Lp6/a;)V
    ...
    .line 3
    iput-object p2, p0, Lcom/android/camera2/k5;->g:Landroid/hardware/camera2/CaptureResult;

    .line 4
    invoke-virtual {p0}, Lcom/android/camera2/k5;->k()Z

    move-result p1

    iput-boolean p1, p0, Lcom/android/camera2/u4;->mAnchorFrame:Z

    .line 5
    iput-object p3, p0, Lcom/android/camera2/k5;->h:Lp6/a;
    ...
    iget-object p0, p0, Lcom/android/camera2/k5;->h:Lp6/a;

    invoke-virtual {p1, p0}, Lcom/android/camera2/g4;->H4(Lp6/a;)V

    :cond_0
    return-void
.end method

.method public static synthetic d(Lcom/android/camera2/k5;)Ldd/x;
    .locals 0

    iget-object p0, p0, Lcom/android/camera2/k5;->b:Ldd/x;

    return-object p0
.end method

.method public static synthetic e(Lcom/android/camera2/k5;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/camera2/k5;->f:Z

    return p0
.end method

.method public static synthetic f(Lcom/android/camera2/k5;)Landroid/hardware/camera2/TotalCaptureResult;
    .locals 0

    iget-object p0, p0, Lcom/android/camera2/k5;->d:Landroid/hardware/camera2/TotalCaptureResult;

    return-object p0
.end method

.method public static synthetic g(Lcom/android/camera2/k5;Landroid/hardware/camera2/TotalCaptureResult;)Landroid/hardware/camera2/TotalCaptureResult;
    .locals 0

    iput-object p1, p0, Lcom/android/camera2/k5;->d:Landroid/hardware/camera2/TotalCaptureResult;

    return-object p1
.end method

.method public static synthetic h(Lcom/android/camera2/k5;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/camera2/k5;->e:Z

    return p0
.end method

.method public static synthetic i(Lcom/android/camera2/k5;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/camera2/k5;->c:Z

    return p0
.end method

.method public static synthetic j(Lcom/android/camera2/k5;Ldd/x;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;)V
    .locals 0

    invoke-virtual {p0, p1, p2, p3}, Lcom/android/camera2/k5;->m(Ldd/x;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;)V
...
.method public generateRequestBuilder()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-virtual {v1}, Lcom/android/camera2/n5;->j0()Landroid/view/Surface;
    ...
    iget-object v2, p0, Lcom/android/camera2/k5;->b:Ldd/x;

    invoke-virtual {v2, v1}, Ldd/x;->U0(Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Lcom/android/camera2/g4;->J()I
    ...
    :cond_5
    iget-boolean v1, p0, Lcom/android/camera2/k5;->a:Z
    ...
    iget-object v1, v1, Lcom/android/camera2/n5;->o:Landroid/media/ImageReader;
    ...
    iget-object v1, v1, Lcom/android/camera2/n5;->p:Landroid/media/ImageReader;
    ...
    iget-object v2, p0, Lcom/android/camera2/k5;->g:Landroid/hardware/camera2/CaptureResult;
    ...
    invoke-virtual {v1}, Lsb/c;->S1()Ljava/util/List;
...
.method public final k()Z
    ...
    invoke-virtual {v0}, Lcom/android/camera2/g4;->A3()Z
...
.method public l(Ldd/x;)V
    .locals 1

    const/4 v0, 0x0

    invoke-virtual {p0, p1, v0, v0}, Lcom/android/camera2/k5;->m(Ldd/x;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;)V

    return-void
.end method

.method public final m(Ldd/x;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;)V
    .locals 6
    ...
    iget-object v4, p0, Lcom/android/camera2/k5;->b:Ldd/x;

    iget v5, p0, Lcom/android/camera2/u4;->mPreviewThumbnailHash:I

    invoke-virtual {v4, v5}, Ldd/x;->h1(I)V
    ...
    invoke-interface {v0, p1, p2, p3, v4}, Ldd/o;->k(Ldd/x;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
...
.method public bridge synthetic notifyResultData(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera2/k5;->l(Ldd/x;)V
...
.method public onImageReceived(Landroid/media/Image;I)V
    ...
    invoke-virtual {v2, v4, p0}, Lcom/android/camera2/g4;->I4(ZLcom/android/camera2/u4;)V

    :cond_1
    iget-object v2, p0, Lcom/android/camera2/k5;->d:Landroid/hardware/camera2/TotalCaptureResult;
    ...
    invoke-interface {v0, v4, p0, p1, v1}, Lcom/android/camera2/a$m;->l9(ZJI)V
    ...
    invoke-virtual {v2, v5, v6}, Ldd/x;->u1(J)V
    ...
    invoke-virtual {v2, p2}, Ldd/x;->W(I)Z
    ...
    iget-object v5, p0, Lcom/android/camera2/k5;->b:Ldd/x;
    ...
    iget-object p1, p0, Lcom/android/camera2/k5;->b:Ldd/x;

    invoke-virtual {p1, v3, p2}, Ldd/x;->a([BI)V

    if-eqz v2, :cond_7

    iget-object p1, p0, Lcom/android/camera2/k5;->b:Ldd/x;

    invoke-virtual {p1, v2}, Ldd/x;->O0([B)V
    ...
    invoke-virtual {p1}, Ldd/y;->m0()I

    move-result v3

    invoke-static {p2, v2, v3}, Lh9/b;->j(III)Landroid/graphics/Rect;
    ...
    invoke-virtual {p1, p2}, Ldd/x;->L0(Landroid/graphics/Rect;)V

    :cond_7
    iget-boolean p1, p0, Lcom/android/camera2/k5;->e:Z
    ...
    invoke-virtual {p1, v2}, Ldd/x;->b0(Ljava/lang/String;)Z

    move-result p1

    if-eqz p1, :cond_8

    iget-object p1, p0, Lcom/android/camera2/k5;->d:Landroid/hardware/camera2/TotalCaptureResult;
    ...
    iget-boolean p1, p0, Lcom/android/camera2/k5;->c:Z
    ...
    invoke-interface {v0, v4, p1, p2, v1}, Lcom/android/camera2/a$m;->l9(ZJI)V

    :cond_c
    iget-object p1, p0, Lcom/android/camera2/k5;->b:Ldd/x;

    iget-object p2, p0, Lcom/android/camera2/k5;->d:Landroid/hardware/camera2/TotalCaptureResult;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/android/camera2/k5;->m(Ldd/x;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;)V
...
.method public prepare()V
    ...
    invoke-virtual {v0}, Lcom/android/camera2/g4;->t()Lcom/android/camera2/g3;
    ...
    :cond_1
    iput-boolean v1, p0, Lcom/android/camera2/k5;->a:Z

    goto :goto_0

    :cond_2
    iput-boolean v1, p0, Lcom/android/camera2/k5;->e:Z

    iput-boolean v1, p0, Lcom/android/camera2/k5;->f:Z

    goto :goto_0

    :cond_3
    iput-boolean v1, p0, Lcom/android/camera2/k5;->c:Z
...
.method public startSessionCapture()V
    ...
    :try_start_0
    invoke-virtual {p0, v0, v1}, Lcom/android/camera2/u4;->generateParallelTaskData(J)Ldd/x;

    move-result-object v0

    iput-object v0, p0, Lcom/android/camera2/k5;->b:Ldd/x;
    ...
    invoke-virtual {v0, v1}, Ldd/x;->s1(Z)Z

    iget-object v0, p0, Lcom/android/camera2/k5;->b:Ldd/x;
    ...
    invoke-virtual {v0, v1}, Ldd/x;->V0(Z)Z
    ...
    invoke-static {v0}, Lcom/android/camera/c6;->e1(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/camera2/k5;->b:Ldd/x;

    invoke-virtual {v1, v0}, Ldd/x;->q1(Z)V
