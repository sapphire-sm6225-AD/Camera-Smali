...
.method private static buildExif(Lwb/e;Landroid/hardware/camera2/CaptureResult;IILcom/android/camera2/compat/theme/custom/cv/cvwatermark/CvWatermarkParam;)Lwb/e;
    .locals 11
    ...
    invoke-static/range {v0 .. v10}, Lcom/android/camera/d3;->e(IIIJLandroid/location/Location;Landroid/hardware/camera2/CaptureResult;JLwb/e;Z)V
    ...
    invoke-static {p0, p2, p3, v0, p4}, Lcom/android/camera/d3;->b(Lwb/e;JIS)V

    invoke-static {p1, p0}, Lcom/android/camera/d3;->d(Landroid/hardware/camera2/CaptureResult;Lwb/e;)V
    :try_end_0
...
.method private static composeXmpMeta(Lcom/android/camera2/compat/theme/custom/cv/cvwatermark/CvWatermarkParam;)Lc/g;
    .locals 5
    ...
    invoke-static {v0, v2, v3, v4, p0}, Lcom/android/camera/j6;->a(Lorg/xmlpull/v1/XmlSerializer;ILandroid/graphics/Rect;ZZ)V
    ...
    invoke-interface {v0, v1, v2, p0}, Lc/g;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static dumpYuv(Ljava/lang/String;Ljava/lang/String;[BII)V
    ...
    invoke-static {p2, v3}, Lcom/android/camera/c6;->s4([BLjava/lang/String;)V
    ...
    invoke-static {p0, p1}, Lcom/android/camera/c6;->s4([BLjava/lang/String;)V
...
.method private static exifToArray(Lwb/e;[B)[B
    .locals 6
    ...
    :try_start_1
    invoke-virtual {p0, v2, p1}, Lwb/e;->w(Ljava/io/OutputStream;[B)Ljava/io/OutputStream;
    ...
    invoke-virtual {p1}, Lwb/g;->g()V

    move-object p1, p0

    check-cast p1, Lwb/g;

    invoke-virtual {p1}, Lwb/g;->h()V
...
.method public static processPreviewWatermark(Ldd/x;)V
    .locals 5
    ...
    invoke-virtual {v3}, Ldd/y;->o0()Landroid/location/Location;
    ...
    invoke-virtual {p0}, Ldd/x;->q()I

    move-result v3

    invoke-virtual {v1, v3}, Lsb/c;->G8(I)Z

    move-result v1

    sget-object v3, Lcom/android/camera/c3;->d:Lcom/android/camera/c3;

    invoke-virtual {v3, v2}, Lcom/android/camera/c3;->b(Z)I

    move-result v2

    invoke-static {v0, v2}, Lze/c;->h(Landroid/graphics/Bitmap;I)[B
    ...
    invoke-virtual {v3, v4, v0}, Ldd/y;->e1(II)V

    invoke-virtual {p0, v2}, Ldd/x;->s0([B)V

    iget-object p0, p0, Ldd/x;->l0:Ldd/h;

    invoke-virtual {p0, v1}, Ldd/h;->g(Z)V

    return-void
.end method

.method public static processWatermark(Ldd/x;)V
    .locals 27

    move-object/from16 v6, p0

    invoke-virtual/range {p0 .. p0}, Ldd/x;->s()Ldd/y;
    ...
    invoke-virtual {v2}, Ldd/y;->k0()I

    move-result v2

    invoke-virtual/range {p0 .. p0}, Ldd/x;->l()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {v10}, Ldd/y;->o0()Landroid/location/Location;
    ...
    invoke-virtual/range {p0 .. p0}, Ldd/x;->q()I

    move-result v12

    invoke-virtual {v11, v12}, Lsb/c;->G8(I)Z
    ...
    invoke-virtual {v13}, Ldd/y;->v0()Landroid/util/Size;
    ...
    invoke-virtual/range {p0 .. p0}, Ldd/x;->y()[B

    move-result-object v14

    invoke-virtual/range {p0 .. p0}, Ldd/x;->x()Ljava/lang/String;
    ...
    invoke-virtual {v7}, Ldd/y;->t0()Landroid/util/Size;
    ...
    invoke-static/range {v26 .. v26}, Lcom/android/camera/c6;->j1(I)I
    ...
    invoke-virtual/range {p0 .. p0}, Ldd/x;->t()J
    ...
    invoke-virtual {v1, v2, v4}, Ldd/y;->b1(ILandroid/graphics/Rect;)V
    ...
    invoke-static {v10, v9, v4, v8, v0}, Lcom/android/camera2/compat/theme/custom/cv/cvwatermark/CvWatermarkUtil;->buildExif(Lwb/e;Landroid/hardware/camera2/CaptureResult;IILcom/android/camera2/compat/theme/custom/cv/cvwatermark/CvWatermarkParam;)Lwb/e;

    move-result-object v4

    invoke-static {v0}, Lcom/android/camera2/compat/theme/custom/cv/cvwatermark/CvWatermarkUtil;->composeXmpMeta(Lcom/android/camera2/compat/theme/custom/cv/cvwatermark/CvWatermarkParam;)Lc/g;

    move-result-object v0

    invoke-virtual {v4, v0}, Lwb/e;->M0(Lc/g;)V

    move-object/from16 v11, v24

    invoke-static {v4, v11}, Lcom/android/camera2/compat/theme/custom/cv/cvwatermark/CvWatermarkUtil;->exifToArray(Lwb/e;[B)[B
    ...
    invoke-static/range {v0 .. v5}, Lcom/android/camera2/compat/theme/custom/cv/cvwatermark/CvWatermarkUtil;->saveHeifFile(Ldd/x;[B[BIII)[B
    ...
    invoke-virtual {v3, v5}, Ldd/x;->v([B)Lwb/e;
    ...
    invoke-static {v8, v9, v12, v14, v0}, Lcom/android/camera2/compat/theme/custom/cv/cvwatermark/CvWatermarkUtil;->buildExif(Lwb/e;Landroid/hardware/camera2/CaptureResult;IILcom/android/camera2/compat/theme/custom/cv/cvwatermark/CvWatermarkParam;)Lwb/e;

    invoke-virtual/range {p0 .. p0}, Ldd/x;->B()I
    ...
    invoke-virtual {v8, v0}, Lwb/e;->M0(Lc/g;)V
    ...
    invoke-virtual {v3, v0}, Ldd/x;->s0([B)V
    ...
    :goto_8
    invoke-virtual {v3, v7}, Ldd/x;->a1(Z)V

    return-void
.end method

.method private static saveHeifFile(Ldd/x;[B[BIII)[B
    .locals 10
    ...
    invoke-virtual {p0}, Ldd/x;->M()Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {v5}, Lcom/android/camera/c6;->d1(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p3, p4}, Lsb/c;->G8(I)Z
    ...
    invoke-virtual {p0, p3, p4}, Laa/d;->o(J)V
    ...
    invoke-static {p0}, Lch/b;->h(Ljava/lang/String;)[B
