...
# instance fields
.field private mComponentRunningShine:Lx0/w0;
...
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;Ljava/util/List;III)V
    ...
    .line 4
    invoke-interface {p1}, Lj7/p1;->Ba()Lx0/w0;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera2/compat/theme/custom/mm/beauty/MakeupSingleCheckAdapterMM;->mComponentRunningShine:Lx0/w0;
...
.method public onBindViewHolder(Lcom/android/camera/fragment/beauty/MakeupSingleCheckAdapter$SingleCheckViewHolder;I)V
    ...
    iget-object p0, p0, Lcom/android/camera2/compat/theme/custom/mm/beauty/MakeupSingleCheckAdapterMM;->mComponentRunningShine:Lx0/w0;

    invoke-virtual {p0}, Lx0/w0;->h0()Z
