.class public Lcom/android/camera2/e5;
...
.method public static constructor <clinit>()V
    ...
    invoke-virtual {v0}, Lsb/c;->z1()I

    move-result v0

    sput v0, Lcom/android/camera2/e5;->k:I

    return-void
.end method

.method public constructor <init>(Lcom/android/camera2/g4;ILandroid/view/Surface;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera2/b5;-><init>(Lcom/android/camera2/g4;)V

    const/4 p1, 0x1

    iput-boolean p1, p0, Lcom/android/camera2/e5;->b:Z

    iput p2, p0, Lcom/android/camera2/e5;->e:I

    sget-object p1, Lik/b;->j:Lik/b;

    iput-object p1, p0, Lcom/android/camera2/e5;->h:Lik/b;

    iput-object p3, p0, Lcom/android/camera2/e5;->i:Landroid/view/Surface;
...
.method public static synthetic h()I
    ...
    sget v0, Lcom/android/camera2/e5;->k:I

    return v0
.end method

.method public static synthetic i(Lcom/android/camera2/e5;)I
    .locals 0

    iget p0, p0, Lcom/android/camera2/e5;->g:I

    return p0
.end method

.method public static synthetic j(Lcom/android/camera2/e5;)I
    .locals 2

    iget v0, p0, Lcom/android/camera2/e5;->g:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, Lcom/android/camera2/e5;->g:I

    return v0
.end method

.method public static synthetic k(Lcom/android/camera2/e5;)Lik/b;
    .locals 0

    iget-object p0, p0, Lcom/android/camera2/e5;->h:Lik/b;

    return-object p0
.end method

.method public static synthetic l(Lcom/android/camera2/e5;)I
    .locals 0

    iget p0, p0, Lcom/android/camera2/e5;->d:I

    return p0
.end method

.method public static synthetic m(Lcom/android/camera2/e5;I)I
    .locals 0

    iput p1, p0, Lcom/android/camera2/e5;->d:I

    return p1
.end method

.method public static synthetic n(Lcom/android/camera2/e5;)I
    .locals 0

    iget p0, p0, Lcom/android/camera2/e5;->c:I

    return p0
.end method

.method public static synthetic o(Lcom/android/camera2/e5;)Landroid/hardware/camera2/CaptureResult;
    .locals 0

    iget-object p0, p0, Lcom/android/camera2/e5;->a:Landroid/hardware/camera2/CaptureResult;

    return-object p0
.end method

.method public static synthetic p(Lcom/android/camera2/e5;Landroid/hardware/camera2/CaptureResult;)Landroid/hardware/camera2/CaptureResult;
    .locals 0

    iput-object p1, p0, Lcom/android/camera2/e5;->a:Landroid/hardware/camera2/CaptureResult;

    return-object p1
.end method

.method public static synthetic q(Lcom/android/camera2/e5;ZI)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Lcom/android/camera2/e5;->onRepeatingEnd(ZI)V
...
.method public generateCaptureCallback()Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;
    ...
    new-instance v0, Lcom/android/camera2/e5$a;

    invoke-direct {v0, p0}, Lcom/android/camera2/e5$a;-><init>(Lcom/android/camera2/e5;)V
...
.method public generateRequestBuilder()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-virtual {v8}, Lcom/android/camera2/n5;->V()Landroid/view/Surface;
    ...
    invoke-virtual {v8}, Lcom/android/camera2/n5;->W()Landroid/view/Surface;
    ...
    invoke-virtual {v8}, Lcom/android/camera2/n5;->L()Landroid/view/Surface;
    ...
    invoke-virtual {v8}, Lcom/android/camera2/n5;->f0()Landroid/view/Surface;
    ...
    invoke-virtual {v1}, Lcom/android/camera2/h3;->J0()Lcom/android/camera/u2;

    move-result-object v1

    iput-object v1, p0, Lcom/android/camera2/b5;->mAlgoSize:Lcom/android/camera/u2;
    ...
    iget v7, p0, Lcom/android/camera2/u4;->mSatCameraId:I

    iget-object v8, p0, Lcom/android/camera2/u4;->mMiCamera:Lcom/android/camera2/g4;

    invoke-virtual {v8}, Lcom/android/camera2/g4;->n4()Z

    move-result v8

    invoke-virtual {v3, v7, v8}, Lcom/android/camera2/n5;->G(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {v1}, Lcom/android/camera2/n5;->h0()Landroid/view/Surface;
    ...
    invoke-virtual {p0, v7, v3, v1}, Lcom/android/camera2/b5;->configParallelSession(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;

    move-result-object v1

    iput-object v1, p0, Lcom/android/camera2/b5;->mBufferFormat:Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-virtual {v1}, Lcom/android/camera2/n5;->f0()Landroid/view/Surface;
    ...
    invoke-virtual {v3, v0, v5}, Lcom/android/camera2/g4;->c3(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    invoke-static {v3}, Lcom/android/camera2/g;->n7(Lcom/android/camera2/f;)Z
...
.method public bridge synthetic notifyResultData(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera2/e5;->r([B)V
...
.method public final onRepeatingEnd(ZI)V
    ...
    invoke-virtual {v0}, Lcom/android/camera2/g4;->A0()I
    ...
    invoke-interface {p2, p1, v2, v3, v1}, Lcom/android/camera2/a$m;->l9(ZJI)V
    ...
    invoke-virtual {p2, p1, p0}, Lcom/android/camera2/g4;->q0(ZLcom/android/camera2/u4;)V
...
.method public startSessionCapture()V
    ...
    iget v0, p0, Lcom/android/camera2/e5;->f:I

    iget v1, p0, Lcom/android/camera2/e5;->e:I
    ...
    iget-boolean v2, p0, Lcom/android/camera2/e5;->b:Z
    ...
    iget-boolean v1, p0, Lcom/android/camera2/e5;->b:Z
    ...
    :cond_2
    :try_start_0
    invoke-virtual {p0}, Lcom/android/camera2/e5;->generateCaptureCallback()Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;

    move-result-object v1

    invoke-virtual {p0}, Lcom/android/camera2/e5;->generateRequestBuilder()Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v2

    iget-object v3, p0, Lcom/android/camera2/e5;->i:Landroid/view/Surface;
    ...
    :cond_3
    iget-boolean v3, p0, Lcom/android/camera2/e5;->b:Z
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/camera2/e5;->b:Z
    ...
    invoke-virtual {v6}, Lcom/android/camera2/g4;->s()Landroid/hardware/camera2/CameraCaptureSession;
    ...
    iget-object v8, p0, Lcom/android/camera2/u4;->mCameraHandler:Landroid/os/Handler;
    ...
    iget v7, p0, Lcom/android/camera2/e5;->f:I

    add-int/2addr v7, v4

    iput v7, p0, Lcom/android/camera2/e5;->f:I

    iput v6, p0, Lcom/android/camera2/e5;->c:I

    iget v8, p0, Lcom/android/camera2/e5;->e:I

    if-ne v7, v8, :cond_5

    iput v6, p0, Lcom/android/camera2/e5;->d:I
    ...
    iget v9, p0, Lcom/android/camera2/e5;->d:I
    ...
    iget v6, p0, Lcom/android/camera2/e5;->f:I
