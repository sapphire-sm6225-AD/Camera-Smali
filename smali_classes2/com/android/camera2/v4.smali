.class public Lcom/android/camera2/v4;
...
# direct methods
.method public constructor <init>(Lcom/android/camera2/g4;IZ)V
    .locals 1
    ...
    iput-boolean v0, p0, Lcom/android/camera2/v4;->e:Z

    iput p1, p0, Lcom/android/camera2/v4;->h:I

    iput-boolean p1, p0, Lcom/android/camera2/v4;->i:Z

    iput p2, p0, Lcom/android/camera2/v4;->f:I

    iput-boolean p3, p0, Lcom/android/camera2/v4;->d:Z

    return-void
.end method

.method public static synthetic d(Lcom/android/camera2/v4;ZI)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Lcom/android/camera2/v4;->onRepeatingEnd(ZI)V

    return-void
.end method

.method public static synthetic e(Lcom/android/camera2/v4;)I
    .locals 0
...
.method public static synthetic f(Lcom/android/camera2/v4;I)I
    .locals 0
...
.method public static synthetic g(Lcom/android/camera2/v4;)I
    .locals 0

    iget p0, p0, Lcom/android/camera2/v4;->h:I

    return p0
.end method

.method public static synthetic h(Lcom/android/camera2/v4;)I
    .locals 0

    iget p0, p0, Lcom/android/camera2/v4;->g:I

    return p0
.end method

.method public static synthetic i(Lcom/android/camera2/v4;Z)Z
    .locals 0
...
.method public static synthetic j(Lcom/android/camera2/v4;Landroid/hardware/camera2/TotalCaptureResult;)Landroid/hardware/camera2/TotalCaptureResult;
    .locals 0

    iput-object p1, p0, Lcom/android/camera2/v4;->c:Landroid/hardware/camera2/TotalCaptureResult;

    return-object p1
.end method

.method public static synthetic k(Lcom/android/camera2/v4;)I
    .locals 0

    iget p0, p0, Lcom/android/camera2/v4;->f:I

    return p0
.end method

.method public static synthetic l(Lcom/android/camera2/v4;)I
    .locals 0
...
.method public generateCaptureCallback()Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;
    ...
    new-instance v0, Lcom/android/camera2/v4$a;

    invoke-direct {v0, p0}, Lcom/android/camera2/v4$a;-><init>(Lcom/android/camera2/v4;)V
...
.method public generateRequestBuilder()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-virtual {v0}, Lsb/c;->d7()Z

    move-result v0

    if-eqz v0, :cond_1

    iget v0, p0, Lcom/android/camera2/v4;->f:I
    ...
    iget-object v2, v2, Lcom/android/camera2/n5;->a:Landroid/media/ImageReader;
    ...
    iget-boolean v2, p0, Lcom/android/camera2/v4;->d:Z
...
.method public m([B)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/camera2/v4;->n([BLandroid/hardware/camera2/CaptureResult;)V
...
.method public final n([BLandroid/hardware/camera2/CaptureResult;)V
    ...
    invoke-interface {v0, p1, p2}, Lcom/android/camera2/a$m;->d7([BLandroid/hardware/camera2/CaptureResult;)V
...
.method public bridge synthetic notifyResultData(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera2/v4;->m([B)V
...
.method public onImageReceived(Landroid/media/Image;I)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/camera2/v4;->c:Landroid/hardware/camera2/TotalCaptureResult;
    ...
    :cond_1
    iget p2, p0, Lcom/android/camera2/v4;->h:I

    const/4 v0, 0x1

    add-int/2addr p2, v0

    iput p2, p0, Lcom/android/camera2/v4;->h:I
    ...
    iget-object p1, p0, Lcom/android/camera2/v4;->c:Landroid/hardware/camera2/TotalCaptureResult;

    invoke-virtual {p0, p2, p1}, Lcom/android/camera2/v4;->n([BLandroid/hardware/camera2/CaptureResult;)V

    iget-boolean p1, p0, Lcom/android/camera2/v4;->i:Z

    if-eqz p1, :cond_2

    iget p1, p0, Lcom/android/camera2/v4;->h:I

    iget p2, p0, Lcom/android/camera2/v4;->g:I

    if-ne p1, p2, :cond_2

    iget p1, p0, Lcom/android/camera2/v4;->b:I

    invoke-virtual {p0, v0, p1}, Lcom/android/camera2/v4;->onRepeatingEnd(ZI)V
...
.method public startSessionCapture()V
    ...
    iget v1, p0, Lcom/android/camera2/v4;->g:I
    ...
    :try_start_0
    invoke-virtual {p0}, Lcom/android/camera2/v4;->generateCaptureCallback()Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;

    move-result-object v0

    invoke-virtual {p0}, Lcom/android/camera2/v4;->generateRequestBuilder()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-virtual {v3}, Lsb/c;->d7()Z

    move-result v3

    if-eqz v3, :cond_4

    iget v3, p0, Lcom/android/camera2/v4;->f:I

    if-lez v3, :cond_4

    iget-boolean v3, p0, Lcom/android/camera2/v4;->e:Z
    ...
    :goto_0
    iput-boolean v2, p0, Lcom/android/camera2/v4;->e:Z
    ...
    iget v7, p0, Lcom/android/camera2/v4;->g:I

    add-int/2addr v7, v4

    iput v7, p0, Lcom/android/camera2/v4;->g:I

    iput v6, p0, Lcom/android/camera2/v4;->a:I

    iget v8, p0, Lcom/android/camera2/v4;->f:I

    if-ne v7, v8, :cond_3

    iput v6, p0, Lcom/android/camera2/v4;->b:I
    ...
    iget v9, p0, Lcom/android/camera2/v4;->b:I
    ...
    iget v6, p0, Lcom/android/camera2/v4;->g:I
    ...
    iput v0, p0, Lcom/android/camera2/v4;->b:I
    ...
    iget v3, p0, Lcom/android/camera2/v4;->b:I
