...
.method public onCaptureCompleted(Landroid/hardware/camera2/CameraCaptureSession;Landroid/hardware/camera2/CaptureRequest;Landroid/hardware/camera2/TotalCaptureResult;)V
    ...
    iget-boolean p2, p1, Lcom/android/camera2/u4;->mNeedDoAnchorFrame:Z

    iput-boolean p2, p1, Lcom/android/camera2/u4;->mAnchorFrameLost:Z
    ...
    invoke-static {p3}, Lcom/android/camera2/h5;->m(Lcom/android/camera2/h5;)I
    ...
    invoke-static {p3}, Lyc/a;->b(Landroid/hardware/camera2/CaptureResult;)Landroid/os/Parcelable;
    ...
    invoke-static {p3}, Lcom/android/camera2/h5;->n(Lcom/android/camera2/h5;)I
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/camera/q3$b;->x(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
...
.method public onCaptureStarted(Landroid/hardware/camera2/CameraCaptureSession;Landroid/hardware/camera2/CaptureRequest;JJ)V
    ...
    invoke-static {p1}, Lcom/android/camera2/h5;->h(Lcom/android/camera2/h5;)Z
    ...
    invoke-virtual {p1}, Lcom/android/camera2/g4;->H()Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object p1

    iget-object p6, p0, Lcom/android/camera2/h5$a;->a:Lcom/android/camera2/h5;

    iget-object p6, p6, Lcom/android/camera2/u4;->mMiCamera:Lcom/android/camera2/g4;

    invoke-virtual {p6}, Lcom/android/camera2/g4;->r()Lcom/android/camera2/f;
    ...
    iput-wide p3, p1, Lcom/android/camera2/b5;->mFirstFrameTimestamp:J
    ...
    iget-object v0, v0, Lcom/android/camera2/u4;->mButtonStatus:Lp6/a;
    ...
    iget-object p3, p3, Lcom/android/camera2/u4;->mButtonStatus:Lp6/a;

    invoke-virtual {p6, p3}, Ldd/x;->F0(Lp6/a;)V
    ...
    invoke-virtual {p3}, Lcom/android/camera2/u4;->getFileName()Ljava/lang/String;

    move-result-object p3

    invoke-virtual {p6, p3}, Ldd/x;->U0(Ljava/lang/String;)V
    ...
    invoke-virtual {p6, p3}, Ldd/x;->D0(Z)V

    iget-object p3, p0, Lcom/android/camera2/h5$a;->a:Lcom/android/camera2/h5;

    iget-boolean p4, p3, Lcom/android/camera2/u4;->mAnchorFrame:Z

    const/4 v0, 0x0

    if-eqz p4, :cond_4

    iget p4, p3, Lcom/android/camera2/u4;->mSoundTime:I
    ...
    :goto_0
    new-instance p4, Lcom/android/camera2/p3$b;

    iget-object p3, p3, Lcom/android/camera2/b5;->mAlgoSize:Lcom/android/camera/u2;

    invoke-direct {p4, p3}, Lcom/android/camera2/p3$b;-><init>(Lcom/android/camera/u2;)V

    new-instance p3, Lcom/android/camera2/s5;

    iget-object v1, p0, Lcom/android/camera2/h5$a;->a:Lcom/android/camera2/h5;

    invoke-virtual {v1}, Lcom/android/camera2/u4;->isQuickShotAnimation()Z

    move-result v3

    iget-object v1, p0, Lcom/android/camera2/h5$a;->a:Lcom/android/camera2/h5;

    iget-boolean v4, v1, Lcom/android/camera2/u4;->mAnchorFrame:Z

    const/4 v6, 0x0

    iget-object v7, v1, Lcom/android/camera2/u4;->mButtonStatus:Lp6/a;

    move-object v2, p3

    invoke-direct/range {v2 .. v7}, Lcom/android/camera2/s5;-><init>(ZZZZLp6/a;)V

    invoke-virtual {p4, p3}, Lcom/android/camera2/p3$b;->c(Lcom/android/camera2/s5;)Lcom/android/camera2/p3$b;

    move-result-object p3

    iget-object p4, p0, Lcom/android/camera2/h5$a;->a:Lcom/android/camera2/h5;

    iget p4, p4, Lcom/android/camera2/u4;->mSatCameraId:I

    invoke-virtual {p3, p4}, Lcom/android/camera2/p3$b;->d(I)Lcom/android/camera2/p3$b;

    move-result-object p3

    invoke-virtual {p3}, Lcom/android/camera2/p3$b;->a()Lcom/android/camera2/p3;

    move-result-object p3

    invoke-interface {p1, p6, p3}, Lcom/android/camera2/a$m;->Qa(Ldd/x;Lcom/android/camera2/p3;)Ldd/x;
    ...
    iget-object p3, p3, Lcom/android/camera2/b5;->mCaptureId:Ljava/lang/String;

    invoke-virtual {p1, p3}, Ldd/x;->H0(Ljava/lang/String;)V

    iget-object p3, p0, Lcom/android/camera2/h5$a;->a:Lcom/android/camera2/h5;

    invoke-static {p3}, Lcom/android/camera2/h5;->i(Lcom/android/camera2/h5;)Z
    ...
    invoke-static {p3}, Lcom/android/camera2/h5;->j(Lcom/android/camera2/h5;)Lik/b;
    ...
    :cond_5
    sget-object p3, Lik/b;->j:Lik/b;

    :goto_1
    invoke-virtual {p1, p3}, Ldd/x;->o1(Lik/b;)V

    iget-object p3, p0, Lcom/android/camera2/h5$a;->a:Lcom/android/camera2/h5;

    invoke-static {p3}, Lcom/android/camera2/h5;->k(Lcom/android/camera2/h5;)I

    move-result p3

    invoke-virtual {p1, p3}, Ldd/x;->B0(I)V
    ...
    invoke-virtual {p3}, Lu0/h1;->r0()Lu0/y;
    ...
    iget-object p4, p4, Lcom/android/camera2/u4;->mMiCamera:Lcom/android/camera2/g4;

    invoke-virtual {p4}, Lcom/android/camera2/g4;->u()Lcom/android/camera2/h3;
    ...
    invoke-virtual {p1, p5}, Ldd/x;->E0(I)V

    iget-object p3, p0, Lcom/android/camera2/h5$a;->a:Lcom/android/camera2/h5;

    iget-object p3, p3, Lcom/android/camera2/b5;->mBufferFormat:Lcom/xiaomi/engine/BufferFormat;

    invoke-virtual {p1, p3}, Ldd/x;->J0(Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-virtual {p1, p5}, Ldd/x;->S0(Z)V
    ...
    invoke-static {p2}, Lcom/android/camera2/h5;->l(Lcom/android/camera2/h5;)Z
    ...
    invoke-virtual {p1, p5}, Ldd/x;->m1(Z)V

    :cond_c
    iget-object p0, p0, Lcom/android/camera2/h5$a;->a:Lcom/android/camera2/h5;

    invoke-static {p0}, Lcom/android/camera2/h5;->h(Lcom/android/camera2/h5;)Z
