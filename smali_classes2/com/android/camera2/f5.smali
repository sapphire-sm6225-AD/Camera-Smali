...
# instance fields
.field public final a:Lcom/android/camera2/w5;
...
.field public n:Ldd/x;


# direct methods
.method public constructor <init>(Lcom/android/camera2/g4;Landroid/hardware/camera2/CaptureResult;Lp6/a;)V
    .locals 0

    invoke-direct {p0, p1, p3}, Lcom/android/camera2/b5;-><init>(Lcom/android/camera2/g4;Lp6/a;)V

    const/16 p3, 0xb

    iput p3, p0, Lcom/android/camera2/f5;->h:I

    const/4 p3, -0x1

    iput p3, p0, Lcom/android/camera2/f5;->m:I
    ...
    iput-object p1, p0, Lcom/android/camera2/f5;->a:Lcom/android/camera2/w5;

    return-void
.end method

.method public static synthetic h(Lcom/android/camera2/f5;)I
    .locals 0
...
.method public static synthetic i(Lcom/android/camera2/f5;)I
    .locals 2
    ...
    iput v1, p0, Lcom/android/camera2/f5;->e:I

    return v0
.end method

.method public static synthetic j(Lcom/android/camera2/f5;)I
    .locals 0
...
.method public static synthetic k(Lcom/android/camera2/f5;)I
    .locals 0

    iget p0, p0, Lcom/android/camera2/f5;->h:I

    return p0
.end method

.method public static synthetic l(Lcom/android/camera2/f5;)Landroid/util/Size;
    .locals 0

    iget-object p0, p0, Lcom/android/camera2/f5;->l:Landroid/util/Size;

    return-object p0
.end method

.method public static synthetic m(Lcom/android/camera2/f5;)Ldd/x;
    .locals 0

    iget-object p0, p0, Lcom/android/camera2/f5;->n:Ldd/x;

    return-object p0
.end method

.method public static synthetic n(Lcom/android/camera2/f5;Ldd/x;)Ldd/x;
    .locals 0

    iput-object p1, p0, Lcom/android/camera2/f5;->n:Ldd/x;

    return-object p1
.end method

.method public static synthetic o(Lcom/android/camera2/f5;)I
    .locals 0
...
.method public static synthetic p(Lcom/android/camera2/f5;)I
    .locals 2
    ...
    iput v1, p0, Lcom/android/camera2/f5;->d:I

    return v0
.end method

.method public static synthetic q(Lcom/android/camera2/f5;)I
    .locals 0

    iget p0, p0, Lcom/android/camera2/f5;->m:I
...
.method public generateRequestBuilder()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    :cond_0
    iget-object v2, p0, Lcom/android/camera2/f5;->j:Landroid/view/Surface;
    ...
    invoke-virtual {v4}, Lcom/android/camera2/g4;->W()Z
    ...
    invoke-virtual {v4}, Lcom/android/camera2/g4;->M()I

    move-result v4

    iput v4, p0, Lcom/android/camera2/u4;->mSatCameraId:I
    ...
    iget-object v4, p0, Lcom/android/camera2/f5;->i:Landroid/view/Surface;

    iget-object v8, p0, Lcom/android/camera2/u4;->mMiCamera:Lcom/android/camera2/g4;

    invoke-virtual {v8}, Lcom/android/camera2/g4;->Q()Lcom/android/camera2/n5;

    move-result-object v8

    invoke-virtual {v8}, Lcom/android/camera2/n5;->h0()Landroid/view/Surface;
    ...
    iget-object v9, p0, Lcom/android/camera2/f5;->k:Landroid/util/Size;

    invoke-virtual {p0, v4, v9, v8, v2}, Lcom/android/camera2/b5;->configParallelSession(ILandroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;

    move-result-object v2

    iput-object v2, p0, Lcom/android/camera2/b5;->mBufferFormat:Lcom/xiaomi/engine/BufferFormat;

    goto :goto_2

    :cond_5
    iget-object v4, p0, Lcom/android/camera2/f5;->k:Landroid/util/Size;

    invoke-virtual {p0, v4, v8, v2}, Lcom/android/camera2/b5;->configParallelSession(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    :cond_6
    iget-boolean v2, p0, Lcom/android/camera2/u4;->mAnchorFrame:Z
    ...
    invoke-virtual {v9}, Lcom/android/camera2/g4;->F()I
    ...
    invoke-virtual {v4}, Lcom/android/camera2/g4;->F()I
    ...
    invoke-virtual {v2, v0, v6}, Lcom/android/camera2/g4;->c3(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget v2, p0, Lcom/android/camera2/f5;->c:I
    ...
    iget-boolean v4, p0, Lcom/android/camera2/f5;->b:Z
    ...
    :cond_e
    iget-object v1, p0, Lcom/android/camera2/f5;->a:Lcom/android/camera2/w5;
...
.method public prepare()V
    ...
    iget-object v0, p0, Lcom/android/camera2/f5;->f:Lcom/xiaomi/camera/imagecodec/FeatureSetting;
    ...
    invoke-virtual {p0}, Lcom/android/camera2/f5;->r()Z

    move-result v0

    iput-boolean v0, p0, Lcom/android/camera2/u4;->mAnchorFrame:Z

    iget v0, p0, Lcom/android/camera2/f5;->h:I

    invoke-virtual {p0, v0}, Lcom/android/camera2/u4;->getSoundTimeWhenAnchor(I)I

    move-result v0

    iput v0, p0, Lcom/android/camera2/u4;->mSoundTime:I
    ...
    invoke-virtual {v0}, Lcom/android/camera2/h3;->N0()Lcom/android/camera/u2;

    move-result-object v0

    iput-object v0, p0, Lcom/android/camera2/u4;->mPreviewSize:Lcom/android/camera/u2;
...
.method public final r()Z
    ...
    iget-boolean v3, p0, Lcom/android/camera2/f5;->b:Z
...
.method public final s()V
    ...
    iget-object v1, v0, Lcom/android/camera2/u4;->TAG:Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/android/camera2/n5;->V()Landroid/view/Surface;

    move-result-object v1

    iput-object v1, v0, Lcom/android/camera2/f5;->j:Landroid/view/Surface;
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0

    :catch_0
    iget-object v1, v0, Lcom/android/camera2/f5;->j:Landroid/view/Surface;

    const/4 v3, 0x1

    if-nez v1, :cond_0

    iput-boolean v3, v0, Lcom/android/camera2/f5;->g:Z
    ...
    invoke-virtual {v5}, Lcom/android/camera2/g4;->i4()Z
    ...
    invoke-virtual {v5}, Lcom/android/camera2/g4;->b0()Z
    ...
    invoke-virtual {v5}, Lcom/android/camera2/g4;->M()I
    ...
    iget-object v6, v0, Lcom/android/camera2/u4;->mMiCamera:Lcom/android/camera2/g4;

    invoke-virtual {v6}, Lcom/android/camera2/g4;->Q()Lcom/android/camera2/n5;

    move-result-object v6

    iget-object v7, v0, Lcom/android/camera2/u4;->mMiCamera:Lcom/android/camera2/g4;

    invoke-virtual {v7}, Lcom/android/camera2/g4;->n4()Z

    move-result v7

    invoke-virtual {v6, v5, v7}, Lcom/android/camera2/n5;->G(IZ)Landroid/view/Surface;

    move-result-object v6

    iput-object v6, v0, Lcom/android/camera2/f5;->i:Landroid/view/Surface;
    ...
    :cond_6
    iput v5, v0, Lcom/android/camera2/f5;->m:I

    iget-object v6, v0, Lcom/android/camera2/u4;->mMiCamera:Lcom/android/camera2/g4;

    invoke-virtual {v6}, Lcom/android/camera2/g4;->n4()Z

    move-result v6

    invoke-virtual {v1, v5, v6}, Lcom/android/camera2/h3;->f(IZ)Lcom/android/camera/u2;

    move-result-object v6

    invoke-virtual {v6}, Lcom/android/camera/u2;->i()Landroid/util/Size;

    move-result-object v6

    iput-object v6, v0, Lcom/android/camera2/f5;->l:Landroid/util/Size;

    iget-object v6, v0, Lcom/android/camera2/f5;->i:Landroid/view/Surface;

    invoke-static {v6}, Landroid/hardware/camera2/utils/SurfaceUtils;->getSurfaceSize(Landroid/view/Surface;)Landroid/util/Size;

    move-result-object v6

    iput-object v6, v0, Lcom/android/camera2/f5;->k:Landroid/util/Size;
    ...
    iget-object v8, v0, Lcom/android/camera2/f5;->l:Landroid/util/Size;
    ...
    iget-object v8, v0, Lcom/android/camera2/f5;->k:Landroid/util/Size;
    ...
    invoke-virtual {v1}, Lcom/android/camera2/h3;->G0()Lcom/android/camera/u2;

    move-result-object v6

    if-nez v6, :cond_7

    iget-object v7, v0, Lcom/android/camera2/f5;->k:Landroid/util/Size;
    ...
    :goto_5
    iget-object v9, v0, Lcom/android/camera2/f5;->k:Landroid/util/Size;
    ...
    :cond_9
    iget-object v9, v0, Lcom/android/camera2/u4;->TAG:Ljava/lang/String;
    ...
    iget-object v7, v0, Lcom/android/camera2/b5;->mPreviewCaptureResult:Landroid/hardware/camera2/CaptureResult;

    invoke-static {}, La7/a;->a()La7/a;

    move-result-object v8

    invoke-virtual {v8}, La7/a;->b()Lcom/android/camera/q3$b;
    ...
    :goto_6
    iput-boolean v13, v0, Lcom/android/camera2/f5;->b:Z
    ...
    :cond_e
    iput-boolean v3, v0, Lcom/android/camera2/f5;->b:Z
    ...
    :goto_7
    iget-object v13, v0, Lcom/android/camera2/u4;->TAG:Ljava/lang/String;
    ...
    invoke-static {v7}, Lyc/a;->b(Landroid/hardware/camera2/CaptureResult;)Landroid/os/Parcelable;
    ...
    :cond_11
    :goto_8
    iget-object v3, v0, Lcom/android/camera2/b5;->mPreviewCaptureResult:Landroid/hardware/camera2/CaptureResult;
    ...
    :goto_9
    iget-object v10, v0, Lcom/android/camera2/b5;->mPreviewCaptureResult:Landroid/hardware/camera2/CaptureResult;
    ...
    :cond_13
    iget-object v12, v0, Lcom/android/camera2/u4;->TAG:Ljava/lang/String;
    ...
    iget-object v3, v0, Lcom/android/camera2/f5;->k:Landroid/util/Size;

    iget-object v7, v0, Lcom/android/camera2/f5;->l:Landroid/util/Size;
    ...
    invoke-virtual {v8, v2, v4, v1, v3}, Lcom/android/camera/q3$b;->H(Lcom/xiaomi/camera/isp/IspInterfaceIO;Landroid/os/Parcelable;Lcom/xiaomi/camera/imagecodec/QueryFeatureSettingParameter;Z)Lcom/xiaomi/camera/imagecodec/FeatureSetting;

    move-result-object v1

    iput-object v1, v0, Lcom/android/camera2/f5;->f:Lcom/xiaomi/camera/imagecodec/FeatureSetting;
    ...
    iget-object v3, v0, Lcom/android/camera2/f5;->f:Lcom/xiaomi/camera/imagecodec/FeatureSetting;
    ...
    iput-boolean v1, v0, Lcom/android/camera2/f5;->g:Z
...
.method public startSessionCapture()V
    ...
    :cond_0
    iget-object v3, p0, Lcom/android/camera2/f5;->f:Lcom/xiaomi/camera/imagecodec/FeatureSetting;
    ...
    :goto_0
    iget v6, p0, Lcom/android/camera2/f5;->c:I
    ...
    iget-object v7, p0, Lcom/android/camera2/f5;->l:Landroid/util/Size;

    invoke-virtual {v7}, Landroid/util/Size;->getWidth()I

    move-result v7

    iget-object v8, p0, Lcom/android/camera2/f5;->l:Landroid/util/Size;
    ...
    invoke-virtual {p0, v2, v6, v3}, Lcom/android/camera2/b5;->generatePreProcessData(Landroid/hardware/camera2/CaptureRequest;Lcom/xiaomi/engine/BufferFormat;I)Lcom/xiaomi/engine/PreProcessData;

    move-result-object v2

    if-eqz v2, :cond_5

    invoke-virtual {p0, v2}, Lcom/android/camera2/b5;->preCapture(Lcom/xiaomi/engine/PreProcessData;)V
    ...
    invoke-virtual {v2, v3}, Lb7/n;->s(Ljava/lang/String;)J
    ...
    invoke-virtual {v2}, Lcom/android/camera2/g4;->s()Landroid/hardware/camera2/CameraCaptureSession;

    move-result-object v2

    iget-object v3, p0, Lcom/android/camera2/u4;->mCameraHandler:Landroid/os/Handler;
...
.method public t()Z
    ...
    :cond_1
    iget-object p0, p0, Lcom/android/camera2/f5;->f:Lcom/xiaomi/camera/imagecodec/FeatureSetting;
