...
.method public final a(ZLcom/android/camera/data/data/c;IZ)V
    ...
    invoke-direct {v0, v1}, Lcom/android/camera/ui/t1;-><init>(Landroid/content/Context;)V

    iget v1, p2, Lcom/android/camera/data/data/c;->a:I

    invoke-virtual {v0, v1}, Lcom/android/camera/ui/t1;->setCircleRes(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/camera/ui/t1;->setTextRes(I)V

    iget-boolean v1, p0, Lcom/android/camera/ui/TopAlertCapsuleSwitchView;->b:Z

    invoke-virtual {v0, v1}, Lcom/android/camera/ui/t1;->setExpandAnimateLTR(Z)V

    if-eqz p4, :cond_0

    sget-object p4, Lcom/android/camera/ui/t1;->k0:Ljava/lang/Float;
    ...
    invoke-virtual {v0, v1}, Lcom/android/camera/ui/t1;->setmBackgroundColor(I)V

    invoke-virtual {v0, p4}, Lcom/android/camera/ui/t1;->setmBgViewAlpha(F)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/camera/ui/t1;->e(Z)V
    ...
    invoke-virtual {v0}, Lcom/android/camera/ui/t1;->getMaxLength()F
...
.method public final g(Z)V
    ...
    check-cast v1, Lcom/android/camera/ui/t1;
    ...
    invoke-virtual {v1, p1, v2}, Lcom/android/camera/ui/t1;->j(IF)V
    ...
    invoke-virtual {v1, p1, v2}, Lcom/android/camera/ui/t1;->k(IF)V
...
.method public final h(I)V
    ...
    invoke-virtual {v1}, Lp8/q;->x0()Z

    move-result v1

    if-eqz v1, :cond_0

    sget-object v0, Lcom/android/camera/ui/t1;->k0:Ljava/lang/Float;
    ...
    check-cast v3, Lcom/android/camera/ui/t1;

    invoke-virtual {v3, v1}, Lcom/android/camera/ui/t1;->setmBackgroundColor(I)V

    invoke-virtual {v3, v0}, Lcom/android/camera/ui/t1;->setmBgViewAlpha(F)V

    if-ne v2, p1, :cond_1

    invoke-virtual {v3, v0}, Lcom/android/camera/ui/t1;->setCurrentBgAlphaValue(F)V
...
.method public final i()V
    ...
    sget-object v2, Lcom/android/camera/ui/t1;->y:Ljava/lang/Float;
    ...
    invoke-virtual {v3}, Lp8/q;->x0()Z

    move-result v3

    if-eqz v3, :cond_0

    sget-object v2, Lcom/android/camera/ui/t1;->k0:Ljava/lang/Float;
    ...
    :goto_1
    invoke-virtual {v1, v2}, Lcom/android/camera/ui/t1;->setCurrentBgAlphaValue(F)V
...
.method public m(Lcom/android/camera/data/data/b;I)V
    ...
    invoke-virtual {v4}, Lx0/h1;->t0()Lp8/q;

    move-result-object v4

    invoke-virtual {v4}, Lp8/q;->x0()Z
