...
.field public f:Lcom/android/camera/q3$c;
...
.method public static synthetic a(Ld6/o2;)V
    .locals 0

    invoke-static {p0}, Lj6/f;->l(Ld6/o2;)V

    return-void
.end method

.method public static synthetic b(Lj6/f;)Ljava/lang/ref/WeakReference;
    .locals 0
...
.method public static synthetic l(Ld6/o2;)V
    .locals 1
    ...
    invoke-virtual {v0, p0}, Lcom/android/camera/q3$b;->Q(I)V
...
.method public c(Ldd/x;Z)V
    ...
    iget-object p2, p0, Lj6/f;->f:Lcom/android/camera/q3$c;
    ...
    invoke-virtual {p2}, Ld6/j0;->ij()Le6/m;
    ...
    invoke-direct {v0, v1, p2}, Lg6/f0;-><init>(Lcom/android/camera2/a;Ld6/o2;)V

    iput-object v0, p0, Lj6/f;->f:Lcom/android/camera/q3$c;

    invoke-static {}, La7/a;->a()La7/a;

    move-result-object p2

    iget-object v0, p0, Lj6/f;->f:Lcom/android/camera/q3$c;

    invoke-virtual {p2, v0}, La7/a;->d(Lcom/android/camera/q3$c;)V

    iget-object p0, p0, Lj6/f;->f:Lcom/android/camera/q3$c;

    invoke-virtual {p1, p0}, Ldd/x;->r1(Lcom/android/camera/q3$c;)V
...
.method public final d()V
    ...
    invoke-virtual {v0}, Ld6/o2;->Co()I

    move-result v3

    invoke-virtual {v0}, Ld6/o2;->qo()Lcom/xiaomi/engine/GraphDescriptorBean;
    ...
    iget-object v6, v0, Ld6/o2;->q9:Lg6/g0;

    iget-object v6, v6, Lg6/g0;->A:Lcom/android/camera/u2;
    ...
    iget-object v6, v6, Lg6/g0;->B:Lcom/android/camera/u2;
    ...
    iget-object v1, v0, Ld6/o2;->q9:Lg6/g0;

    iget-boolean v5, v0, Ld6/o2;->na:Z
    ...
    invoke-virtual/range {v1 .. v6}, Lg6/g0;->a(IILcom/xiaomi/engine/GraphDescriptorBean;ZLcom/android/camera/u2;)Lcom/xiaomi/engine/BufferFormat;

    move-result-object v1

    iget-object v2, v0, Ld6/o2;->q9:Lg6/g0;

    iget-object v2, v2, Lg6/g0;->z:Lcom/android/camera/u2;
    ...
    iget-object v0, v0, Ld6/o2;->q9:Lg6/g0;

    iget-object v0, v0, Lg6/g0;->z:Lcom/android/camera/u2;

    invoke-virtual {v0}, Lcom/android/camera/u2;->i()Landroid/util/Size;
    ...
    invoke-virtual {v0, v2}, La7/a;->c(Z)Lcom/android/camera/q3$b;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {v0, v1}, Lcom/android/camera/q3$b;->g(Lcom/xiaomi/engine/BufferFormat;)V
...
.method public e(Lcom/android/camera2/p3;Landroid/util/Size;I)Ldd/y;
    .locals 4
    ...
    invoke-virtual {p1}, Lcom/android/camera2/p3;->d()Lcom/android/camera/u2;
    ...
    invoke-virtual {v2}, Lcom/android/camera/u2;->i()Landroid/util/Size;
    ...
    iget-object v3, v0, Ld6/o2;->q9:Lg6/g0;

    iget v3, v3, Lg6/g0;->D:I

    invoke-direct {v1, v2, p1, p2, v3}, Ldd/y$b;-><init>(Landroid/util/Size;Landroid/util/Size;Landroid/util/Size;I)V
    ...
    invoke-virtual {v1, p1}, Ldd/y$b;->R(Z)Ldd/y$b;
    ...
    invoke-virtual {v1, p1}, Ldd/y$b;->Q(Z)Ldd/y$b;
    ...
    invoke-virtual {v0}, Ld6/o2;->ap()Z

    move-result v1

    invoke-virtual {p2, v1}, Ldd/y$b;->z(Z)Ldd/y$b;
    ...
    invoke-virtual {p2, v1}, Ldd/y$b;->v(I)Ldd/y$b;

    move-result-object p2

    sget v1, Lcom/android/camera/effect/p;->q3:I

    invoke-virtual {p2, v1}, Ldd/y$b;->h(I)Ldd/y$b;

    move-result-object p2

    sget v1, Lcom/android/camera/effect/p;->V2:I

    invoke-virtual {p2, v1}, Ldd/y$b;->n(I)Ldd/y$b;
    ...
    invoke-virtual {p2, v1}, Ldd/y$b;->X(I)Ldd/y$b;
    ...
    invoke-virtual {p2, p1}, Ldd/y$b;->U(I)Ldd/y$b;

    move-result-object p2

    invoke-virtual {p2, p1}, Ldd/y$b;->W(I)Ldd/y$b;

    move-result-object p2

    invoke-virtual {p2, p1}, Ldd/y$b;->G(I)Ldd/y$b;

    move-result-object p2

    invoke-virtual {p2, p1}, Ldd/y$b;->B(Z)Ldd/y$b;

    move-result-object p2

    invoke-virtual {v0}, Ld6/j0;->wg()Le6/b;
    ...
    :goto_0
    invoke-virtual {p2, v1}, Ldd/y$b;->C(I)Ldd/y$b;
    ...
    invoke-virtual {p2, v1}, Ldd/y$b;->u(I)Ldd/y$b;
    ...
    invoke-virtual {p2, v1}, Ldd/y$b;->N(F)Ldd/y$b;
    ...
    invoke-virtual {p2, v1}, Ldd/y$b;->M(I)Ldd/y$b;
    ...
    invoke-virtual {p2, v1}, Ldd/y$b;->w(Landroid/location/Location;)Ldd/y$b;
    ...
    invoke-virtual {p2, v1}, Ldd/y$b;->o(Z)Ldd/y$b;

    move-result-object p2

    invoke-virtual {v0}, Ld6/o2;->ro()Lg6/r;
    ...
    invoke-virtual {p2, v1}, Ldd/y$b;->d(Z)Ldd/y$b;

    move-result-object p2

    iget-object v1, v0, Ld6/o2;->F9:Ljava/lang/String;

    invoke-virtual {p2, v1}, Ldd/y$b;->b(Ljava/lang/String;)Ldd/y$b;

    move-result-object p2

    invoke-virtual {v0, p1}, Ld6/o2;->zo(Z)Ldd/a0;

    move-result-object v1

    invoke-virtual {p2, v1}, Ldd/y$b;->E(Ldd/a0;)Ldd/y$b;

    move-result-object p2

    const-string v1, ""

    invoke-virtual {p2, v1}, Ldd/y$b;->P(Ljava/lang/String;)Ldd/y$b;
    ...
    invoke-virtual {p2, p0}, Ldd/y$b;->k(Lcom/android/camera/effect/renders/f;)Ldd/y$b;

    move-result-object p0

    invoke-virtual {p0, p3}, Ldd/y$b;->t(I)Ldd/y$b;
    ...
    :cond_1
    invoke-virtual {p0, p1}, Ldd/y$b;->L(Z)Ldd/y$b;

    move-result-object p0

    invoke-virtual {p0}, Ldd/y$b;->a()Ldd/y;
...
.method public f()V
    ...
    invoke-static {v0, v3}, Lcom/android/camera2/g;->L1(Lcom/android/camera2/f;I)Lcom/android/camera/u2;
    ...
    :cond_5
    invoke-virtual {v1, v2}, Lcom/android/camera/q3$b;->i(Ljava/util/HashMap;)V
...
.method public h()V
    ...
    invoke-virtual {v3, v4}, La7/a;->c(Z)Lcom/android/camera/q3$b;
    ...
    invoke-virtual {v3, p0}, Lcom/android/camera/q3$b;->J(La8/h;)V

    :cond_3
    iget-object p0, v1, Ld6/o2;->q9:Lg6/g0;

    iget-object v1, p0, Lg6/g0;->B:Lcom/android/camera/u2;

    iget v4, v1, Lcom/android/camera/u2;->a:I

    iget v1, v1, Lcom/android/camera/u2;->b:I

    iget p0, p0, Lg6/g0;->D:I

    invoke-virtual {v3, v4, v1, p0}, Lcom/android/camera/q3$b;->M(III)V

    invoke-static {}, Lsb/c;->r2()Lsb/c;

    move-result-object p0

    invoke-virtual {p0}, Lsb/c;->F4()Z

    move-result p0

    invoke-virtual {v3, p0}, Lcom/android/camera/q3$b;->O(Z)V
...
.method public k()Z
    ...
    invoke-virtual {v1}, Lcom/android/camera/q3$b;->r()Z
...
.method public m()V
    ...
    invoke-virtual {v1}, Ldd/s;->v()Landroid/os/Handler;

    move-result-object v1

    new-instance v2, Lj6/d;

    invoke-direct {v2, v0}, Lj6/d;-><init>(Ld6/o2;)V
...
.method public n()V
    ...
    invoke-virtual {v1, p0}, Lcom/android/camera/q3$b;->L(Lcom/xiaomi/protocol/ISessionStatusCallBackListener;)V

    :cond_0
    if-eqz v1, :cond_1

    iget-boolean p0, v0, Ld6/o2;->da:Z
    ...
    invoke-interface {p0}, Le6/m;->w2()Ldd/k;

    move-result-object p0

    invoke-virtual {v1, p0}, Lcom/android/camera/q3$b;->N(Ldd/k;)V
