...
.field public static final i:Lpa/g;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lpa/g;->a:[C

    invoke-static {}, Lpa/a;->d()[B

    move-result-object v0

    sput-object v0, Lpa/g;->b:[B

    new-instance v0, Lpa/g;

    invoke-direct {v0}, Lpa/g;-><init>()V

    sput-object v0, Lpa/g;->i:Lpa/g;
...
# virtual methods
.method public final a(IILua/c;I)I
    .locals 0

    invoke-virtual {p3, p4}, Lua/c;->p(I)V

    const/16 p0, 0x5c

    invoke-virtual {p3, p0}, Lua/c;->b(I)V
    ...
    sget-object p2, Lpa/g;->b:[B

    shr-int/lit8 p4, p0, 0x4

    aget-byte p4, p2, p4

    invoke-virtual {p3, p4}, Lua/c;->b(I)V
    ...
    :goto_0
    sget-object p0, Lpa/g;->b:[B

    shr-int/lit8 p2, p1, 0x4

    aget-byte p2, p0, p2

    invoke-virtual {p3, p2}, Lua/c;->b(I)V
...
.method public g(Ljava/lang/String;)[B
    ...
    invoke-static {v1, v5}, Lua/c;->j([BI)Lua/c;

    move-result-object v3

    :cond_0
    invoke-virtual {v3}, Lua/c;->i()[B
    ...
    invoke-static {v4, v6}, Lpa/g;->d(II)I
    ...
    :cond_11
    invoke-virtual {v3, v5}, Lua/c;->h(I)[B
...
.method public i(Ljava/lang/CharSequence;Ljava/lang/StringBuilder;)V
    ...
    invoke-virtual {p0, v5, v4}, Lpa/g;->c(I[C)I
    ...
    :cond_2
    invoke-virtual {p0, v7, v4}, Lpa/g;->b(I[C)I
...
.method public j(Ljava/lang/CharSequence;)[C
    ...
    invoke-virtual {p0, p1}, Lpa/g;->k(Ljava/lang/String;)[C
    ...
    invoke-virtual {p0, v7, v6}, Lpa/g;->c(I[C)I
    ...
    :cond_2
    invoke-virtual {p0, v10, v6}, Lpa/g;->b(I[C)I
    ...
    invoke-static {v0}, Lua/n;->t([C)Lua/n;

    move-result-object v4

    :cond_4
    invoke-virtual {v4}, Lua/n;->s()[C
    ...
    :cond_b
    invoke-virtual {v4, v8}, Lua/n;->J(I)V

    invoke-virtual {v4}, Lua/n;->g()[C
...
.method public k(Ljava/lang/String;)[C
    ...
    :cond_a
    invoke-virtual {v5, v8}, Lua/n;->J(I)V

    invoke-virtual {v5}, Lua/n;->g()[C
...
.method public l(Ljava/lang/String;)[B
    ...
    invoke-virtual {p0, v4, v1, v3, v5}, Lpa/g;->a(IILua/c;I)I

    move-result v5

    invoke-virtual {v3}, Lua/c;->k()[B
    ...
    invoke-static {v4, v7}, Lpa/g;->d(II)I
