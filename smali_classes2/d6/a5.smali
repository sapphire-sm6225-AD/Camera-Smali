...
.method public constructor <init>(Ld6/j0;)V
    ...
    invoke-direct {p0, p1}, Lm9/s;-><init>(Ld6/b5;)V

    iput-object p1, p0, Ld6/a5;->k:Ld6/j0;

    return-void
.end method

.method public static synthetic Db(Lj7/g0;)V
    .locals 1

    invoke-interface {p0}, Lj7/g0;->u3()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-interface {p0}, Lj7/g0;->g8()V
...
.method public static synthetic gb(Ll7/a;)V
    ...
    invoke-static {p0}, Ld6/a5;->Ib(Ll7/a;)V

    return-void
.end method

.method public static synthetic qb(Lj7/g0;)V
    .locals 0

    invoke-static {p0}, Ld6/a5;->Db(Lj7/g0;)V
...
.method public B0()V
    ...
    iget-object p0, p0, Ld6/a5;->k:Ld6/j0;
...
.method public Bb()Z
    ...
    iget-object v0, p0, Ld6/a5;->k:Ld6/j0;
...
.method public O6(I)V
    ...
    new-instance v2, Ld6/y4;

    invoke-direct {v2}, Ld6/y4;-><init>()V
    ...
    :cond_0
    iget-object p1, p0, Ld6/a5;->k:Ld6/j0;
    ...
    new-instance p1, Ld6/z4;

    invoke-direct {p1}, Ld6/z4;-><init>()V
...
.method public Sg(FI)Z
    ...
    iget-object v2, v2, Ld6/o2;->va:Lj6/b;

    iput-boolean v1, v2, Lj6/b;->f:Z

    :cond_0
    iget-object v0, v0, Ld6/j0;->j:Lcom/android/camera/y3;
    ...
    iget-object v1, v1, Ld6/o2;->ga:Ln9/j;

    if-eqz v1, :cond_2

    check-cast v0, Ld6/o2;

    iget-object v0, v0, Ld6/o2;->ga:Ln9/j;

    invoke-virtual {v0, p1}, Ln9/j;->K(F)V

    :cond_2
    invoke-super {p0, p1, p2}, Lm9/s;->Sg(FI)Z
