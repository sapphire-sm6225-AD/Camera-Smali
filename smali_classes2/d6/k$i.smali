...
.method public constructor <init>(Ld6/k;[BJLd6/k$j;)V
    ...
    invoke-static {p1}, Ld6/k;->qn(Ld6/k;)I

    move-result p2

    iput p2, p0, Ld6/k$i;->f:I

    invoke-static {p1}, Ld6/k;->jn(Ld6/k;)I
    ...
    invoke-static {p1}, Ld6/k;->kn(Ld6/k;)Landroid/util/SparseArray;
...
# virtual methods
.method public final a(Lwb/e;[BLandroid/location/Location;S)[B
    .locals 15
    ...
    invoke-static {v11, v0}, Lcom/android/camera/d3;->c(Lwb/e;S)V

    invoke-static {}, Lcom/android/camera/effect/r;->a()[B

    move-result-object v0

    invoke-static {v12, v11, v0}, Lwb/d;->H([BLwb/e;[B)[B
...
.method public final c([B[B)[B
    ...
    invoke-static {v3, v6, p0, v7, v8}, Lcom/android/camera/j6;->a(Lorg/xmlpull/v1/XmlSerializer;ILandroid/graphics/Rect;ZZ)V
    ...
    .catch Lc/e; {:try_start_2 .. :try_end_2} :catch_2
    ...
    invoke-interface {p2, v5, v6, p0}, Lc/g;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    invoke-static {v3, v4, p2}, Lcom/android/camera/i6;->f(Ljava/io/InputStream;Ljava/io/OutputStream;Lc/g;)Z
    ...
    .catch Lc/e; {:try_start_6 .. :try_end_6} :catch_2
    ...
    .catch Lc/e; {:try_start_a .. :try_end_a} :catch_2
...
.method public varargs d([Ljava/lang/Void;)Ljava/lang/Integer;
    ...
    invoke-static {p1}, Lcom/android/camera/t2;->i0(Z)Lcom/android/camera/c3;

    move-result-object v0

    invoke-virtual {v0, p1}, Lcom/android/camera/c3;->b(Z)I
    ...
    invoke-virtual {v2}, Lcom/android/camera/t3;->h()Landroid/location/Location;
    ...
    :try_start_0
    invoke-virtual {p0, v5, v0, v2, v1}, Ld6/k$i;->a(Lwb/e;[BLandroid/location/Location;S)[B
    ...
    invoke-direct/range {v6 .. v13}, Ldd/x;-><init>(IJILjava/lang/String;J)V

    invoke-virtual {v2, v1, p1}, Ldd/x;->a([BI)V

    iget-object v1, v2, Ldd/x;->l0:Ldd/h;

    invoke-virtual {v1, v5}, Ldd/h;->f(Lwb/e;)V

    new-instance v1, Ldd/y$b;

    const/16 v3, 0x100

    invoke-direct {v1, v0, v0, v0, v3}, Ldd/y$b;-><init>(Landroid/util/Size;Landroid/util/Size;Landroid/util/Size;I)V
    ...
    invoke-static {v5}, Lcom/android/camera/t2;->W(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v3}, Ldd/y$b;->q(Z)Ldd/y$b;

    move-result-object v1

    iget v3, p0, Ld6/k$i;->g:I

    invoke-virtual {v1, v3}, Ldd/y$b;->u(I)Ldd/y$b;
    ...
    invoke-virtual {v3, p1}, Lcom/android/camera/c3;->b(Z)I

    move-result v3

    invoke-virtual {v1, v3}, Ldd/y$b;->t(I)Ldd/y$b;

    move-result-object v1

    sget v3, Lcom/android/camera/effect/p;->q3:I

    invoke-virtual {v1, v3}, Ldd/y$b;->h(I)Ldd/y$b;
    ...
    invoke-virtual {v1, v3}, Ldd/y$b;->V(I)Ldd/y$b;

    move-result-object v1

    sget v3, Lcom/android/camera/effect/p;->q4:I

    invoke-virtual {v1, v3}, Ldd/y$b;->X(I)Ldd/y$b;
    ...
    invoke-virtual {v1, p1}, Ldd/y$b;->U(I)Ldd/y$b;

    move-result-object v1

    invoke-virtual {v1, p1}, Ldd/y$b;->W(I)Ldd/y$b;

    move-result-object v1

    invoke-virtual {v1, p1}, Ldd/y$b;->G(I)Ldd/y$b;
    ...
    invoke-static {v1}, Lh9/b;->i(Landroid/content/Context;)Ljava/lang/String;
    ...
    :goto_4
    invoke-virtual {p1, v1}, Ldd/y$b;->T(Ljava/lang/String;)Ldd/y$b;

    move-result-object p1

    invoke-virtual {p1, v0}, Ldd/y$b;->k(Lcom/android/camera/effect/renders/f;)Ldd/y$b;
    ...
    invoke-static {v0}, Ld6/k;->ln(Ld6/k;)Ldd/a0;
    ...
    invoke-virtual {p1, v0}, Ldd/y$b;->E(Ldd/a0;)Ldd/y$b;

    move-result-object p1

    invoke-virtual {p1}, Ldd/y$b;->a()Ldd/y;

    move-result-object p1

    invoke-virtual {v2, p1}, Ldd/x;->b(Ldd/y;)V

    invoke-virtual {v2, v6}, Ldd/x;->b1(Z)V
    ...
    invoke-virtual {p0, v2, v4, v4, v4}, La8/h;->k(Ldd/x;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
...
.method public final e(SLandroid/location/Location;I)[B
    ...
    invoke-static {p1, p2, p0, p3}, Lcom/android/camera/o3;->c([BIII)[B
...
.method public final g(SLandroid/location/Location;I)[B
    ...
    invoke-static {v6, v7}, Lcom/android/camera/c6;->Y(J)Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/android/camera/c6;->j1(I)I
