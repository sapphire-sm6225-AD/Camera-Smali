...
.method public final a(Ld6/k;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {p1}, Ld6/k;->mn(Ld6/k;)Lcom/android/camera/ambilight/AmbilightEngine;
    ...
    :cond_0
    invoke-static {p1}, Ld6/k;->nn(Ld6/k;)Ljava/lang/Object;
    ...
    :try_start_0
    invoke-static {p1}, Ld6/k;->on(Ld6/k;)I
    ...
    invoke-static {p1}, Ld6/k;->pn(Ld6/k;)I
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {p0}, Ld6/k;->tn(Ld6/k;)Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {p0, v0}, Ld6/k;->Rn([B)V

    goto :goto_0

    :cond_4
    invoke-static {p0, v2}, Ld6/k;->un(Ld6/k;Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;

    :goto_0
    invoke-static {p0, v4}, Ld6/k;->vn(Ld6/k;Z)Z
    ...
    invoke-static {v0}, Ld6/k;->rn(Ld6/k;)Z
    ...
    invoke-static {v0}, Ld6/k;->mn(Ld6/k;)Lcom/android/camera/ambilight/AmbilightEngine;
    ...
    invoke-static {v0, v3}, Ld6/k;->sn(Ld6/k;Z)Z
    ...
    invoke-static {v0}, Ld6/k;->Um(Ld6/k;)Ljava/util/concurrent/atomic/AtomicInteger;

    move-result-object p0

    invoke-virtual {p0}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    invoke-static {v0}, Ld6/k;->Tm(Ld6/k;)Ljava/util/concurrent/atomic/AtomicInteger;
