...
# direct methods
.method public constructor <init>(Lcom/android/camera/Camera;Ljava/lang/String;[BIIIZIIILcom/android/camera/fragment/beauty/c0;Ljava/lang/String;Ld6/c8$d;)V
    .locals 0
    ...
    iput-object p2, p0, Ld6/c8$c;->l:Ljava/lang/String;

    iput-object p3, p0, Ld6/c8$c;->b:[B

    iput p4, p0, Ld6/c8$c;->c:I

    iput p5, p0, Ld6/c8$c;->d:I

    iput p6, p0, Ld6/c8$c;->m:I

    iput-boolean p7, p0, Ld6/c8$c;->e:Z

    iput p9, p0, Ld6/c8$c;->g:I

    iput p8, p0, Ld6/c8$c;->f:I

    iput p10, p0, Ld6/c8$c;->h:I

    iput-object p11, p0, Ld6/c8$c;->i:Lcom/android/camera/fragment/beauty/c0;

    iput-object p12, p0, Ld6/c8$c;->j:Ljava/lang/String;

    iput-object p13, p0, Ld6/c8$c;->a:Ld6/c8$d;

    new-instance p2, Ljava/lang/ref/WeakReference;

    invoke-direct {p2, p1}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object p2, p0, Ld6/c8$c;->k:Ljava/lang/ref/WeakReference;
...
.method public final a(Ljava/lang/String;Ljava/lang/String;[BIII)V
    ...
    new-instance v1, Ldd/a0;

    invoke-direct {v1}, Ldd/a0;-><init>()V

    iget v2, v0, Ld6/c8$c;->m:I

    invoke-virtual {v1, v2}, Ldd/a0;->D(I)Ldd/a0;
    ...
    invoke-static/range {v10 .. v22}, Lcom/android/camera/d3;->o([BJZLjava/lang/String;Ldd/a0;IIILandroid/location/Location;Landroid/hardware/camera2/impl/CameraMetadataNative;Z[B)[B
    ...
    invoke-static/range {v1 .. v8}, La8/x;->e(Landroid/content/Context;Ljava/lang/String;IJLandroid/location/Location;II)Landroid/net/Uri;

    move-result-object v1

    invoke-static {v9, v13, v10, v11, v12}, Lwb/d;->E(Ljava/lang/String;ILandroid/location/Location;J)V
    ...
    invoke-static {v1, v9}, La8/i;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/net/Uri;
    ...
    iget-object v4, v0, Ld6/c8$c;->k:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {v4}, Lcom/android/camera/ActivityBase;->e2()Lcom/android/camera/ui/o1;

    move-result-object v4

    invoke-virtual {v4}, Lcom/android/camera/ui/o1;->p()V
    ...
    invoke-virtual/range {v4 .. v9}, Lcom/android/camera/ActivityBase;->u2(Landroid/net/Uri;ZLjava/lang/String;IZ)V
    ...
    invoke-static {v4, v1, v3}, Lcom/android/camera/k5;->f(Landroid/content/Context;Landroid/net/Uri;Z)Lcom/android/camera/k5;
    ...
    iget-object v2, v0, Ld6/c8$c;->k:Ljava/lang/ref/WeakReference;
    ...
    invoke-static {v2, v1}, Lcom/android/camera/c6;->w(Landroid/content/Context;Landroid/net/Uri;)V

    iget-object v0, v0, Ld6/c8$c;->k:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {v0, v4, v2, v3}, Lcom/android/camera/ThumbnailUpdater;->u(Lcom/android/camera/k5;ZZ)V
...
.method public varargs b([Ljava/lang/Void;)Ljava/lang/Integer;
    ...
    invoke-static {}, Lcom/android/camera/t2;->y()I
    ...
    iget-object v6, v7, Ld6/c8$c;->b:[B

    iget v8, v7, Ld6/c8$c;->c:I

    iget v9, v7, Ld6/c8$c;->d:I
    ...
    iget-object v9, v7, Ld6/c8$c;->b:[B

    iget v10, v7, Ld6/c8$c;->c:I

    iget v11, v7, Ld6/c8$c;->d:I
    ...
    :cond_8
    iget-boolean v0, v7, Ld6/c8$c;->e:Z

    if-eqz v0, :cond_a

    iget v0, v7, Ld6/c8$c;->f:I
    ...
    iget-object v0, v7, Ld6/c8$c;->b:[B

    iget v3, v7, Ld6/c8$c;->c:I

    iget v4, v7, Ld6/c8$c;->d:I
    ...
    invoke-virtual {v5, v2}, Lcom/android/camera/c3;->b(Z)I

    move-result v5

    invoke-static {v0, v3, v4, v5}, Lcom/android/camera/o3;->c([BIII)[B
    ...
    :cond_b
    iget-object v0, v7, Ld6/c8$c;->l:Ljava/lang/String;

    invoke-static {v0, v2}, La8/x;->p(Ljava/lang/String;Z)Ljava/lang/String;

    move-result-object v1

    iget-object v2, v7, Ld6/c8$c;->l:Ljava/lang/String;

    iget v4, v7, Ld6/c8$c;->c:I

    iget v5, v7, Ld6/c8$c;->d:I

    iget v6, v7, Ld6/c8$c;->f:I

    move-object/from16 v0, p0

    invoke-virtual/range {v0 .. v6}, Ld6/c8$c;->a(Ljava/lang/String;Ljava/lang/String;[BIII)V
    ...
    iget v1, v7, Ld6/c8$c;->h:I

    const/16 v21, 0x1

    iget v2, v7, Ld6/c8$c;->g:I

    iget-object v3, v7, Ld6/c8$c;->i:Lcom/android/camera/fragment/beauty/c0;
    ...
    invoke-static/range {v16 .. v25}, Lz7/a;->I1(Ljava/util/Map;ZZIIZILcom/android/camera/fragment/beauty/c0;Lcom/android/camera/y3;Ljava/lang/String;)V

    iget-object v0, v7, Ld6/c8$c;->j:Ljava/lang/String;

    iget-object v1, v7, Ld6/c8$c;->i:Lcom/android/camera/fragment/beauty/c0;
...
.method public c(Ljava/lang/Integer;)V
    ...
    iget-object p0, p0, Ld6/c8$c;->a:Ld6/c8$d;

    if-eqz p0, :cond_0

    invoke-interface {p0}, Ld6/c8$d;->a()V
...
.method public bridge synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Ld6/c8$c;->b([Ljava/lang/Void;)Ljava/lang/Integer;
...
.method public bridge synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Ld6/c8$c;->c(Ljava/lang/Integer;)V
