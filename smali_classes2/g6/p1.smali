...
.method public static synthetic E(ZLj7/k2;)V
    ...
    invoke-interface {p1, p0}, Lj7/k2;->ub(I)V
...
.method public static synthetic Q(Lj7/o;)V
    ...
    invoke-interface {p0, v2, v0, v1}, Lj7/o;->Uc(IZLjava/lang/Object;)V
...
.method public V(Lcom/android/camera2/w5$b;)Z
    .locals 2
    .annotation build Lcom/android/camera/jacoco/JacocoForceIgnore;
    .end annotation
    ...
    iget-boolean v1, p1, Lcom/android/camera2/w5$b;->C:Z

    if-eqz v1, :cond_3

    iget-boolean p1, p1, Lcom/android/camera2/w5$b;->G:Z
...
.method public X(Lcom/android/camera2/w5$b;)V
    .locals 3
    ...
    iget-boolean p1, p1, Lcom/android/camera2/w5$b;->B:Z
    ...
    invoke-interface {p0, p1, v1, v0}, Lj7/o;->Uc(IZLjava/lang/Object;)V
...
.method public Y(Lcom/android/camera2/w5$b;)V
    .locals 10
    ...
    iget-object v3, v0, Ld6/o2;->sa:Lg6/x0;
    ...
    invoke-virtual {v0, v3}, Ld6/j0;->El(Z)V
    ...
    invoke-virtual {v0}, Ld6/j0;->ei()Lcom/android/camera/y3;
    ...
    iget-boolean v8, p1, Lcom/android/camera2/w5$b;->E:Z

    if-eqz v8, :cond_e

    iget-boolean v8, p1, Lcom/android/camera2/w5$b;->G:Z
    ...
    iput-wide v8, p1, Lcom/android/camera2/w5$b;->N:J
    ...
    invoke-direct {v1, v0}, Lg6/z1;-><init>(Ld6/o2;)V
    ...
    iput-wide v3, p1, Lcom/android/camera2/w5$b;->O:J
...
.method public Z(Lcom/android/camera2/w5$b;)V
    .locals 4
    ...
    invoke-static {}, Lcom/android/camera/t2;->a3()Z
    ...
    :goto_1
    iput-boolean v0, p1, Lcom/android/camera2/w5$b;->L:Z
    ...
    :cond_4
    iget-boolean v0, p1, Lcom/android/camera2/w5$b;->E:Z
    ...
    invoke-interface {p0, p1, v3, v0}, Lj7/o;->Uc(IZLjava/lang/Object;)V
...
.method public a0(Landroid/hardware/camera2/CaptureResult;Lcom/android/camera2/w5$b;)V
    .locals 7
    ...
    :cond_3
    iget-object v4, p2, Lcom/android/camera2/w5$b;->H:[B
    ...
    invoke-virtual {v4, p1}, Lx0/h1;->A0(I)V
    ...
    invoke-direct {v5, v0}, Lg6/z1;-><init>(Ld6/o2;)V
    ...
    invoke-interface {p1}, Lj7/k2;->nf()V
    ...
    iput-wide v0, p2, Lcom/android/camera2/w5$b;->O:J
    ...
    iput-wide v0, p2, Lcom/android/camera2/w5$b;->N:J
...
.method public f0()V
    ...
    invoke-static {v1}, Lcom/android/camera/c6;->D2(I)Z
...
.method public g0()V
    ...
    invoke-virtual {p0, v0, v0}, Lg6/p1;->h0(Landroid/hardware/camera2/CaptureResult;Lcom/android/camera2/w5$b;)V

    return-void
.end method

.method public h0(Landroid/hardware/camera2/CaptureResult;Lcom/android/camera2/w5$b;)V
    .locals 9
    ...
    iget-object v2, v1, Ld6/o2;->sa:Lg6/x0;
    ...
    :cond_0
    invoke-virtual {v1}, Ld6/j0;->ij()Le6/m;
    ...
    :cond_1
    invoke-virtual {p0, v2, p1, p2}, Lg6/p1;->q(Le6/m;Landroid/hardware/camera2/CaptureResult;Lcom/android/camera2/w5$b;)V

    invoke-virtual {p0, p2}, Lg6/p1;->V(Lcom/android/camera2/w5$b;)Z
    ...
    iget-object p2, p2, Lcom/android/camera2/w5$b;->H:[B
    ...
    iput-boolean v3, p2, Lcom/android/camera2/w5$b;->C:Z

    invoke-virtual {p0}, Lg6/p1;->t()I

    move-result v3

    iput v3, p2, Lcom/android/camera2/w5$b;->D:I
    ...
    iget-boolean v7, p2, Lcom/android/camera2/w5$b;->E:Z
    ...
    iput-boolean v0, p2, Lcom/android/camera2/w5$b;->E:Z
    ...
    :goto_2
    invoke-virtual {v7, v4}, Lx0/h1;->o1(Z)V
    ...
    invoke-virtual {v4, v0}, Lx0/h1;->o1(Z)V

    :goto_3
    iget-boolean v4, p2, Lcom/android/camera2/w5$b;->E:Z
    ...
    invoke-virtual {v1, v4}, Ld6/j0;->sc([I)V
    ...
    iget-boolean v8, p2, Lcom/android/camera2/w5$b;->E:Z
    ...
    iget-boolean p2, p2, Lcom/android/camera2/w5$b;->G:Z
    ...
    invoke-virtual {p0, v6}, Lx0/h1;->l1(Lz9/n;)V
    ...
    invoke-virtual {v1}, Ld6/o2;->Eo()Lg6/x1;
    ...
    invoke-virtual {p2, p1}, Lx0/h1;->l1(Lz9/n;)V
...
.method public final q(Le6/m;Landroid/hardware/camera2/CaptureResult;Lcom/android/camera2/w5$b;)V
    .locals 6
    ...
    iget-boolean v0, p3, Lcom/android/camera2/w5$b;->Q:Z
    ...
    :goto_1
    iput-boolean v0, p3, Lcom/android/camera2/w5$b;->G:Z
    ...
    iget-boolean v1, p3, Lcom/android/camera2/w5$b;->G:Z
    ...
    iget-boolean v0, p3, Lcom/android/camera2/w5$b;->G:Z
    ...
    iput-boolean v0, p3, Lcom/android/camera2/w5$b;->B:Z
    ...
    iget-boolean v1, p3, Lcom/android/camera2/w5$b;->B:Z
    ...
    iput-boolean v0, p3, Lcom/android/camera2/w5$b;->C:Z

    invoke-virtual {p0}, Lg6/p1;->t()I

    move-result v0

    iput v0, p3, Lcom/android/camera2/w5$b;->D:I
    ...
    iput v0, p3, Lcom/android/camera2/w5$b;->F:I
    ...
    :goto_2
    iput-boolean v4, p3, Lcom/android/camera2/w5$b;->E:Z
    ...
    iget v1, p3, Lcom/android/camera2/w5$b;->F:I
    ...
    iput-object p1, p3, Lcom/android/camera2/w5$b;->K:Lz9/l$b;

    invoke-static {p2}, Lcom/android/camera2/o3;->R(Landroid/hardware/camera2/CaptureResult;)[B

    move-result-object p0

    iput-object p0, p3, Lcom/android/camera2/w5$b;->H:[B
    ...
    iget-object p1, p3, Lcom/android/camera2/w5$b;->H:[B
...
.method public r(Z)V
    ...
    invoke-virtual {p0, v4}, Ld6/o2;->l0(I)V
    ...
    invoke-interface {p0, v6, v7}, Lcom/android/camera/ui/e1;->G0(Lxj/d;[Ljava/lang/Object;)V
...
.method public v()V
    ...
    iget-object v4, v0, Ld6/o2;->sa:Lg6/x0;
    ...
    invoke-interface {p0, v4, v2}, Lcom/android/camera/ui/e1;->G0(Lxj/d;[Ljava/lang/Object;)V
    ...
    :cond_a
    :goto_1
    invoke-virtual {v0, v1}, Ld6/j0;->El(Z)V
...
.method public w(Lcom/android/camera2/f;Landroid/hardware/camera2/CaptureResult;)V
    ...
    invoke-static {v2, p1}, Lyc/b;->e(IZ)I
    ...
    invoke-static {p1, v1}, Lcom/android/camera/t2;->D1(Lcom/android/camera2/f;I)I
