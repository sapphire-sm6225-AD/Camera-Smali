...
# direct methods
.method public constructor <init>(Lg6/x0;Ld6/o2;)V
    .locals 0
    ...
    iput-object p1, p0, Lg6/x0$b;->d:Ldd/y;
...
.method public static synthetic a(Ld6/o2;)V
    ...
    invoke-static {p0}, Lg6/x0$b;->c(Ld6/o2;)V

    return-void
.end method

.method public static synthetic c(Ld6/o2;)V
    .locals 1
...
.method public Qa(Ldd/x;Lcom/android/camera2/p3;)Ldd/x;
    ...
    iget-object v3, v2, Ld6/o2;->xa:Lj6/f;
    ...
    :cond_0
    invoke-virtual {v2}, Ld6/j0;->Ib()Le6/h;
    ...
    invoke-static {v3}, Lg6/x0;->p(Lg6/x0;)Z
    ...
    invoke-virtual {v3, v8, v9}, La8/h;->j0(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_3
    iget-object v3, v2, Ld6/o2;->q9:Lg6/g0;
    ...
    :cond_4
    invoke-virtual/range {p2 .. p2}, Lcom/android/camera2/p3;->d()Lcom/android/camera/u2;

    move-result-object v15

    iget-object v9, v0, Lg6/x0$b;->d:Ldd/y;
    ...
    invoke-virtual {v2}, Ld6/j0;->ij()Le6/m;
    ...
    invoke-interface {v9}, Le6/m;->q2()Lcom/android/camera/u2;

    move-result-object v9

    invoke-virtual {v15, v9}, Lcom/android/camera/u2;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v9, v3, Lg6/g0;->B:Lcom/android/camera/u2;
    ...
    :cond_9
    iget-object v9, v3, Lg6/g0;->A:Lcom/android/camera/u2;

    if-eqz v9, :cond_a

    invoke-virtual {v9, v15}, Lcom/android/camera/u2;->equals(Ljava/lang/Object;)Z
    ...
    invoke-interface {v9, v15}, Le6/m;->v1(Lcom/android/camera/u2;)V
    ...
    invoke-virtual/range {v9 .. v14}, Lg6/g0;->r(Lcom/android/camera/u2;ILe6/m;IZ)V
    ...
    invoke-virtual {v15}, Lcom/android/camera/u2;->i()Landroid/util/Size;
    ...
    invoke-static {v6}, Lcom/android/camera/t2;->i0(Z)Lcom/android/camera/c3;

    move-result-object v11

    invoke-virtual {v11, v10}, Lcom/android/camera/c3;->b(Z)I
    ...
    :cond_e
    iget-object v10, v2, Ld6/o2;->xa:Lj6/f;

    move-object/from16 v12, p2

    invoke-virtual {v10, v12, v9, v11}, Lj6/f;->e(Lcom/android/camera2/p3;Landroid/util/Size;I)Ldd/y;

    move-result-object v9

    iput-object v9, v0, Lg6/x0$b;->d:Ldd/y;

    :cond_f
    iget-object v9, v0, Lg6/x0$b;->d:Ldd/y;

    invoke-virtual {v1, v9}, Ldd/x;->b(Ldd/y;)V

    invoke-static {}, Lsb/c;->r2()Lsb/c;

    move-result-object v9

    invoke-virtual {v9}, Lsb/c;->ib()Z

    move-result v9

    if-eqz v9, :cond_10

    invoke-virtual {v1, v6}, Ldd/x;->n1(Z)V
    ...
    invoke-virtual {v9}, Lcom/android/camera/Camera;->S0()La8/h;

    move-result-object v9

    invoke-virtual {v9}, La8/h;->R()Z
    ...
    invoke-virtual {v2, v9}, Ld6/o2;->l0(I)V
    ...
    invoke-direct {v12, v2}, Lg6/y0;-><init>(Ld6/o2;)V
    ...
    invoke-static {v9, v10}, Lg6/x0;->r(Lg6/x0;Lio/reactivex/disposables/Disposable;)Lio/reactivex/disposables/Disposable;
    ...
    invoke-static {v4}, Lg6/x0;->q(Lg6/x0;)Lio/reactivex/ObservableEmitter;
    ...
    invoke-virtual {v1, v3}, Ldd/x;->p1(Ljava/lang/String;)V
    ...
    :cond_14
    :goto_3
    invoke-virtual {v1, v6}, Ldd/x;->b1(Z)V

    iget-object v2, v2, Ld6/o2;->xa:Lj6/f;

    invoke-virtual {v2, v1, v7}, Lj6/f;->c(Ldd/x;Z)V
    ...
    invoke-static {v2}, Lg6/x0;->p(Lg6/x0;)Z
    ...
    :cond_1a
    invoke-virtual {v1, v6}, Ldd/x;->x0(Z)V
...
.method public b()Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lcom/android/camera/c6;->Y(J)Ljava/lang/String;
...
.method public l9(ZJI)V
    ...
    invoke-virtual {v0, p4}, Lcom/android/camera/ActivityBase;->nk(Z)V

    :cond_2
    invoke-virtual {p0, p1, p2, p3}, Ld6/o2;->Bq(ZJ)V
