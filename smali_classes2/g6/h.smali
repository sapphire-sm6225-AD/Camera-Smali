...
# direct methods
.method public constructor <init>(Ld6/o2;Landroid/os/Looper;)V
    .locals 0
...
.method public static synthetic b(Ld6/o2;Lj7/o1;)V
    .locals 0

    invoke-static {p0, p1}, Lg6/h;->c(Ld6/o2;Lj7/o1;)V

    return-void
.end method

.method public static synthetic c(Ld6/o2;Lj7/o1;)V
    .locals 1

    invoke-interface {p1}, Lj7/e1;->Z7()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-interface {p1}, Lj7/e1;->cg()Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {v0, v3}, Ld6/j0;->cm(Lcom/android/camera/Camera;)V

    :cond_1
    invoke-virtual {v0}, Ld6/j0;->Uk()Z
    ...
    iput-boolean v5, v0, Ld6/o2;->U9:Z
    ...
    invoke-interface {p0, p1, v0}, Lj7/a0;->eb(II)V
    ...
    invoke-direct {p1, v0}, Lg6/e;-><init>(Ld6/o2;)V
    ...
    :pswitch_8
    iget-object p0, v0, Ld6/o2;->q5:Lg6/o;
    ...
    invoke-virtual {v0, v5, p0, p1, v5}, Ld6/o2;->l9(ZJI)V

    goto/16 :goto_2

    :cond_4
    invoke-virtual {v0}, Ld6/j0;->tk()V
    ...
    invoke-virtual {v0}, Ld6/j0;->mm()V

    goto/16 :goto_2

    :cond_6
    :pswitch_a
    invoke-virtual {v0}, Ld6/j0;->Kl()V

    goto/16 :goto_2

    :cond_7
    instance-of p0, v0, Lu2/s;

    if-eqz p0, :cond_12

    check-cast v0, Lu2/s;

    invoke-virtual {v0}, Lu2/s;->Ys()Lg6/e0;
    ...
    :cond_8
    iput-boolean v3, v0, Ld6/o2;->t9:Z
    ...
    iget-boolean p0, v0, Ld6/o2;->s9:Z
    ...
    :cond_d
    invoke-virtual {v0, p0, v5}, Ld6/o2;->Mo(ZZ)V

    goto :goto_2

    :cond_e
    invoke-virtual {v0}, Ld6/o2;->cr()V
    ...
    invoke-virtual {v0}, Ld6/j0;->Kk()Landroid/view/Window;

    move-result-object p1

    invoke-virtual {p1, v2}, Landroid/view/Window;->addFlags(I)V

    invoke-virtual {v0}, Ld6/j0;->Hk()I
    ...
    :cond_10
    invoke-virtual {v0}, Ld6/j0;->ri()V

    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J

    move-result-wide v1

    iget-wide v3, v0, Ld6/o2;->p8:J
