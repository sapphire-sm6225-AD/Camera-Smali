...
.method public static synthetic d(Ld6/o2;)V
    .locals 0

    invoke-static {p0}, Lg6/d;->j(Ld6/o2;)V

    return-void
.end method

.method public static synthetic e(Lg6/d;Ljava/lang/Object;IIZZ)V
    .locals 0
...
.method public static synthetic j(Ld6/o2;)V
    .locals 0
...
.method public a([BIIZZLp6/a;)V
    ...
    invoke-direct {p0, v0}, Lg6/c;-><init>(Ld6/o2;)V
...
.method public final f(Ljava/lang/Object;IIZZ)V
    ...
    :cond_0
    invoke-virtual {v14}, Ld6/j0;->ij()Le6/m;
    ...
    invoke-virtual {v14}, Ld6/o2;->ap()Z
    ...
    invoke-virtual {v14}, Ld6/j0;->wg()Le6/b;
    ...
    invoke-interface {v1, v2, v3}, Lj7/x2;->Ef(ZI)I
    ...
    invoke-static/range {v16 .. v16}, Lcom/android/camera/t2;->w3(I)Z
    ...
    invoke-virtual {v4, v5}, Lsb/c;->G8(I)Z
    ...
    invoke-static {v0, v5, v7}, Lwb/d;->H([BLwb/e;[B)[B
    ...
    invoke-virtual {v14, v3}, Ld6/o2;->yo(I)I
    ...
    iget-object v5, v14, Ld6/o2;->xa:Lj6/f;
    ...
    iget-boolean v5, v14, Ld6/o2;->A9:Z
    ...
    invoke-virtual {v14}, Ld6/o2;->so()Lg6/s;
    ...
    invoke-direct/range {v25 .. v32}, Ldd/x;-><init>(IJILjava/lang/String;J)V

    iget-object v2, v14, Ld6/o2;->xa:Lj6/f;

    iget-boolean v2, v2, Lj6/f;->e:Z

    if-nez v2, :cond_e

    iget-boolean v2, v14, Ld6/o2;->A9:Z

    if-nez v2, :cond_e

    iget-boolean v2, v14, Ld6/o2;->ea:Z
    ...
    :goto_9
    invoke-virtual {v4, v6}, Ldd/x;->b1(Z)V

    const/4 v2, 0x0

    invoke-virtual {v4, v0, v2}, Ldd/x;->a([BI)V

    invoke-virtual {v4, v11}, Ldd/x;->c1(Z)V

    move/from16 v0, v23

    invoke-virtual {v4, v0}, Ldd/x;->t1(Z)V

    move/from16 v0, v18

    invoke-virtual {v4, v0}, Ldd/x;->Y0(Z)V
    ...
    invoke-direct {v0, v2, v5, v6, v3}, Ldd/y$b;-><init>(Landroid/util/Size;Landroid/util/Size;Landroid/util/Size;I)V
    ...
    :goto_a
    invoke-virtual {v0, v6}, Ldd/y$b;->R(Z)Ldd/y$b;

    invoke-virtual {v0, v1}, Ldd/y$b;->C(I)Ldd/y$b;
    ...
    invoke-virtual {v0, v1}, Ldd/y$b;->N(F)Ldd/y$b;
    ...
    invoke-virtual {v0, v1}, Ldd/y$b;->M(I)Ldd/y$b;
    ...
    invoke-virtual {v0, v1}, Ldd/y$b;->w(Landroid/location/Location;)Ldd/y$b;

    move-result-object v0

    move/from16 v1, v22

    invoke-virtual {v0, v1}, Ldd/y$b;->h(I)Ldd/y$b;

    move-result-object v0

    move/from16 v1, v21

    invoke-virtual {v0, v1}, Ldd/y$b;->V(I)Ldd/y$b;
    ...
    invoke-virtual {v2, v1}, Lcom/android/camera/effect/n;->getDegree(I)I
    ...
    invoke-virtual {v0, v12}, Ldd/y$b;->n(I)Ldd/y$b;

    move-result-object v0

    move/from16 v1, v17

    invoke-virtual {v0, v1}, Ldd/y$b;->B(Z)Ldd/y$b;

    move-result-object v0

    invoke-virtual {v0, v10}, Ldd/y$b;->c(Z)Ldd/y$b;

    move-result-object v0

    const/4 v1, 0x1

    invoke-virtual {v14, v1}, Ld6/o2;->zo(Z)Ldd/a0;

    move-result-object v2

    invoke-virtual {v0, v2}, Ldd/y$b;->E(Ldd/a0;)Ldd/y$b;

    move-result-object v0

    move/from16 v12, v24

    invoke-virtual {v0, v12}, Ldd/y$b;->z(Z)Ldd/y$b;
    ...
    invoke-virtual {v0, v2}, Ldd/y$b;->S(Ljava/lang/String;)Ldd/y$b;
    ...
    invoke-virtual {v0, v2}, Ldd/y$b;->o(Z)Ldd/y$b;
    ...
    invoke-virtual {v0, v2}, Ldd/y$b;->k(Lcom/android/camera/effect/renders/f;)Ldd/y$b;
    ...
    invoke-virtual {v0, v2}, Ldd/y$b;->p(Z)Ldd/y$b;

    move-result-object v0

    invoke-virtual {v0, v7}, Ldd/y$b;->g(I)Ldd/y$b;
    ...
    invoke-virtual {v0, v2}, Ldd/y$b;->i(Z)Ldd/y$b;
    ...
    invoke-virtual {v0, v2}, Ldd/y$b;->j(Z)Ldd/y$b;

    move-result-object v0

    invoke-virtual {v14}, Ld6/o2;->mo()J

    move-result-wide v2

    invoke-virtual {v0, v2, v3}, Ldd/y$b;->f(J)Ldd/y$b;
    ...
    invoke-virtual {v4, v0}, Ldd/x;->b(Ldd/y;)V
    ...
    invoke-virtual {v4, v1}, Ldd/x;->n1(Z)V
    ...
    invoke-virtual {v0, v4, v1, v1, v1}, La8/h;->k(Ldd/x;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
...
.method public final g(Landroid/graphics/Bitmap;ZZZIZ)[B
    ...
    invoke-virtual {p0, p2}, Lcom/android/camera/c3;->b(Z)I

    move-result p0

    invoke-static {p1, p0}, Lze/c;->h(Landroid/graphics/Bitmap;I)[B
...
.method public final h([BZZZIZZ)[B
    ...
    :cond_3
    invoke-virtual {v2}, Ld6/j0;->wg()Le6/b;
    ...
    invoke-static/range {v1 .. v7}, Lcom/android/camera/c6;->c0(Landroid/graphics/Bitmap;FZFZZZ)Landroid/graphics/Bitmap;

    move-result-object v1

    if-eqz v1, :cond_4

    sget-object v0, Lcom/android/camera/c3;->d:Lcom/android/camera/c3;

    invoke-virtual {v0, v8}, Lcom/android/camera/c3;->b(Z)I

    move-result v0

    invoke-static {v1, v0}, Lze/c;->h(Landroid/graphics/Bitmap;I)[B
