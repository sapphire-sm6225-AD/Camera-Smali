...
.method public static synthetic l0(Lj7/o1;)V
    ...
    invoke-interface {p0, v0}, Lj7/i0;->J5(Z)V

    invoke-interface {p0, v0}, Lj7/o1;->Ni(Z)V
...
.method public E(I)Z
    ...
    invoke-virtual {v0}, Ld6/o2;->so()Lg6/s;
    ...
    iget-object p0, v0, Ld6/o2;->ya:Lp6/a;
    ...
    iput-object p0, v0, Ld6/o2;->ya:Lp6/a;
    ...
    invoke-virtual {v7}, Lu0/h1;->d0()Lu0/l0;
    ...
    new-instance v8, Ld6/m2;

    invoke-direct {v8}, Ld6/m2;-><init>()V
    ...
    invoke-interface {v4, p1}, Lj7/x2;->gf(I)Z
    ...
    iget-object v4, v0, Ld6/o2;->ua:Lg6/p1;
    ...
    invoke-virtual {v0}, Ld6/j0;->Ib()Le6/h;

    move-result-object v3

    invoke-interface {v3, p1}, Le6/h;->O0(I)V

    invoke-virtual {p0, v0}, Lg6/o;->G0(Ld6/o2;)V
    ...
    invoke-virtual {p0, p1}, Lb7/n;->Z([Ljava/lang/String;)V
...
.method public final G0(Ld6/o2;)V
    .locals 6
    ...
    invoke-virtual {p0, p1}, Lb7/n;->a0(Lb7/a$b;)V
...
.method public Oa(Z)V
    ...
    iput-object p1, p0, Ld6/o2;->ya:Lp6/a;
...
.method public c0()Z
    ...
    iget-object v2, v0, Ld6/o2;->ya:Lp6/a;
    ...
    iput-object v2, v0, Ld6/o2;->ya:Lp6/a;
...
.method public fi(Landroid/view/View;)V
    ...
    :cond_0
    iget-boolean v2, p1, Ld6/o2;->U9:Z
    ...
    :cond_1
    iget-object v2, p1, Ld6/o2;->xa:Lj6/f;

    iget-boolean v2, v2, Lj6/f;->e:Z

    if-nez v2, :cond_3

    iget-boolean v2, p1, Ld6/o2;->A9:Z

    if-nez v2, :cond_3

    iget-boolean v2, p1, Ld6/o2;->da:Z
    ...
    :cond_3
    :goto_0
    invoke-virtual {p0, p1}, Lg6/o;->k0(Ld6/o2;)Z
    ...
    :cond_4
    invoke-virtual {p1, v1}, Ld6/j0;->Lk(Z)V

    return-void
.end method

.method public final k0(Ld6/o2;)Z
    .locals 4
    ...
    :goto_1
    invoke-virtual {p1}, Ld6/o2;->ro()Lg6/r;
    ...
    invoke-virtual {v2}, Lcom/android/camera/Camera;->xm()Z
    ...
    invoke-virtual {p1}, Ld6/o2;->K2()Z

    move-result v3

    if-nez v3, :cond_5

    iget-object v3, p1, Ld6/o2;->sa:Lg6/x0;
...
.method public xd()V
    ...
    iput-boolean v2, v0, Ld6/o2;->p9:Z
