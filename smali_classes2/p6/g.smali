...
.method public declared-synchronized L(IIZ)I
    ...
    :pswitch_0
    invoke-static {p2}, Lcom/android/camera/t2;->c6(I)Z
    ...
    invoke-virtual {v2}, Lu0/h1;->K()Lu0/w;
    ...
    invoke-virtual {p3}, Lx0/h1;->k0()Lu0/g1;
    ...
    invoke-virtual {p3, v3}, Lx0/h1;->T0(Ljava/lang/String;)Z
    ...
    invoke-virtual {p3}, Lx0/h1;->K()Lx0/c0;

    move-result-object p3

    invoke-virtual {p3}, Lx0/c0;->v()Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_2f
    invoke-static {p2}, Lcom/android/camera/t2;->u7(I)Z

    move-result p3

    if-eqz p3, :cond_31

    invoke-static {p2}, Lcom/android/camera/t2;->I(I)Ljava/lang/String;
    ...
    :goto_4
    invoke-virtual {v3, p2, v5}, Lx0/w0;->R(IZ)Z
    ...
    :cond_34
    invoke-static {p2}, Lcom/android/camera/t2;->i3(I)Z
    ...
    invoke-static {p2, v3}, Lcom/android/camera/t2;->Aa(ILjava/lang/String;)Z

    move-result v3

    invoke-static {p2}, Lcom/android/camera/t2;->c7(I)Z
    ...
    :cond_3a
    invoke-static {p2}, Lcom/android/camera/t2;->Y5(I)Z

    move-result v3

    if-eqz v3, :cond_3e

    invoke-static {p2}, Lcom/android/camera/t2;->C1(I)Ljava/lang/String;
    ...
    :cond_3f
    invoke-static {p2}, Lcom/android/camera/t2;->G2(I)Z
    ...
    invoke-virtual {v5}, Lu0/h1;->Q()Lu0/a0;
    ...
    :goto_6
    invoke-static {p2, v6}, Lcom/android/camera/t2;->Aa(ILjava/lang/String;)Z
    ...
    :cond_45
    invoke-static {p2}, Lcom/android/camera/t2;->u3(I)Z
...
.method public final M(I)I
    ...
    invoke-static {}, Lcom/android/camera/c6;->H2()Z
