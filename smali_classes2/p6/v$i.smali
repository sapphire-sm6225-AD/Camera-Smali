...
.method public a(Landroid/os/Message;)Z
    ...
    invoke-static {v2}, Lp6/v;->M0(Lp6/v;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lp6/v;->z0(Lp6/v;)Lp6/v$c;
    ...
    invoke-static {v2, v6}, Lp6/v;->H0(Lp6/v;I)Z
    ...
    invoke-static {v0}, Lp6/v;->I0(Lp6/v;)Lp6/v$g;
    ...
    invoke-static {v0}, Lp6/v;->K0(Lp6/v;)Lp6/v$h;
    ...
    invoke-static {v0}, Lp6/v;->J0(Lp6/v;)Ljava/lang/Object;
    ...
    invoke-static {v0}, Lp6/v;->C0(Lp6/v;)Ljava/util/Map;
    ...
    invoke-static {v0}, Lp6/v;->N0(Lp6/v;)Landroid/hardware/camera2/CameraDevice;
    ...
    invoke-static {v0, v7}, Lp6/v;->D0(Lp6/v;Ljava/util/Map;)Ljava/util/Map;

    iget-object v0, v1, Lp6/v$i;->c:Lp6/v;

    invoke-static {v0}, Lp6/v;->A0(Lp6/v;)Lp6/v$f;

    move-result-object v4

    invoke-virtual {v0, v4}, Lye/d;->r0(Lye/a;)V
    :try_end_1
    ...
    invoke-static {v8}, Lp6/v;->M0(Lp6/v;)Ljava/lang/String;
    ...
    invoke-static {v12}, Lp6/v;->M0(Lp6/v;)Ljava/lang/String;
    ...
    invoke-static {v10}, Lp6/v;->u0(Lp6/v;)Lcom/android/camera2/f;
    ...
    invoke-static {v10}, Lp6/v;->C0(Lp6/v;)Ljava/util/Map;
    ...
    invoke-static {v4}, Lp6/v;->w0(Lp6/v;)Lcom/android/camera2/v5;

    move-result-object v4

    invoke-static {v0, v4}, Lcom/android/camera2/n3;->z1(Landroid/hardware/camera2/CaptureRequest$Builder;Lcom/android/camera2/v5;)V

    iget-object v4, v1, Lp6/v$i;->c:Lp6/v;

    invoke-static {v4}, Lp6/v;->N0(Lp6/v;)Landroid/hardware/camera2/CameraDevice;
    ...
    invoke-direct {v13, v0, v7}, Lp6/v$e;-><init>(Lp6/v;Lp6/v$a;)V

    iget-object v0, v1, Lp6/v$i;->c:Lp6/v;

    invoke-static {v0}, Lp6/v;->L0(Lp6/v;)Landroid/os/Handler;
    ...
    invoke-static {v4}, Lp6/v;->M0(Lp6/v;)Ljava/lang/String;
    ...
    invoke-static {v0, v6}, Lp6/v;->G0(Lp6/v;Ljava/util/List;)Ljava/util/List;

    iget-object v0, v1, Lp6/v$i;->c:Lp6/v;

    invoke-static {v0}, Lp6/v;->M0(Lp6/v;)Ljava/lang/String;
    ...
    invoke-static {v2}, Lp6/v;->J0(Lp6/v;)Ljava/lang/Object;
    ...
    invoke-static {v6}, Lp6/v;->F0(Lp6/v;)Ljava/util/List;
    ...
    invoke-static {v1}, Lp6/v;->M0(Lp6/v;)Ljava/lang/String;
