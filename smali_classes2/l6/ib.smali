...
.method public static synthetic d0(Lj7/z2;)V
    ...
    invoke-static {p0}, Lcom/android/camera/t2;->d8(Z)V
...
.method public static synthetic l0(Z)V
    ...
    invoke-interface {p0, v0}, Lj7/o;->mj(I)Z
...
# virtual methods
.method public Tc(ZI)V
    .locals 5

    invoke-virtual {p0}, Ll6/ib;->b0()Ld6/b5;
    ...
    invoke-virtual {v2}, Lx0/w0;->O()Z

    move-result v3

    invoke-virtual {v2}, Lx0/w0;->m0()Z
    ...
    :cond_1
    invoke-virtual {v2}, Lx0/w0;->A()Z

    move-result v3

    invoke-virtual {v2, v1}, Lx0/w0;->h(I)Z
    ...
    invoke-interface {p0, p2}, Le6/l;->Lb(I)V

    :cond_3
    return-void
.end method

.method public final b0()Ld6/b5;
    .locals 1
...
.method public of(Z)V
    ...
    invoke-static {v3}, Lcom/android/camera/t2;->m(I)Ljava/lang/String;
    ...
    invoke-static {v4}, Lcom/android/camera/t2;->d8(Z)V
    ...
    invoke-static {p1, v1}, Lcom/android/camera/t2;->G8(ILjava/lang/String;)V
    ...
    :cond_3
    invoke-static {v10}, Lcom/android/camera/t2;->d8(Z)V
    ...
    invoke-static {p1, v3}, Lcom/android/camera/t2;->G8(ILjava/lang/String;)V
    ...
    invoke-interface {v1, v3, p1}, Lj7/a0;->L6(Ljava/lang/String;[I)V
